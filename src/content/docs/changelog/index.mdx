---
description: Tallyfy Changelog is an AI-powered tool that automatically converts GitHub
  issues into customer-friendly release notes with consistent brand voice and proper
  categorization while supporting multi-repository products and eliminating manual
  changelog writing effort.

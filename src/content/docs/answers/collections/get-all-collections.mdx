---
description: The Tallyfy Answers API lets you retrieve all collections in your account
  via a GET request to /v1/collections with optional limit and offset parameters for
  pagination and returns each collection's name and description and object count sorted
  newest first.
...
This endpoint retrieves a summary of all collections in your Tallyfy Answers account. It sorts collections by creation date in descending order[^1] (newest first), so you'll find recently created ones at the top.

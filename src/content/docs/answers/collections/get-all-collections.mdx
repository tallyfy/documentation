---
description: The GET /v1/collections endpoint retrieves a paginated summary of all
  collections in your Tallyfy Answers account sorted by creation date with optional

---
description: "The GET /v1/collections endpoint retrieves all collections in your Tallyfy Answers account, sorted by creation date. Use limit and offset parameters for pagination."

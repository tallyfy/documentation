---
description: The GET endpoint retrieves comprehensive details about a specific Tallyfy
  Answers collection including its metadata schema information and object counts using
  the collection's unique name as a path parameter.

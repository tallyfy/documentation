---
description: Retrieve information about a specific collection in Tallyfy Answers using
  its unique name. The response includes metadata, schema details, and object counts.

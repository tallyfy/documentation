...
<LinkTitleCard header="<b>Collections > Get all collections</b>" href="/products/answers/collections/get-all-collections/" > The GET /v1/collections endpoint retrieves all collections in your Tallyfy Answers account... </LinkTitleCard>

---
description: Tallyfy Answers lets you create collections via a POST API call with
  a unique name and optional description and it automatically detects data types as
  you index objects into them.

---
description: The PATCH endpoint allows modification of existing collection properties
  like description while maintaining immutable collection names and provides comprehensive

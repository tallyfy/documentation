...
snippet: The PATCH endpoint enables modification of collection properties like descriptions
  and configurations while maintaining immutable collection names through /v1/collections/{collection_name}
  and returns updated collection details upon success.

---
description: "Use the PATCH endpoint to modify existing collection properties like descriptions in Tallyfy Answers. Collection names can't be changed, and schema detection stays automatic."

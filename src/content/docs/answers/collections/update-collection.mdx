---
description: The PATCH endpoint modifies existing collection properties like descriptions
  through a simple API call while maintaining the original collection name and automatically
  updating timestamps.

...
<LinkTitleCard header="<b>Collections > Update a collection</b>" href="/products/answers/collections/update-collection/" > Use the PATCH endpoint to modify existing collection properties like descriptions in Tallyfy... </LinkTitleCard>

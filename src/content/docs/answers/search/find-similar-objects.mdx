---
description: Tallyfy Answers provides a recommendation API endpoint that uses vector
  embeddings to find and rank objects similar to a given reference object within a
  collection — useful for product recommendations and content discovery and returning
  results scored from 0 to 1 based on cosine similarity.

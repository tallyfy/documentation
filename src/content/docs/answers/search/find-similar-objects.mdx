---
description: The recommendation endpoint enables vector-based similarity search to
  find objects with related characteristics by converting text content into numerical
  representations and ranking results based on vector distances and similarity scores.

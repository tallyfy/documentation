---
description: "Use the Tallyfy Answers recommendation endpoint to find objects similar to a reference object. Results are ranked by vector distance and similarity score."

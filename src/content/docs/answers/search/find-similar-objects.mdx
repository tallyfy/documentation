...
sidebar:
  order: 1
snippet: The recommendation endpoint leverages vector embeddings to discover semantically
  similar objects based on a reference object's characteristics and enables filtered
  retrieval of ranked results with customizable similarity thresholds for various
  use cases like product recommendations and content discovery.

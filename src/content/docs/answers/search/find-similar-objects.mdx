---
description: Tallyfy Answers uses vector embeddings[^1] and semantic similarity to find
  objects related to a specified reference object through a recommendation endpoint
  that compares vector distances and ranks results by similarity scores.

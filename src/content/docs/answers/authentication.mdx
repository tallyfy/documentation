...
<LinkTitleCard header="<b>Collections > Delete a collection</b>" href="/products/answers/collections/delete-collection/" > The Tallyfy Answers API provides a DELETE endpoint that permanently and irreversibly removes an... </LinkTitleCard>
</CardGrid>
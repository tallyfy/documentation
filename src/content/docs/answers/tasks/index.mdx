---
description: Tallyfy Answers background task management allows monitoring and controlling long-running operations like batch imports and data processing jobs.
id: 9a7f8e6d5c4b3a2e1f0d9c8b7a6f5e4d
sidebar:
  order: 6
title: Tasks
---

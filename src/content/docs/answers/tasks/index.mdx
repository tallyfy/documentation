---
description: Tallyfy Answers processes long-running operations like batch document
  imports and bulk data jobs in the background so API requests stay fast and you can
  monitor or cancel those tasks through simple GET and DELETE endpoints.

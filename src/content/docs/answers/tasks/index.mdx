---
description: Tallyfy Answers processes long-running operations like batch imports
  in the background without blocking API requests. Monitor task progress and cancel
  jobs as needed.

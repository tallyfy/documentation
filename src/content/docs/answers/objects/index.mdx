---
description: Objects in Tallyfy Answers are JSON-based data records that live inside
  collections and can be indexed and searched using either custom or auto-generated
  unique IDs without requiring a predefined schema.

---
description: "Objects are JSON data records in Tallyfy Answers that belong to collections. They can be indexed, retrieved, and searched using custom or auto-generated unique identifiers."

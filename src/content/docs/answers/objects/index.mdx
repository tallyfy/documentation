---
description: Objects in Tallyfy Answers are fundamental JSON data records that belong
  to collections and can be indexed searched and retrieved using either custom or
  auto-generated unique identifiers with flexible schema requirements.

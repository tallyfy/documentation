---
description: Use the DELETE endpoint to permanently remove objects from Tallyfy Answers
  collections by unique ID. Returns deletion confirmation, with no recovery option.

---
description: The DELETE endpoint permanently removes specific objects from collections
  using unique identifiers and returns confirmation status while warning that deletion
  is irreversible and suggesting alternatives like archiving or soft deletion.

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Objects > Index multiple objects</b>" href="/products/answers/objects/index-muliple-objects/" > The batch import endpoint enables efficient indexing of multiple objects through a single API call using JSONLines format with size limitations content chunking and error handling capabilities. </LinkTitleCard>

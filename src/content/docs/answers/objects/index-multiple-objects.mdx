...
sidebar:
  order: 2
snippet: The endpoint enables bulk importing of multiple objects into collections
  using JSONLines format with support for parallel processing error handling and size
  limitations for efficient data management.

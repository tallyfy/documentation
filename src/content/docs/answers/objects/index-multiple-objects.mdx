---
description: This API endpoint enables efficient bulk indexing of multiple objects
  into Tallyfy Answers collections using JSONLines format which significantly outperforms

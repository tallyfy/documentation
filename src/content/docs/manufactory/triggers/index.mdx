---
description: Manufactory offers real-time event-based triggers that fire based on
  actor actions using conditions and criteria to enable quick responses to incoming

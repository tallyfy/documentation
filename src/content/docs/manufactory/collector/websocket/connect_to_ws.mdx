---
description: After authenticating and receiving a client UUID and actor profile ID
  you connect to the Tallyfy Manufactory websocket server and complete a two-phase
  handshake by sending an auth message with your org ID and project ID and credentials
  before the server confirms readiness to accept events.

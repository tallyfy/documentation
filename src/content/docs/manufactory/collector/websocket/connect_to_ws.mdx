...
WebSocket: WebSocket Server {
  shape: cloud
  style.fill: "#f2faf4"
  label: "WebSocket Server\n(collector.tallyfy.com)"
}

# Connection Phase
Client -> WebSocket: 1. Connect to\nwss://collector.tallyfy.com/ws {
  style.stroke: "#225930"
...
Client -> WebSocket: 3. Send auth message\n{type, org_id, project_id,\nclient_uuid, actor_profile_id} {
  style.stroke: "#225930"
  style.stroke-width: 3
}

WebSocket -> WebSocket: 4. Validate\ncredentials {
  style.stroke: "#225930"
}
...
WebSocket -> Ready: 6. Authentication\ncomplete {
  style.stroke: "#225930"
  style.stroke-width: 2
}

Client -> Ready: 7. Begin sending\nevents {
  style.stroke: "#225930"
  style.stroke-width: 2
}
```

...
sidebar:
  order: 2
snippet: Connect to the websocket server with authentication credentials and pair
  the connection using actor profile ID and client UUID to establish a secure communication
  channel for sending actor-generated events.

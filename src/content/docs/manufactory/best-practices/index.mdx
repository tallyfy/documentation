---
description: Tallyfy Manufactory uses observability practices built on structured
  events and distributed tracing and metrics to help you monitor event-driven workflows
  and quickly troubleshoot issues before they affect users.

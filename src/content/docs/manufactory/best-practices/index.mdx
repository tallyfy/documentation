...
sidebar:
  order: 0
snippet: Learn the fundamentals of observability and how to apply best practices using
  Tallyfy Manufactory to gain deep insights into your event-driven systems.

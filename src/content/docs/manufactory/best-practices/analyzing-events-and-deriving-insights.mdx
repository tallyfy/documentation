---
description: Event analysis in Tallyfy Manufactory transforms raw structured event
  data into actionable insights through systematic investigation using filtering grouping
  and correlation techniques to understand system behavior troubleshoot issues and

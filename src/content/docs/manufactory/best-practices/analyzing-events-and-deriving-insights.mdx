...
sidebar:
  order: 5
snippet: Event analysis in Tallyfy Manufactory enables systematic investigation of
  raw data through filtering grouping time-series analysis and correlation techniques
  to understand system behavior troubleshoot issues and drive continuous process improvements
  across workflows.

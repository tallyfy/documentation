...
Filter.link: "/products/manufactory/best-practices/understanding-structured-events/"
Filter.tooltip: "Learn about structured events"
Action.link: "#from-analysis-to-action"
Action.tooltip: "Jump to action items"
```

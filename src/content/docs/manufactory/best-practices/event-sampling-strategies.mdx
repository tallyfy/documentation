...
sidebar:
  order: 7
snippet: Learn about event sampling techniques to manage high-volume event streams sent to Tallyfy Manufactory while retaining crucial data for observability.
---

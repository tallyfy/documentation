---
description: Event sampling strategies help manage high-volume event streams in Tallyfy
  Manufactory. Use techniques like fixed-rate or content-based sampling to reduce
  costs while keeping critical events like errors and business transactions.

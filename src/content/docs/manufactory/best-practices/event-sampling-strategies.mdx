---
description: Event sampling provides a practical approach to managing high-volume
  event data by selectively retaining representative events while reducing storage
  and processing costs without compromising essential observability capabilities for

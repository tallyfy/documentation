---
description: Distributed tracing tracks an event's full journey across services by
  assigning shared trace IDs and parent-child span relationships so that when Tallyfy
  Manufactory ingests and routes events through its projects and actors you can pinpoint
  exactly where bottlenecks or failures occur using tools like Jaeger or Zipkin to

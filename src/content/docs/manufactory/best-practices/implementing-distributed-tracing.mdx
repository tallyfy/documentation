---
description: Distributed tracing monitors event-driven architectures by tracking single
  events through multiple services and components using unique identifiers to visualize
  complete journeys and identify bottlenecks in complex workflows.

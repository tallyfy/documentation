...
sidebar:
  order: 6
description: Service Level Objectives provide a user-focused alerting framework that monitors
  error budget burn rates to generate meaningful alerts based on actual business impact
  rather than arbitrary technical thresholds.

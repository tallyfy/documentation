---
description: SLOs provide a user-centric approach for creating actionable alerts by
  measuring error budget burn rates instead of relying on noisy traditional cause-based

...
sidebar:
  order: 6
snippet: Learn to define Service Level Objectives (SLOs) and create actionable alerts based on event data processed by Tallyfy Manufactory.
---
...
<LinkTitleCard header="<b>Best Practices > Effective event sampling strategies for Tallyfy Manufactory</b>" href="./event-sampling-strategies/" >Learn about event sampling techniques to manage high-volume event streams sent to Tallyfy Manufactory while retaining crucial data for observability.</LinkTitleCard>

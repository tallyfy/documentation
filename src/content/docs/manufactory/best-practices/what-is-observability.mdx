---
description: "Observability helps you understand complex systems through detailed event
  data analysis. Explore and debug both known and unknown issues beyond predefined metrics."

---
description: Observability enables deep understanding of complex systems by providing
  the ability to query any aspect of system state and debug unexpected conditions
  through rich event data and correlation analysis rather than relying on pre-defined
  monitoring checks.

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Best Practices > Understanding structured events</b>" href="/products/manufactory/best-practices/understanding-structured-events/" > Structured events in Tallyfy Manufactory use key-value pairs to format event data which enables efficient routing searchability analysis and automation while providing rich context through timestamps identifiers and business-specific information. </LinkTitleCard>

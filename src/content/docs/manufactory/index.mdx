...
sidebar:
  order: 1
snippet: A scalable event lifecycle engine that handles event collection querying
  and triggering while giving organizations full control over analytics through API-based
  infrastructure and webhook functionality at a cost based solely on stored events.
title: Overview
---

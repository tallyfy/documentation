---
description: This comprehensive guide explains how to effectively use guest users
  in Tallyfy workflows to include external participants in processes without requiring
  them to have paid accounts while maintaining security and process control.
...
When a process is set to **[Public to the world](/products/pro/tracking-and-tasks/processes/make-a-process-public/)**, guest visibility changes significantly:

---
description: Guest users are external participants who can complete specific assigned
  tasks in Tallyfy processes through email links without requiring full member accounts
  while providing unlimited free access with security limitations that restrict their
  visibility to only their designated tasks.

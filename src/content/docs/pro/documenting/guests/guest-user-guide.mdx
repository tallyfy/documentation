...
sidebar:
  order: 2
snippet: Complete guide to managing guest users in Tallyfy, including inviting guests, setting permissions, tracking their tasks, and resolving common guest access issues.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Guests > What is a guest</b>" href="/products/pro/documenting/guests/what-is-a-guest/" > Guests in Tallyfy are external collaborators who can complete assigned tasks without needing a paid account making it easy to involve clients partners and other external stakeholders in your processes. </LinkTitleCard>
...
<LinkTitleCard header="<b>Guests > Convert guest into member</b>" href="/products/pro/documenting/guests/convert_guest_into_member/" > Guest users can be converted to full members in Tallyfy by inviting them through the Members section in Settings and selecting the appropriate role for their new account. </LinkTitleCard>
<LinkTitleCard header="<b>Members > Convert member to guest</b>" href="/products/pro/documenting/members/convert-member-to-guest/" > Members can be converted to guests in Tallyfy which removes their account access but allows them to still complete tasks as external participants when needed. </LinkTitleCard>
</CardGrid> 
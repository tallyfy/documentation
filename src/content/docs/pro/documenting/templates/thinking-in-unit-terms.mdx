---
description: Master the unit terms approach to workflow design by creating templates
  for single instances rather than bulk operations ensuring clarity flexibility and
  proper task ownership in Tallyfy processes.

---
description: Unit-based workflow design means creating templates that handle one instance
  at a time rather than processing multiple items in bulk which ensures clear task
  ownership proper tracking workflow flexibility and better accountability while enabling
  parallel processing and precise metrics.

---
about_tallyfy: true
description: Tallyfy templates should handle one item at a time, like one employee
  or one invoice, rather than batches. This creates clear task ownership, precise
  tracking, and lets you launch hundreds of parallel instances that each progress
  independently.

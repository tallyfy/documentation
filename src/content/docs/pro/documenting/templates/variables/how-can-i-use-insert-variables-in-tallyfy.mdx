...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Templates > Variables</b>" href="/products/pro/documenting/templates/variables/" > Variables in Tallyfy act as placeholders that automatically transfer information from form fields in early process steps to later steps enabling data flow personalization automation and consistency throughout workflows. </LinkTitleCard>
...
<LinkTitleCard header="<b>Edit Processes > Auto-name a process in Tallyfy</b>" href="/products/pro/tracking-and-tasks/processes/edit-processes/how-can-i-auto-name-a-process-in-tallyfy/" > Auto-naming processes in Tallyfy creates consistent naming patterns for workflows launched from templates by using variables from required kick-off form fields to automatically generate structured process names up to 550 characters long. </LinkTitleCard>

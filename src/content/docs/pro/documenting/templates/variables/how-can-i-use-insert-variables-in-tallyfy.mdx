---
description: Variables in step titles and descriptions enable automatic information
  display from earlier form fields to later steps ensuring data consistency personalization

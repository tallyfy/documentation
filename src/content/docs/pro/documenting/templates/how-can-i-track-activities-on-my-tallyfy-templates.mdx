---
about_tallyfy: true
description: Tallyfy's Activity tab on any template provides an immutable audit trail
  showing exactly who changed what and when across all content edits and configuration
  updates and form field modifications with timestamps displayed in your local timezone
  and access restricted to administrators and permitted members.

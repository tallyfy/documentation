---
about_tallyfy: true
description: Tallyfy's Activity tab shows who changed what and when on any template.
  Every content edit, configuration update, and form field change gets recorded with

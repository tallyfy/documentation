...
sidebar:
  order: 4
snippet: Best practices for organizing and managing your templates in Tallyfy, including
  folder structures, naming conventions, template governance, and strategies for maintaining

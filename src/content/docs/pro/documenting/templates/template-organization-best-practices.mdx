---
about_tallyfy: true
description: Organizing your Tallyfy template library through clear folder structures
  and naming conventions and tags and proper step grouping ensures your team can instantly
  find and use the right process while keeping everything accurate and up to date
  through regular audits and version-controlled changes.

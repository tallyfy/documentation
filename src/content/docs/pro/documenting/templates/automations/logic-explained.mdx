...
Now here's where it gets interesting. You might wonder - what happens when you mix AND with OR? Tallyfy keeps it simple by evaluating conditions **sequentially from left to right[^1]**, exactly in the order you add them.

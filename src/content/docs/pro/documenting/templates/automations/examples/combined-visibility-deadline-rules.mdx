---
description: This automation example demonstrates how to combine visibility and deadline
  rules to create conditional steps that only appear when needed and have dynamic
  due dates based on process data.

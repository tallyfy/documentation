...
sidebar:
  order: 3 # Adjust order as needed relative to other examples
snippet: Learn how to automatically assign a specific task, like a final notification email, back to the person who originally launched the process using automations.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Automations > Actions</b>" href="/products/pro/documenting/templates/automations/actions/" > Learn about the various actions you can trigger using automations in Tallyfy procedure templates. </LinkTitleCard>
<LinkTitleCard header="<b>Automations > Conditionals</b>" href="/products/pro/documenting/templates/automations/conditionals/" > Understand how to set up conditions (IF statements) to control when your automations run. </LinkTitleCard>
<LinkTitleCard header="<b>Tasks > Form Fields</b>" href="/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/" > Discover the different types of form fields available in Tallyfy tasks and kick-off forms. </LinkTitleCard>
<LinkTitleCard header="<b>Templates > Variables</b>" href="/products/pro/documenting/templates/variables/" > See how to use variables to pull data from one step into another within your Tallyfy processes. </LinkTitleCard>
</CardGrid> 
---
description: This tutorial shows how to automatically assign a final process step
  to the original requestor by capturing their identity at the start using an assignee
  picker field and then using automation rules to assign them to a later notification
  step ensuring they receive completion updates without manual intervention.

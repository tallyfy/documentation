...
In Tallyfy [automations](/products/pro/documenting/templates/automations/), use the **AND** operator for synchronization. **AND** means *all* conditions must be true before the action happens.

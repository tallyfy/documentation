---
about_tallyfy: true
description: Assignee picker fields in kick-off forms let the person launching a process
  dynamically choose who handles specific tasks through automation rules that support
  adding or replacing or clearing assignments based on form selections and conditional
  logic.
...
<LinkTitleCard header="<b>Examples > Automatically assign a step to the original process requestor</b>" href="/products/pro/documenting/templates/automations/examples/assign-step-to-requestor/" > Tallyfy lets you capture who started a process using an assignee picker field on the kick-off... </LinkTitleCard>
</CardGrid>
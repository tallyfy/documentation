---
description: This automation example demonstrates how to dynamically assign tasks
  to team members selected from a dropdown in the kick-off form enabling flexible
  delegation based on who launches the process.

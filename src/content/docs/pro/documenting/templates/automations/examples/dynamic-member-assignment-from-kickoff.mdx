...
Want to let process launchers pick who does what? Tallyfy's assignee picker fields make it happen. You can automatically assign [tasks](/products/pro/tracking-and-tasks/tasks/) to team members based on selections made right in the kick-off form - perfect when different situations need different people.

...
In Tallyfy, you create multiple [automation](/products/pro/documenting/templates/automations/) rules with different conditions. Only the rule whose condition gets met will run its action, so your process follows just one path.

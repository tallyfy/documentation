---
description: Tallyfy enables exclusive choice automation where processes automatically
  follow one specific path from multiple options based on user selections like employee
  roles triggering different onboarding workflows without manual intervention.

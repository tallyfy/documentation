---
description: Tallyfy's decision-wait-continue pattern uses three automations to handle
  YES/NO decisions where the NO path requires a waiting step before continuing.

...
```mermaid
flowchart TD
 Create[Create Request] --> Manager{Manager Approval}
 Manager -->|"✅"| Finance{Finance Approval}
 Manager -->|"❌"| Create
 
 Finance -->|"✅"| COO{COO Approval}
 Finance -->|"❌"| Create
...
```mermaid
graph TD
 Initial["Initial Review"] Initial -->"]
 Sync -->|"Any ❌"| Initial
...
```mermaid
flowchart TD
 Agent[Create Listing] --> Manager{Manager Review}
 Manager -->|"✅"| Marketing{Marketing Review}
 Manager -->|"❌"| Agent
 
 Marketing -->|"✅"| Compliance{Compliance Check}
 Marketing -->|"❌"| Agent
 
 Compliance -->|"✅"| Publish[Published to MLS]
 Compliance -->|"❌"| Agent

...
- Later approvals won't appear until earlier ones pass - [visibility rules](/products/pro/documenting/templates/automations/actions/visibility-actions/)[^1] control this

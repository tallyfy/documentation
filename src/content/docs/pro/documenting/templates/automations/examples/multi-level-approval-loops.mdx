...
Manager.link: "/products/pro/documenting/templates/automations/actions/status-actions/"
Manager.tooltip: "Learn about status actions for re-opening tasks"
Finance.link: "/products/pro/documenting/templates/automations/actions/visibility-actions/"
Finance.tooltip: "Learn about visibility rules for approval flow"
COO.link: "/products/pro/tutorials/how-to/track-and-run-complex-approval-workflows/"
COO.tooltip: "See complex approval workflow patterns"
```
...
Sync -> Final
Sync -> Initial: "Any ❌"
Legal.link: "/products/pro/documenting/templates/automations/actions/visibility-actions/"
Legal.tooltip: "Learn about parallel visibility rules"
Final.link: "/products/pro/documenting/templates/automations/conditionals/conditionals-explained/"
Final.tooltip: "Learn about AND conditions for synchronization"
```
...
Compliance -> Publish: "✅"
Compliance -> Agent: "❌"
Compliance.link: "/products/pro/documenting/templates/automations/actions/status-actions/"
Compliance.tooltip: "Learn how rejections trigger re-opens"
Manager.link: "/products/pro/documenting/templates/automations/actions/visibility-actions/"
Manager.tooltip: "See how visibility rules control flow"
```

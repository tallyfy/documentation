---
description: This automation example demonstrates how to automatically assign tasks
  to specific team members based on service level or package selections ensuring appropriate
  expertise handles different customer tiers.

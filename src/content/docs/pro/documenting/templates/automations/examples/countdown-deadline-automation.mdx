---
about_tallyfy: true
description: Tallyfy enables you to set task deadlines that count backwards from a
  target date using simple IF-THEN automation rules so that preparation tasks like
  meeting agendas and event setup are always completed before the critical date arrives.

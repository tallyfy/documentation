---
description: This automation example demonstrates how to set task deadlines that count backwards from important dates like meetings launches or events ensuring preparation tasks complete with appropriate lead time.

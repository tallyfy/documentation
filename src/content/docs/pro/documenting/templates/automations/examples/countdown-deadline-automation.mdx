...
<LinkTitleCard header="<b>Examples > Combined visibility and deadline rules</b>" href="/products/pro/documenting/templates/automations/examples/combined-visibility-deadline-rules/" > Combine visibility and deadline automations so steps appear only when conditions are met, with... </LinkTitleCard>
</CardGrid>
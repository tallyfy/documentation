...
description: Tallyfy lets you show or hide entire workflow tasks based on form field
  values using IF-THEN rules with AND/OR logic. One template can handle multiple process
  variations instead of maintaining separate templates for each path.

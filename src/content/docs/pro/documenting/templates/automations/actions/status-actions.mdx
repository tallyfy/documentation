...
Status actions in Tallyfy have one specific job: they automatically **re-open a step ([task](/products/pro/tracking-and-tasks/tasks/)) that was already marked as complete.**

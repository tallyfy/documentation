...
sidebar:
  order: 2
snippet: Visibility actions allow automatic showing or hiding of workflow steps based
  on specific conditions enabling dynamic process adaptation and sequential task progression
  as needed.

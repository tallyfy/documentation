...
Actions are the "THEN" part of "if-this-then-that" [automation](/products/pro/documenting/templates/automations/) rules. When your conditions get met, actions define what Tallyfy does automatically.

...
<LinkTitleCard header="<b>Actions > Automate hiding or showing tasks</b>" href="/products/pro/documenting/templates/automations/actions/visibility-actions/" > Visibility actions in Tallyfy allow you to dynamically show or hide specific process steps based on conditions ensuring users see only the relevant tasks they need when they need them while maintaining workflow flexibility through smart automation rules. </LinkTitleCard>
</CardGrid>
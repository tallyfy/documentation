---
description: 'Assignment actions in Tallyfy automatically route tasks to the right
  people when specific workflow conditions are met through three options: adding assignees
  to existing ones replacing all current assignees with new ones or clearing all assignees
  entirely.'

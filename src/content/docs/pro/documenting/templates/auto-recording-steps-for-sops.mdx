---
about_tallyfy: true
description: Free screen capture tools like ShareX and OBS Studio let you document
  procedures in Tallyfy without paying for proprietary tools. Unlike Scribe or Trainual,
  which only capture steps, Tallyfy also tracks execution and automates workflows.
...
Tallyfy does all of it, so procedures don't just get documented. They get done.
...
4. **Add Tallyfy features**
   ...
   - Configure [deadlines](/products/pro/documenting/templates/edit-templates/) for time-sensitive steps

...
description: Free screen capture tools like Windows Steps Recorder ShareX and macOS
  built-in screenshot combined with Tallyfy's rich text editor let you document
  procedures without paying for proprietary tools like Scribe or Trainual that lock

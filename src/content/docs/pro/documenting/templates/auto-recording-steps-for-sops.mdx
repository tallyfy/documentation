...
sidebar:
  order: 20
description: Learn how to capture step-by-step procedures using free screen recording tools and bring them into Tallyfy templates without expensive software like Scribe or Trainual while maintaining control of your content and avoiding vendor lock-in
...
<LinkTitleCard header="<b>Templates > Create a template</b>" href="/products/pro/documenting/templates/create-template/" > Templates in Tallyfy serve as reusable blueprints for processes that can be launched repeatedly with tasks automatically created and assigned to ensure consistent execution of workflows across your organization. </LinkTitleCard>
<LinkTitleCard header="<b>Templates > Understanding automations</b>" href="/products/pro/documenting/templates/automations/" > Automations in Tallyfy are if-this-then-that rules that automatically assign tasks hide steps or trigger actions based on form responses and process data enabling dynamic workflows that adapt to different scenarios without manual intervention. </LinkTitleCard>
</CardGrid>
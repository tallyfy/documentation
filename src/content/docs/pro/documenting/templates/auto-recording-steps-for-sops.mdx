---
about_tallyfy: true
description: Free screen capture tools like ShareX and OBS Studio combined with Tallyfy's
  workflow engine let you document and actually enforce procedures without paying
  for proprietary tools like Scribe or Trainual that only solve the easy part of capturing
  steps while ignoring execution tracking and automation.

---
about_tallyfy: true
description: Tallyfy snippets let admins create reusable text blocks like disclaimers
  or contact info that any member can insert into template steps, task descriptions,
  and comments. Write standard content once through the References panel and update
  it everywhere from a single source.
...
![Tallyfy snippet creation screen](https://screenshots.tallyfy.com/tallyfy%2Fpro%2Fdesktop-light-create-snippet1701483433378.png)
...
![Inserting a snippet into a template in Tallyfy](https://screenshots.tallyfy.com/tallyfy%2Fpro%2Fdesktop-light-insert-snippet-in-template-example.png)
...
**Review periodically.** Check quarterly that they're still current and relevant.

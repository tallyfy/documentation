---
about_tallyfy: true
description: Tallyfy snippets let admins create reusable rich-text blocks—like disclaimers
  or contact info—that any member can insert into templates and tasks from the References
  panel so you only update content in one place.

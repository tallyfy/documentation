---
description: Snippets in Tallyfy are reusable text blocks that admins create and
  manage while all members can insert them into rich text editors across templates,
  tasks, comments, and documents.

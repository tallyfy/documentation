...
description: Tallyfy snippets let admins create reusable text blocks like disclaimers
  or contact info that any member can insert into template steps and task descriptions
  and comments through the References panel so you write standard content once and
  update it everywhere from a single source.

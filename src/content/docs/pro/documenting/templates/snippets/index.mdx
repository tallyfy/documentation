---
about_tallyfy: true
description: Snippets are reusable text blocks - save content like addresses and disclaimers
  once, insert them anywhere, and all instances update automatically.

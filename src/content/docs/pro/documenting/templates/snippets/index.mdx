---
about_tallyfy: true
description: Snippets in Tallyfy are reusable text blocks that admins create once
  and insert anywhere across templates and tasks so that updating the snippet in one
  place automatically pushes the change everywhere it appears.

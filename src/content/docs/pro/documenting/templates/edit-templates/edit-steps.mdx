...
sidebar:
  order: 3
snippet: Users can modify template steps by adding new ones through the Add Step option
  and edit existing steps' descriptions assignments types form fields timings and
  advanced settings through the template edit interface.
title: Edit steps
---

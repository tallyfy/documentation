...
snippet: Steps in templates can be modified by adding new ones through the Add Step
  option, editing descriptions with rich text formatting, assigning tasks to individuals
  or groups, changing step types, customizing form fields, adjusting deadlines, and
  configuring advanced settings like process triggers and completion requirements.
title: Edit steps
weight: 3
---
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Edit Templates > Edit steps</b>" href="/products/pro/documenting/templates/edit-templates/edit-steps/" > Steps in templates can be edited by adding new ones through the Add Step option and modifying existing steps through descriptions form fields assignees timings and advanced settings in the edit view. </LinkTitleCard>

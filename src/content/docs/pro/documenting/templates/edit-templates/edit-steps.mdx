...
Members with a "Light" role cannot create or edit templates, including adding or editing steps. Only members with a "Standard" role (if they have appropriate permissions) or "Administrator" role can edit template steps.
:::

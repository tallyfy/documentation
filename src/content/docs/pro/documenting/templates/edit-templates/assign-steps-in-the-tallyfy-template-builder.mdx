...
description: Tallyfy lets you assign template steps to specific members, groups, job
  ...
  use automations to route tasks based on form answers or conditions.
...
Click the **Assign** tab for any step to pick who handles it - specific members, groups, job titles[^2], or guests. You can also leave steps unassigned or let automations route assignments dynamically.
...
- Use automations to control assignments dynamically
:::
...
[Automations](/products/pro/documenting/templates/automations/) can change assignments based on what's happening in your process:
...
- Is an automation switching assignments?

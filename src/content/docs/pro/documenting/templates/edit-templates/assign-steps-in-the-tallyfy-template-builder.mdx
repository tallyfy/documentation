...
sidebar:
  order: 5
description: Learn how to assign steps in Tallyfy's template builder with options for specific members groups job titles guests and automated assignment rules to ensure the right people handle each task in your workflow.

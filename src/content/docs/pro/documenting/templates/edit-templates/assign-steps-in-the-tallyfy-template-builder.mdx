---
about_tallyfy: true
description: Tallyfy lets you assign process steps to specific members or groups or
  job titles or guests through the Assign tab in any template step and also supports
  unassigned tasks with dynamic automation rules that route work based on form answers
  or conditions like dollar amounts or priority levels.

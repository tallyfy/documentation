...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Edit Task > Add videos to a task</b>" href="/products/pro/tracking-and-tasks/tasks/edit-task/how-can-i-add-videos-to-my-tallyfy-process/" > Tallyfy allows adding videos to task descriptions either by embedding links from video platforms like YouTube and Vimeo or by uploading video files up to 100MB in MP4 or WebM formats with embedding being the recommended method for better performance. </LinkTitleCard>

---
description: You can add pictures videos files tables and links into task descriptions
  in templates to provide clearer instructions and useful resources with a 100MB size
  limit for uploaded content.

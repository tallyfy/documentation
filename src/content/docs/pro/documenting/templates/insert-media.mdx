---
description: Tallyfy allows users to enrich task descriptions by adding various media
  types including images videos files tables and links directly through the Insert
  button in the editor toolbar with support for uploads up to 100MB and embedding

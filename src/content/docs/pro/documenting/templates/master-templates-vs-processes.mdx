---
description: Master templates in Tallyfy serve as a single authoritative blueprint
  that generates unlimited customized process instances while maintaining version
  independence and enabling continuous improvement without disrupting active workflows.

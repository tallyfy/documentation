...
- **Purpose**: Define standard process structure and logic
- **Editing**: Only users with `checklist_edit` permission can modify
- **Content**: Placeholders, automations, and standard text
...
2. **Define conditional paths** - pair each condition with what should happen next
3. **Set up automation** - configure assignments and deadlines
...
- Set up automations for different paths
...
5. **Add automation** - layer in conditions and actions

...
description: Tallyfy's master templates serve as single sources of truth that generate
  ...
  continuous improvement without disrupting active workflows.
...
```mermaid
graph TD
    MT["`**Master Template v1**
    Single Source of Truth`"]
    
    MT --> Launch1["`**Launch Action**`"]
    
    Launch1 --> P1["`**Process Instance 1**
    Client: ACME Corp
    Region: North America`"]
    
    P1 --> Launch2["`**Another Launch**`"]
    
    Launch2 --> P2["`**Process Instance 2**
    Client: GlobalTech
    Region: Europe`"]
    
    P2 --> Launch3["`**Another Launch**`"]
    
    Launch3 --> P3["`**Process Instance 3**
    Client: AsiaFirm
    Region: APAC`"]
    
    P3 --> Feedback["`**Collect Feedback**`"]
    
    Feedback --> MT2["`**Master Template v2**
    Updated with Improvements`"]
    
    MT2 --> Launch4["`**New Launch**`"]
    
    Launch4 --> P4["`**Process Instance 4**
    Uses v2 Rules`"]
    
    P4 --> Continue["`**Continue Cycle**`"]
    
    classDef template fill:#E8F4FF,stroke:#0066CC,stroke-width:2px
    classDef process fill:#D4EDDA,stroke:#00AA55
    classDef action fill:transparent,stroke:#666,stroke-dasharray: 5 5
    classDef updated fill:#FFF3CD,stroke:#FFC107
    
    class MT,MT2 template
    class P1,P2,P3,P4 process
    class Launch1,Launch2,Launch3,Launch4,Feedback,Continue action
    class MT2 updated
    
    %% Add hyperlinks to related docs
    click MT "/products/pro/documenting/templates/index/" "Learn about templates"
    click P1 "/products/pro/tracking-and-tasks/processes/index/" "Learn about processes"
```

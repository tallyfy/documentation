---
about_tallyfy: true
description: Tallyfy uses a single master template to spawn unlimited customized process
  instances, each with its own data and timeline. Template updates only affect future
  launches while running processes stay untouched.

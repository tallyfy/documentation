...
```mermaid
graph TD
    MT[Master Template<br/>Single Source of Truth]
    
    MT -->|Launch| P1[Process Instance 1<br/>Client: ACME Corp<br/>Region: North America]
    MT -->|Launch| P2[Process Instance 2<br/>Client: GlobalTech<br/>Region: Europe]
    MT -->|Launch| P3[Process Instance 3<br/>Client: AsiaFirm<br/>Region: APAC]
    
    MT2[Master Template v2<br/>Updated Rules]
    MT -.->|Update| MT2
    
    MT2 -->|New Launch| P4[Process Instance 4<br/>Uses v2 Rules]

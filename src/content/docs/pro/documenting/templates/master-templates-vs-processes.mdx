---
description: Master templates in Tallyfy serve as single sources of truth that generate
  unlimited customized process instances while maintaining version independence and
  enabling continuous improvement without disrupting active workflows.

...
description: Master templates in Tallyfy serve as single sources of truth that generate
  multiple customized process instances while maintaining version independence and
  enabling continuous improvement through feedback loops without disrupting running
  workflows.

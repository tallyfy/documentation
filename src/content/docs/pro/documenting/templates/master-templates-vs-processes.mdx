---
description: Master templates in Tallyfy serve as single source blueprints that generate
  multiple customized process instances while maintaining version control and allowing
  individual customization without disrupting running workflows.
...
MT.link: "/products/pro/documenting/templates/index/"
MT.tooltip: "Learn about templates"
P1.link: "/products/pro/tracking-and-tasks/processes/index/"
P1.tooltip: "Learn about processes"
```

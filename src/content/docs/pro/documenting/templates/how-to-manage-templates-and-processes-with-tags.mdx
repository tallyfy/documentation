...
sidebar:
  order: 14
snippet: Tags serve as flexible color-coded labels that allow users to organize and
  filter templates and processes across multiple categories while enabling quick searches

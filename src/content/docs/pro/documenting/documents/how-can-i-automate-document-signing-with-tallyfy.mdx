---
description: Tallyfy connects to e-signature services like DocuSign or HelloSign through
  middleware tools to automatically send documents for signing when workflow steps
  are completed saving teams 15-20 minutes per document.

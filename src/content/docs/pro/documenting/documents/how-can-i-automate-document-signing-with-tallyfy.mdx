---
description: Tallyfy can automatically connect to e-signature services like DocuSign
  or HelloSign through middleware tools to send documents for signing when workflow
  steps are completed saving teams 15-20 minutes per document with no manual work
  required.

...
sidebar:
  order: 10
snippet: Connect Tallyfy to e-signature services through middleware tools to automatically
  send documents for signing when specific workflow steps are completed and track
  signature status through API integrations.

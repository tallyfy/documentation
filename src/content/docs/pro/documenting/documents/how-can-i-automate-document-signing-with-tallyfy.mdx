...
Tallyfy -> Webhook: Trigger webhook {
  style.stroke: "#225930"
  style.animated: true
}
Webhook -> Middleware: Send data {
  style.stroke: "#225930"
  style.animated: true
}
Middleware -> DocuSign: Create envelope {
  style.stroke: "#225930"
}
DocuSign -> Signer: Email to sign {
  style.stroke: "#225930"
}
Signer -> DocuSign: Sign document {
  style.stroke: "#225930"
}
DocuSign -> Middleware: Signed webhook {
  style.stroke: "#225930"
  style.stroke-dash: 3
}
...
Tallyfy -> User: Notify complete {
  style.stroke: "#225930"
}
```

**What to notice:**
- **Steps 3-4**: The webhook fires instantly[^2] when someone completes a Tallyfy step - no delays or manual triggers needed

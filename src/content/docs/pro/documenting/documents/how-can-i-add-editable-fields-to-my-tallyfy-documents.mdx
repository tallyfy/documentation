...
[Document templates](/products/pro/documenting/documents/) in Tallyfy work like smart forms - you fill in specific blanks while keeping the rest unchanged. This approach maintains perfect consistency across all your documents while saving hours of formatting time.
...
When someone [launches](/products/pro/launching/) a document template with [fields](/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/), Tallyfy makes it simple:
...
- Your final documents keep their professional look and structure every single time.

### Tips for using document fields

- Name your [fields](/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/) clearly - "Customer Name" beats "Name" every time. Clear naming prevents 90% of user errors.

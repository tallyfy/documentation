---
description: Light members are cost-effective users who complete assigned tasks without
  template creation or editing privileges, ideal for field workers, external contractors,
  and task-focused roles at 90% less cost than Full members.

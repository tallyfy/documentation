---
description: Light members in Tallyfy provide cost-effective task execution capabilities
  for team members who need to complete assigned work without template creation or
  editing permissions while offering optional process launching abilities when specifically
...
Light members work with focused task completion in Tallyfy - they can't create or edit templates, but they excel at getting assigned work done. With significant cost savings compared to Full members (Administrator and Standard roles), Light members make financial sense for task-focused team members.
...
- Annual billing plans (not monthly plans)
- Can be manually enabled by support for specific cases

**Why these requirements?** Light users solve the SSO problem where company email addresses can't be added as free guests. The role provides a cost-effective middle ground between guests and full members.
:::
...
Don't confuse Light members with [Guests](/products/pro/documenting/guests/). Light members are paid users within your organization with their own login credentials at a discounted rate. Guests are external email addresses (like customers or vendors) who only access specific tasks via email links - they're completely free and unlimited.
:::
...
### Cost-saving strategies with Light members
...
2. **Convert task-only users** - Switch them to Light member status for immediate savings
...
:::tip[Maximum savings example]
A 100-person company with 20 process designers and 80 field workers? Keep 20 Full member licenses for the designers. Convert those 80 field workers to Light members. You'll see substantial savings on your member costs while maintaining full functionality. Check our [pricing page](https://tallyfy.com/pricing/) for current rates.
:::

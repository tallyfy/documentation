---
description: To change a member's role in Tallyfy administrators can navigate to Settings
  > Organization > Members click the member's name select the new role from the dropdown
  and save the changes which take effect immediately.

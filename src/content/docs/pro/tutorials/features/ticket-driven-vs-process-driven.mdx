---
description: Process-driven workflows transform basic ticket handling into structured
  systems with clear accountability and automated routing while ticket-driven workflows
  rely on individual agents managing separate conversations through various channels
  like email phone and chat.

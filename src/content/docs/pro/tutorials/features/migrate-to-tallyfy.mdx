---
about_tallyfy: true
description: Tallyfy's open-source migrator scripts move data from workflow and form
  tools like Asana ClickUp Monday.com Pipefy Process Street Trello and others through

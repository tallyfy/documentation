---
description: Tallyfy provides open-source migrator scripts that help users move data
  from popular workflow and form tools through a five-phase process including discovery
  mapping transformation migration and validation with support for platforms like
  Asana Basecamp ClickUp Google Forms Monday.com Pipefy Process Street Trello and
  many others.

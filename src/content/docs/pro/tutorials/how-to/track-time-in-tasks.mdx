---
about_tallyfy: true
description: Add number fields with validation rules to Tallyfy tasks to capture hours
  and minutes spent, enabling accurate time measurement and cost analysis.

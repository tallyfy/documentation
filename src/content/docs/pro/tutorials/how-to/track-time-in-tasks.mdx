---
about_tallyfy: true
description: Tallyfy enables time tracking within workflows by adding number-validated
  form fields for hours and minutes to each task so assignees can record actual effort
  spent rather than relying on elapsed-time timestamps which are often skewed by holidays
  and external delays.

---
about_tallyfy: true
description: Track actual work effort by adding hours and minutes fields to Tallyfy
  tasks. Direct time input gives cleaner data than elapsed-time timestamps, which
  are often skewed by holidays and external delays.
...
Use [automations](/products/pro/documenting/templates/automations/) to trigger actions based on time entries:

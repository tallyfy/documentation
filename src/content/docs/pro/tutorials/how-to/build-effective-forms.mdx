---
about_tallyfy: true
description: Tallyfy builds forms directly into workflow steps, so every submission
  triggers a trackable process. Public forms include email verification, and multi-step
  forms support conditional branching, field validation, document generation, and

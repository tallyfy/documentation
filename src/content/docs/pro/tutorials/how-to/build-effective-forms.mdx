...
description: Tallyfy builds forms directly into workflow steps so that every submission
  ...
  and supports conditional branching and field validation across multiple steps while
  enabling document generation and real-time collaboration.
...
<LinkTitleCard header="<b>Features > Structure intake</b>" href="/products/pro/tutorials/features/structure-intake/" > Tallyfy turns form submissions into the first step of a structured workflow so that data flows... </LinkTitleCard>
...
<LinkTitleCard header="<b>Tasks > Types of form fields</b>" href="/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/" > Tallyfy offers multiple form field types—including short text, long text, dropdowns, checklists... </LinkTitleCard>
</CardGrid>
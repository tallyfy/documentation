---
about_tallyfy: true
description: Tallyfy builds forms directly into workflow steps so that every submission
  automatically triggers a trackable process with email verification for public forms
  and supports conditional branching and field validation across multi-step forms
  while enabling document generation and real-time collaboration with built-in comments
  and notifications.

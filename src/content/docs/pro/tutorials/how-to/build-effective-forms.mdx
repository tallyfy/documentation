---
about_tallyfy: true
description: Tallyfy lets you build forms that automatically trigger trackable workflows
  upon submission and spread fields across multiple steps with conditional branching
  and email verification and document generation and real-time saving so that data
  collection is directly tied to actionable processes rather than sitting in a standalone
  tool.

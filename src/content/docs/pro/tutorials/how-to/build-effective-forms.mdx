---
about_tallyfy: true
description: Tallyfy connects form submissions directly to trackable workflows so
  that every response automatically triggers defined process steps with email verification
  for public forms and supports conditional branching and document generation along
  with field validation and collaborative multi-step completion across teams.

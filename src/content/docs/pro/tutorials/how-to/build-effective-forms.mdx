...
sidebar:
  order: 3
snippet: Forms in Tallyfy connect data collection directly to trackable workflows
  while offering features like email verification field validation conditional branching
  and automatic document generation to streamline information gathering and process
  execution.

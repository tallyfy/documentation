...
sidebar:
  order: 3
snippet: Tallyfy enables organizations to build forms that integrate directly with
  trackable workflows rather than just collecting data through features like email
  verification conditional branching field validation collaborative completion and

---
about_tallyfy: true
description: Task debt occurs when unfinished tasks accumulate faster than teams complete
  them and Tallyfy addresses this through expiring tasks that auto-complete at their
  deadline along with strategic workflow design principles like bundling related work
  and using conditional logic and smart assignment strategies to prevent buildup in
  the first place.

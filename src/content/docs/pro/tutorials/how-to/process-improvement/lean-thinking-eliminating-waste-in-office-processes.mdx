---
about_tallyfy: false
description: Lean thinking applies Toyota's waste-elimination philosophy to office
  work by identifying eight types of waste (TIM WOODS) in knowledge processes and
  using five core principles—defining customer value and mapping value streams and
  creating flow and establishing pull and pursuing continuous improvement—to dramatically
  reduce cycle times and eliminate non-value-adding activities like unnecessary approvals
  and waiting and rework.

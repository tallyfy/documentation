...
sidebar:
  order: 6
snippet: Lean principles maximize customer value by identifying and eliminating eight
  types of waste in office environments through efficient process management and standardization
  techniques.

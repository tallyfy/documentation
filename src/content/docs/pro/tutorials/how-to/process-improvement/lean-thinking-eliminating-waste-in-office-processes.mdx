---
about_tallyfy: false
description: 'Lean thinking applies Toyota''s waste-elimination approach (TIM WOODS) to office work by defining customer value and removing non-value-adding steps through five core principles. Tallyfy embeds these ideas into daily workflows.'
...
4.  **W - Waiting**: Idle time waiting for information, approvals, decisions, or a previous step to finish.
    *   *Office example*: A project stalled because a decision-maker isn't available. An employee stuck waiting for data from another department.
...
8.  **S - Skills (unused talent)**: Failing to use your team's knowledge, creativity, and experience. Also includes assigning tasks to people without the right skills or burdening skilled workers with mundane work.

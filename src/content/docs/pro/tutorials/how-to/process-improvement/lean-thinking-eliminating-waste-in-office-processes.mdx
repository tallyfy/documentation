...
sidebar:
  order: 6
snippet: Apply Lean principles to identify and eliminate the 8 common wastes (TIM
  WOODS) in your office workflows, boosting efficiency and value with Tallyfy.

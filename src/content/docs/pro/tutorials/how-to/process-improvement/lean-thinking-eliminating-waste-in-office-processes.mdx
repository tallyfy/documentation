...
<CardGrid>
  ...
  <LinkTitleCard header="<b>Kaizen: making continuous small improvements with Tallyfy</b>" href="../kaizen-making-continuous-small-improvements-with-tallyfy/" >Lean thinking is a core component of the Kaizen philosophy for continuous improvement.</LinkTitleCard>
  <LinkTitleCard header="<b>Documenting > Templates > Edit templates > Adding conditional logic (rules)</b>" href="../../../documenting/templates/edit-templates/adding-conditional-logic-rules/" >Conditional logic in Tallyfy helps eliminate over-processing and overproduction by ensuring only relevant steps are activated.</LinkTitleCard>
  <LinkTitleCard header="<b>Integrations > Overview</b>" href="../../../integrations/" >Integrate Tallyfy with other tools to reduce waste like motion (manual data transfer) and defects (re-entry errors).</LinkTitleCard>
</CardGrid>
...
sidebar:
  order: 6
snippet: Lean thinking maximizes customer value by identifying and eliminating eight
  types of waste in office processes through standardized templates and automation
  tools that streamline workflows and reduce inefficiencies.
...
2.  **I - Inventory**: Excess work-in-progress, backlogs of tasks, unread emails, stockpiles of outdated reports, or even too many pending approvals.
    ...
    *   *Tallyfy Helps*: Provides visibility into workloads and queues via the [Tracker view](../../../tracking-and-tasks/tracker-view/). Deadlines and automated reminders help keep work flowing, reducing inventory buildup.
...
5.  **O - Overproduction**: Doing more work than necessary, sooner than necessary, or in greater quantities than needed. This includes creating reports no one uses or providing excessive detail.
    ...
    *   *Tallyfy Helps*: Processes are launched on demand. [Conditional logic (rules)](../../../documenting/templates/edit-templates/adding-conditional-logic-rules/) can ensure only necessary steps are activated, preventing work from being done prematurely.

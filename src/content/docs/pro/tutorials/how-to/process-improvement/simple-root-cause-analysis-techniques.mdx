...
description: Root Cause Analysis uses techniques like the 5 Whys and Fishbone Diagrams
  along with advanced methods such as Pareto analysis and FMEA to trace process problems
  beyond their symptoms to their true underlying causes so teams can implement lasting
  fixes instead of temporary workarounds.

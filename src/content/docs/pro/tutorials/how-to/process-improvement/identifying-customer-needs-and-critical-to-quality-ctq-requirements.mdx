...
sidebar:
  order: 4
snippet: The Voice of the Customer and Critical to Quality requirements are essential
  foundations for improving business processes by focusing on customer needs and translating
  them into measurable targets that drive meaningful outcomes.
title: Identifying customer needs and Critical to Quality (CTQ) requirements
---
...
Tallyfy Pro enables you to build and manage processes with your customers' CTQs at the forefront:

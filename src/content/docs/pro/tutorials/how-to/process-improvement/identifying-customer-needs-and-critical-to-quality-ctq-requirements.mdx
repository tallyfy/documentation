---
description: Process improvement initiatives achieve optimal results by capturing
  the Voice of the Customer through surveys interviews and feedback mechanisms then
  translating those insights into measurable Critical to Quality requirements that
  can be systematically implemented and tracked within workflow management systems.

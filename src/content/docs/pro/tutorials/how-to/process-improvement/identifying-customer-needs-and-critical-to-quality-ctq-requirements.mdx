...
sidebar:
  order: 4
snippet: Learn to uncover what your customers truly value (Voice of the Customer)
  and translate these into measurable CTQ requirements to guide process improvements.

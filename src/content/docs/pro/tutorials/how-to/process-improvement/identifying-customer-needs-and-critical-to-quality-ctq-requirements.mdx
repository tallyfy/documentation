...
<CardGrid>
  ...
  <LinkTitleCard header="<b>Tracking and Tasks > Tasks > What are form fields in Tallyfy?</b>" href="../../../tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/" >Form fields in Tallyfy allow you to capture structured data within your tasks, essential for collecting customer requirements or process inputs needed to meet CTQs.</LinkTitleCard>
  <LinkTitleCard header="<b>Documenting > Templates > Edit templates > Setting deadlines</b>" href="../../../documenting/templates/edit-templates/setting-deadlines/" >Learn how to set and manage deadlines within your Tallyfy templates to ensure processes meet time-sensitive customer requirements (CTQs).</LinkTitleCard>
  <LinkTitleCard header="<b>Understanding your current processes with Tallyfy</b>" href="../understanding-your-current-processes-with-tallyfy/" >Before defining customer needs, ensure you understand the processes that deliver value to them.</LinkTitleCard>
</CardGrid>
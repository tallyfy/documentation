---
about_tallyfy: false
description: Effective process improvement starts with capturing real customer feedback
  through surveys and interviews then categorizing those needs using the Kano Model
  and converting them into specific measurable Critical to Quality requirements that
  can be directly built into Tallyfy workflows through deadlines and form fields and

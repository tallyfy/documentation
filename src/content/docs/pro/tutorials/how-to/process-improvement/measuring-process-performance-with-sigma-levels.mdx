---
about_tallyfy: false
description: Sigma levels measure process quality as defects per million opportunities
  (DPMO). Learn how this metric reveals why even 99% quality allows thousands of errors,
  and how to set targets from 3 sigma for internal workflows to 6 sigma for life-critical
  processes.

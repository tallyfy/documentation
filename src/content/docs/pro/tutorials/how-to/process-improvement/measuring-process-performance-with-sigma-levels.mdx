---
about_tallyfy: false
description: Sigma levels measure process quality using defects per million opportunities
  as a universal metric that reveals how even seemingly high percentages like 99%
  still allow thousands of errors in critical fields like healthcare and finance while
  providing context-appropriate targets ranging from 3 sigma for internal workflows
  up to 6 sigma for life-critical processes.

---
about_tallyfy: false
description: Sigma levels use defects per million opportunities (DPMO) to measure
  process quality on a universal scale—ranging from 1 sigma (31% success) to 6 sigma
  (99.99966% success)—so organizations can set context-appropriate quality targets
  and prioritize improvement investments where they will have the greatest customer
  impact.

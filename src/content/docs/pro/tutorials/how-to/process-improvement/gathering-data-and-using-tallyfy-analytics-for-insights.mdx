---
about_tallyfy: false
description: Effective process improvement relies on collecting both output measures
  like error rates and cycle times alongside in-process metrics like step durations
  and queue times and Tallyfy Analytics automatically captures task completion times
  and workload distribution so you can connect your own BI tools to spot bottlenecks
  and track trends without manual data gathering.

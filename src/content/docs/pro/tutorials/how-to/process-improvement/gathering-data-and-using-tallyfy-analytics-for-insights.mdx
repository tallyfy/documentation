---
about_tallyfy: false
description: Effective process improvement relies on collecting both output and in-process
  metrics aligned with what customers value and Tallyfy Analytics lets you connect
  your own BI tools to automatically captured workflow data—like task completion times
  and bottleneck patterns—so you can spot problems early and validate whether changes
  actually work.

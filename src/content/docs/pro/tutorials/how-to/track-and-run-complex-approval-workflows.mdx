...
For example:
```automation
IF field "Purchase Category" is "Software"
THEN add assignees to "Vendor Privacy Review" with "Jane Doe"
```
...
- **Escalation paths** - create [automations](/products/pro/documenting/templates/automations/actions/status-actions/) that notify managers about delays.

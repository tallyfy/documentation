---
about_tallyfy: true
description: Tallyfy converts complex multi-level approval processes into structured
  trackable workflows with kick-off forms and conditional routing and real-time status
  dashboards and automated reminders so nothing gets lost or delayed.

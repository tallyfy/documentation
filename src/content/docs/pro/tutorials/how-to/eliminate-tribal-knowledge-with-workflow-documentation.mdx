...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Tutorials > Why training fails</b>" href="/products/pro/tutorials/why-documentation-training-fails-forgetting-curve/" > Hermann Ebbinghaus's 1885 research revealed that humans forget information exponentially with 90% lost within seven days which explains why traditional business training and documentation approaches fail because they rely on memory retention rather than providing real-time guidance when employees actually need to perform tasks. </LinkTitleCard>

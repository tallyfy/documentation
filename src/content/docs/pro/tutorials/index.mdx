...
* **Automate decisions** - Set up automations that handle repetitive work
...
* **[Automations](/products/pro/documenting/templates/automations/)** - If-then workflows that run themselves

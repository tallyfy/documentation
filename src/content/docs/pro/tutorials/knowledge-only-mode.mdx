...
**Conditional display** - Use [automations](/products/pro/documenting/templates/automations/) to show different snippets based on user properties. Show region-specific regulations only to relevant teams.

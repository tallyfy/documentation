...
description: Tallyfy lets you publish procedures as searchable reference materials
  ...
  through comments and embedded templates and snippets so everyone always finds the
  latest approved information in seconds.
...
<LinkTitleCard header="<b>How To > Eliminate tribal knowledge</b>" href="/products/pro/tutorials/how-to/eliminate-tribal-knowledge-with-workflow-documentation/" > Tribal knowledge is critical business information trapped inside employees' heads that creates... </LinkTitleCard>
</CardGrid>
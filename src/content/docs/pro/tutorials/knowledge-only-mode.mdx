---
description: Use Tallyfy as a knowledge management system for documenting procedures
  and enabling change management without tracking execution - perfect for reference
  materials training guides and standard operating procedures that teams need to read
  but not formally complete.

...
sidebar:
  order: 20
description: Use Tallyfy as a knowledge management system for documenting procedures and enabling change management without tracking execution - perfect for reference materials training guides and standard operating procedures that teams need to read but not formally complete.
...
<LinkTitleCard header="<b>Templates > Snippets</b>" href="/products/pro/documenting/templates/snippets/" > Snippets are reusable content blocks in Tallyfy that automatically update across all templates when edited centrally eliminating copy-paste errors and ensuring consistent approved language throughout your organization's workflows and documentation. </LinkTitleCard>
<LinkTitleCard header="<b>Integrations > MCP Server</b>" href="/products/pro/integrations/mcp-server/" > Connect Tallyfy to AI platforms through Model Context Protocol enabling intelligent workflow automation voice-controlled task management and natural language process queries while maintaining security and access controls across integrated systems. </LinkTitleCard>
<LinkTitleCard header="<b>Members > Light Members</b>" href="/products/pro/documenting/members/light-members/" > Light members are view-only users in Tallyfy who can complete assigned tasks and view processes but cannot create or edit templates making them perfect for employees who execute workflows without needing administrative capabilities. </LinkTitleCard>
</CardGrid>
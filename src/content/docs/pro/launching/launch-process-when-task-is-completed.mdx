...
sidebar:
  order: 3
snippet: Tallyfy enables automatic process chaining by launching new workflows when
  specific tasks are completed allowing seamless transitions between related processes
  through task triggers or process injection options.

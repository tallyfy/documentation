...
sidebar:
  order: 3
snippet: Tallyfy enables automatic process chaining by launching new workflows or
  injecting tasks when specific tasks are completed allowing seamless transitions
  between related processes based on customizable triggers and configurations.

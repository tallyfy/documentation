...
sidebar:
  order: 3
snippet: The system enables automatic process launching upon task completion by selecting
  a template configuring process names and establishing parent-child relationships
  through unique ID tags for tracking purposes.

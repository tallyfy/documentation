---
about_tallyfy: true
description: Configure any task in a template to automatically launch a new process
  from a different template when it completes. You can also inject those tasks directly
  into the current process instead of creating a separate one.

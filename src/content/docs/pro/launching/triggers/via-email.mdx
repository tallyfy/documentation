...
**Better approach**: Use [kick-off forms](/products/pro/launching/triggers/kick-off-forms/) or [public forms](/products/pro/launching/triggers/public-forms/) instead. With structured forms:

...
### How can I launch Tallyfy processes by sending an email?
...
When someone sends an email to that special Tallyfy address, the following automated sequence occurs:

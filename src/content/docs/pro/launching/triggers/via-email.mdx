---
description: Email triggers in Tallyfy allow team members to launch workflow processes
  by sending emails to unique template-specific addresses without requiring login
  access or dealing with required kick-off form fields.

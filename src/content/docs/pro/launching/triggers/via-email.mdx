---
description: Tallyfy enables process launching through email triggers where sending
  an email to a template's unique address automatically starts a new workflow instance
  using the email subject as the process name while capturing content and attachments
  through specially configured kick-off fields.

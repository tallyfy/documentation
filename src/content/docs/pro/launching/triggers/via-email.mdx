---
description: Email triggers in Tallyfy allow launching processes by sending emails
  to unique template addresses with automatic validation and data capture capabilities.

...
sidebar:
  order: 8
snippet: Tallyfy enables process initiation through email by providing unique addresses
  for templates allowing users to start workflows remotely while capturing email content
  and attachments into designated form fields.

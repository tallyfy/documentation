---
about_tallyfy: true
description: "Launch a Tallyfy process by sending an email to a template's unique trigger address. Tallyfy verifies the sender is an active member and uses the email subject line as the process name."

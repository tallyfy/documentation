---
description: Tallyfy enables users to launch specific process templates by sending
  emails to unique template addresses with the email subject becoming the process
  name and optional fields for capturing email content and attachments.

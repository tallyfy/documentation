...
sidebar:
  order: 8
snippet: Tallyfy enables process automation through a unique email-based launch system
  where users can trigger workflows by sending emails to template-specific addresses

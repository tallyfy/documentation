---
description: Tallyfy enables launching processes directly via email by sending messages
  to unique template addresses which automatically validates sender membership checks
  for required fields and creates new workflow instances using the email subject as
  the process name while optionally capturing email content and attachments into designated
...
Validate.link: "/products/pro/documenting/members/index/"
Validate.tooltip: "Learn about member management"
Check.link: "/products/pro/launching/triggers/kick-off-forms/"
Check.tooltip: "Understanding kick-off forms"
```

---
about_tallyfy: true
description: Tallyfy offers seven ways to start a process, from manual clicks and
  form submissions to API calls, emails, magic links, recurring schedules, and task
  completion chains. Some triggers can pre-fill kick-off form data to cut manual entry.

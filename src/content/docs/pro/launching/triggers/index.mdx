...
<LinkTitleCard header="<b>Triggers > Email triggers</b>" href="/products/pro/launching/triggers/via-email/" > Launch a Tallyfy process by sending an email to a template's unique trigger address. Tallyfy... </LinkTitleCard>
</CardGrid>
...
<LinkTitleCard header="<b>Triggers > Email triggers</b>" href="/products/pro/launching/triggers/via-email/" > Launch Tallyfy processes by sending emails to template-specific addresses where the subject becomes the process name and content fills kick-off fields. </LinkTitleCard>
</CardGrid>
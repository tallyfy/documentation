---
about_tallyfy: true
description: Magic links in Tallyfy are special URLs that automatically trigger actions
  like launching processes and completing tasks or pre-filling form fields when clicked
  by a logged-in user or even by external guests through public kick-off forms.

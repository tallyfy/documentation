...
| Launch [processes](/products/pro/tracking-and-tasks/processes/) | Start new process instances | Template execution from external systems |
...
1. Navigate to the Magic Links section
2. Click **Get a Magic Link**
3. Select **Launch a [Process](/products/pro/tracking-and-tasks/processes/)** from the dropdown
...
<LinkTitleCard header="<b>Triggers > Launch via inbound email</b>" href="/products/pro/launching/triggers/via-email/" > Tallyfy enables automatic process initiation through email triggers by allowing users to start workflows by sending emails to designated addresses which capture content and attachments into process fields. </LinkTitleCard>

...
sidebar:
  order: 3
snippet: Magic links are special URLs that automate Tallyfy actions like launching
  processes creating tasks or updating fields when clicked by logged-in users through

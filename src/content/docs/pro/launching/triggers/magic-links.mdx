---
description: Magic links are special URLs that automatically trigger Tallyfy actions
  like creating tasks launching processes or updating data when logged-in users click
  them and can be used in emails websites or other tools to streamline workflow operations.

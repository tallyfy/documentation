---
description: Magic links are special URLs that enable logged-in Tallyfy users to automatically
  trigger actions like launching processes completing tasks adding comments or updating
  form fields when clicked from emails websites or other tools.
...
*   **Edit Deadline:** `...?action=editDeadline&task_id=[TaskID]&deadline=YYYY-MM-DD+17:00:00`

---
description: Middleware platforms enable automatic Tallyfy process launches by watching
  for events in external applications and seamlessly transferring data to create workflows
  without manual intervention or coding requirements.
...
See our [middleware integration guide](/products/pro/integrations/middleware/) for platform-specific setup instructions.

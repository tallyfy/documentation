...
description: Middleware platforms like Zapier and Make.com let you automatically launch
  Tallyfy processes from events in other apps, like form submissions or new CRM
  records. They watch for triggers and pass mapped data into Tallyfy kick-off forms

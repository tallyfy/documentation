---
description: Middleware tools bridge Tallyfy with other software by automatically
  launching processes when triggered by external events like form submissions or CRM
  updates through platforms like Make.com Power Automate or Zapier.
...
*   A Tallyfy<sup>®</sup> account with permission to launch Tallyfy<sup>®</sup> processes.
*   An account with a [middleware](/products/pro/integrations/middleware/) platform (e.g., Make.com, Power Automate, Zapier).
*   A Tallyfy<sup>®</sup> [process template](/products/pro/documenting/templates/) to launch automatically.

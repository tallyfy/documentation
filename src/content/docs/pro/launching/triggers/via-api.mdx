...
```d2
# An outside system starts a Tallyfy process
direction: down

YourSystem: Your Other System {
  style.stroke: "#225930"
  style.stroke-dash: 3
...
Tallyfy: Tallyfy {
  ...
  Receive: Receives the call {
    style.fill: "#f2faf4"
    style.stroke: "#225930"
  }

  SetFields: Fills kick-off\nform fields {
    style.fill: "#f2faf4"
    style.stroke: "#225930"
  }
...
Confirmed: Sends back a process ID {
  style.fill: "#e1f7e6"
  style.stroke: "#225930"
}

YourSystem.Event -> Tallyfy.Receive: Calls the API
Tallyfy.Receive -> Tallyfy.SetFields
Tallyfy.SetFields -> Tallyfy.Started
Tallyfy.Started -> Confirmed
```

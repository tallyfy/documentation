...
description: Tallyfy processes can be automatically launched on recurring schedules
  using middleware platforms like Zapier or Make.com as well as custom API-based solutions
  with server-side schedulers to run repeating workflows without manual intervention.
...
:::note[Process naming]
For scheduled [processes](/products/pro/tracking-and-tasks/processes/), use consistent names that include the date/time for easier tracking. Example: "Monthly Compliance Check - January"
:::

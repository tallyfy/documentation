---
description: Kick-off forms in Tallyfy collect essential information before workflow
  tasks begin and can be shared publicly to allow external users to start processes
  automatically with progress tracking capabilities.

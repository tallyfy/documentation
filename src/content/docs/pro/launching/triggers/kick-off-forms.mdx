---
about_tallyfy: true
description: Kick-off forms in Tallyfy collect essential information at the start
  of a template and feed that data directly into subsequent workflow steps while also
  supporting public sharing so external users like customers or vendors can submit
  a form to automatically launch an internal process with email verification and progress
  tracking.

...
description: Kick-off forms in Tallyfy attach to process templates to collect essential
  information before workflow tasks begin and can be made public for external stakeholders
  to initiate processes while automatically launching tracked workflows upon submission.

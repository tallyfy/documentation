...
Kick-off forms are forms attached to the very beginning of a Tallyfy<sup>®</sup> [template](/products/pro/documenting/templates/). They ensure you collect all the necessary starting information *before* the main workflow [tasks](/products/pro/tracking-and-tasks/tasks/) begin.
...
Unlike basic online forms, Tallyfy<sup>®</sup> kick-off forms are directly linked to the rest of the workflow. When someone submits the form, the process starts immediately, and everyone can track its progress.

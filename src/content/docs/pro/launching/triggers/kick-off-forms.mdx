...
Form -> Data: Submitted once
Data -> Step1: Pre-fills
Data -> Step2: Pre-fills
Data -> Step3: Pre-fills
Data -> Info: Stays visible
```
...
### Changing kick-off answers after launch
...
[Automations](/products/pro/documenting/templates/automations/) don't. An automation that already ran when the process launched won't run again after you change an answer:
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Launching > Launch from a form</b>" href="/products/pro/launching/how-to-launch-a-tallyfy-process-from-a-webform/" > External web forms can automatically launch Tallyfy processes. Use a public kick-off form link... </LinkTitleCard>

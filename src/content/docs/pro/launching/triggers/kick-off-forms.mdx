...
description: Kick-off forms in Tallyfy attach to process templates to collect essential
  information before workflows begin and can be shared publicly for external stakeholders
  to initiate processes while automatically launching trackable workflows upon submission.
...
## Kick-off forms for process launching

Kick-off forms attach to the beginning of Tallyfy templates, ensuring information collection before main workflow tasks commence.

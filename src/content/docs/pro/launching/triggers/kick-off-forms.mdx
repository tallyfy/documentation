...
description: Kick-off forms in Tallyfy collect essential information at the start
  of a template and feed that data directly into subsequent workflow steps — supporting
  both internal users and external submitters through public shareable links with

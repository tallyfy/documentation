---
about_tallyfy: true
description: Fix common Tallyfy process launch problems - permission errors for Standard
  members, launcher assignment behavior, Magic Link failures with kick-off forms,
  and API integration permission issues.

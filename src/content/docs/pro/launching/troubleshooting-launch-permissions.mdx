---
description: This guide explains how to troubleshoot and resolve common issues when
  launching processes in Tallyfy including permission errors for Standard members
  group assignment behaviors Magic Link failures with kick-off forms dropdown field
  mapping problems in Power Automate and API integration permission errors.

---
about_tallyfy: true
description: Most process launch problems come from missing Standard member permissions
  or draft templates. Fix them by granting launch access on the Permissions tab, checking
  launcher assignment settings, and making sure Magic Links include required kick-off
  values.

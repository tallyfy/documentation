---
about_tallyfy: true
description: Tallyfy process launch problems typically stem from missing permissions
  for Standard members or draft templates and can be resolved by granting explicit
  launch access on the template's Permissions tab while also checking settings like
  automatic launcher assignment and ensuring Magic Links include all required kick-off
  field values.

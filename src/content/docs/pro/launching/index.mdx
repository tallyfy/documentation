...
graph TD
 ...
 Manual["Manual Launch"] --> Process["Active Process"]
 API["API/Webhook"] -.-> Process
 Task["Task Completion"] -.-> Process
 Form["Web Form"] -.-> Process
 Email["Email Trigger"] -.-> Process
 Magic["Magic Link"] -.-> Process
 Template --> Manual
 Template --> API
 Template --> Task
 Template --> Form

...
description: Process launching in Tallyfy transforms reusable templates into active
  trackable workflow instances with specific assignments deadlines and independent
  progress tracking through various methods including manual launching automatic triggers
  and web form integration.
...
Manual -> Process
API: "API/Webhook" -> {style.stroke-dash: 5} Process
Task: "Task Completion" -> {style.stroke-dash: 5} Process
Form: "Web Form" -> {style.stroke-dash: 5} Process
Email: "Email Trigger" -> {style.stroke-dash: 5} Process
Magic: "Magic Link" -> {style.stroke-dash: 5} Process
Template -> Manual
Template -> API
Template -> Task
Template -> Form

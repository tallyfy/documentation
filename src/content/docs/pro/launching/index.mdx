...
graph TD
    ...
    Template --> Manual["`**1. Manual Launch**
    User clicks Run`"]
    
    Template --> API["`**2. API/Webhook**
    External system trigger`"]
    
    Template --> Cascade["`**3. Task Completion**
    Chain from other process`"]
    
    Template --> WebForm["`**4. Web Form**
    Public form submission`"]
    
    Template --> Email["`**5. Email Trigger**
    Send to process email`"]
    
    Template --> Magic["`**6. Magic Link**
    Click special URL`"]
    
    Manual --> Process["`**Active Process**
    Running Instance`"]
    ...
    click WebForm "/products/pro/launching/how-to-launch-a-tallyfy-process-from-a-webform/" "Web form launching"
    ...
    click Cascade "/products/pro/launching/launch-process-when-task-is-completed/" "Task completion triggers"
```

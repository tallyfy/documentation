---
about_tallyfy: true
description: Tallyfy lets you launch reusable templates into independent live processes
  — each with its own assignments and deadlines — through six different methods including
  manual clicks and API calls and email triggers and magic links while allowing you
  to customize names and deadlines and assignments at launch time without ever altering

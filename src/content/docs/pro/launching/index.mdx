---
about_tallyfy: true
description: Tallyfy lets you launch reusable templates into independent trackable
  processes, each with its own name, deadlines, and assignments. Choose from six
  methods including manual clicks, API calls, email triggers, and magic links.
  Template edits only affect future launches and never alter already-running work.

---
description: Tallyfy's process launching transforms reusable templates into active
  trackable workflow instances with assignments deadlines and independent timelines
  that can be initiated manually or through automated triggers like APIs webhooks
  forms email or task completion while allowing customization during launch.

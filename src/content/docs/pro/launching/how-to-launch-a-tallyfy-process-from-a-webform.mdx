...
<LinkTitleCard header="<b>Triggers > Email triggers</b>" href="/products/pro/launching/triggers/via-email/" > Email triggers in Tallyfy allow users to launch processes by sending emails to unique template addresses with automatic validation of sender membership and content capture through special kick-off fields while requiring templates to have only optional fields for successful email-based process initiation. </LinkTitleCard>
</CardGrid>
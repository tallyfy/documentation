...
sidebar:
  order: 2
snippet: External web forms can be configured to automatically trigger Tallyfy processes
  by redirecting form submissions to a template-specific URL that contains mapped
  field data as query parameters.

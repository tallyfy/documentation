...
<LinkTitleCard header="<b>Triggers > Email triggers</b>" href="/products/pro/launching/triggers/via-email/" > Email triggers in Tallyfy allow users to launch workflows by sending emails to unique template-specific addresses which automatically start processes using the email subject as the process name and can capture email content and attachments through special kick-off form fields while requiring the sender to be an active organization member. </LinkTitleCard>
</CardGrid>
...
<LinkTitleCard header="<b>Triggers > Email triggers</b>" href="/products/pro/launching/triggers/via-email/" > Tallyfy templates can be launched via email by sending messages to unique template addresses which automatically creates new process instances using the email subject as the process name while capturing email content and attachments in designated kick-off form fields. </LinkTitleCard>
</CardGrid>
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Settings > Remove a member</b>" href="/products/pro/settings/org-settings/how-can-i-remove-a-member-from-my-tallyfy-organization/" > Step-by-step guide for removing members including deletion constraints, administrator protection rules, and task reassignment procedures. </LinkTitleCard>
<LinkTitleCard header="<b>API > Remove member endpoint</b>" href="/products/pro/integrations/open-api/code-samples/members/remove-member/" > Technical documentation for programmatically removing members via API including error handling and reassignment parameters. </LinkTitleCard>
<LinkTitleCard header="<b>Settings > Understanding member statuses</b>" href="/products/pro/settings/org-settings/understanding-member-statuses/" > Explanation of different member statuses including Active, Invited, Deactivated, and Bot/Unbilled with their implications for access and billing. </LinkTitleCard>
</CardGrid>
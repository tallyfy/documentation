...
description: Tallyfy's System Log gives administrators a single place to see webhook
  failures, email delivery events, billing changes, security events, automatic process
  actions, and AI usage for their organization. Three tabs cover system events, email
  events, and AI usage. Data is retained for 90 days and can be filtered, searched,
  and exported as CSV.

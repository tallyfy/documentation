---
about_tallyfy: true
description: Tallyfy's System Log gives administrators one place to see webhook failures,
  email delivery, billing changes, security and authentication events, bot process
  actions, and AI usage. Events are retained for 18 months and export as CSV. The
  screens ship with the new Tallyfy client and are not yet generally available.

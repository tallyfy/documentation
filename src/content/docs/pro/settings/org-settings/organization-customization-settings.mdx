...
sidebar:
  order: 5
snippet: Administrators can customize Tallyfy through organization settings to control
  member permissions domain management content creation task handling onboarding schedules
  notifications and webhook formatting options.

---
description: Tallyfy member status types indicate user access levels and account status
  with Active members being users who can log in Invited being pending
  users Deactivated being removed users and Bot/Unbilled being special accounts
  for integrations or system functions that don't count toward account limits.

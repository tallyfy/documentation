---
description: Tallyfy administrators can permanently delete their organization account
  by accessing billing settings and submitting an official closure form which will
  irreversibly remove all data processes templates and user information.

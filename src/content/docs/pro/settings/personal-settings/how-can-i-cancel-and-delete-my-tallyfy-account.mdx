...
sidebar:
  order: 5
snippet: Administrators can permanently delete their Tallyfy organization account
  by accessing billing settings and submitting an official closure form with the correct
  Organization ID which results in irreversible data removal.

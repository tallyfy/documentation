---
about_tallyfy: true
description: Tallyfy uses a credit-based billing system through Recurly where you only pay for active members. Pro-rated credits are returned when members are removed, and failed payments progress from grace period to read-only mode to suspension.

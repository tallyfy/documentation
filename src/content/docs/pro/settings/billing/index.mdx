---
about_tallyfy: true
description: Tallyfy manages billing through a credit-based system where you only
  pay for active members and pro-rated credits are returned for unused time while
  failed payments trigger a structured process from grace period to read-only mode
  to suspension and eventual data deletion after 30 days.

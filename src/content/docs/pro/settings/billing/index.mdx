...
Here's who actually uses one of your paid seats, and who doesn't cost you anything:

```d2
# Who uses a paid seat
grid-columns: 3
grid-gap: 40
...
Full: Full Member {
  ...
  Cost: Uses a paid seat {
    style.fill: "#e1f7e6"
    style.stroke: "#225930"
  }
  Build: Can build templates {
    style.fill: "#e1f7e6"
    style.stroke: "#225930"
  }
  Work: Tracks and completes tasks {
    style.fill: "#e1f7e6"
    style.stroke: "#225930"
  }
}
...
Light: Light Member {
  ...
  Build: Can't build templates {
    style.fill: "#e1f7e6"
    style.stroke: "#225930"
  }
  Work: Completes assigned tasks {
    style.fill: "#e1f7e6"
    style.stroke: "#225930"
  }
}
...
Guest: Guest {
  ...
  Work: Completes only shared tasks {
    style.fill: "#f2faf4"
    style.stroke: "#225930"
  }
}
...
**What to notice:**
- Full and Light members both use one of your paid seats. Guests never do.
- Only Full members can build or edit templates.
- Light members complete the tasks assigned to them. Guests only see the specific tasks you share with them.
...
To close an organization, an Administrator submits our [official account closure form](https://tallyfy.com/account-closure-request-form/). See [delete your account](/products/pro/settings/personal-settings/how-can-i-cancel-and-delete-my-tallyfy-account/) for the full process.

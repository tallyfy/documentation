...
*   **Active seats** are the seats in use right now. A seat is taken the moment you invite someone, not when they accept, and it returns to the pool when that member is deactivated or the invite is revoked.
...
*   **Reducing seats** lowers your committed pool straight away, though never below the number of members currently active. What you pay does not change until your next renewal, when the lower count takes effect.

This means you're never billed more than the seats you committed to, and lowering your pool mid-term does not reduce what you pay until the term turns over.
...
The free 3 seats cover the seats themselves. The Analytics add-on is charged separately if you turn it on.
:::

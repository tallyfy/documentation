---
about_tallyfy: false
description: Tallyfy works as a workflow layer above KUKA's robot fleet, from 6kg collaborative arms to 1300kg heavy-duty systems. It provides SOP documentation, audit trails, and fleet-wide visibility that KUKA's native tools don't cover.
...
You can load programs onto controllers in a few ways:

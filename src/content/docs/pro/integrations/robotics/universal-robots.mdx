---
about_tallyfy: false
description: Universal Robots cobots run on static locally-stored programs that can't
  dynamically query procedures or share process improvements across robot fleets and
  a conceptual workflow management integration with a system like Tallyfy could address
  gaps in cross-robot knowledge sharing and compliance traceability by serving as
  a centralized SOP and audit trail layer above PolyScope.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Robotics > KUKA Robotics integration</b>" href="/products/pro/integrations/robotics/kuka/" > Tallyfy can serve as a workflow and procedure management layer above KUKA's industrial robot... </LinkTitleCard>
<LinkTitleCard header="<b>Robotics > Unitree Robotics integration</b>" href="/products/pro/integrations/robotics/unitree/" > Unitree Robotics builds quadruped and humanoid robots with strong SDKs for movement control but... </LinkTitleCard>
<LinkTitleCard header="<b>Integrations > Robotics</b>" href="/products/pro/integrations/robotics/" > Integrating robot systems with human workflows requires bridging proprietary control protocols... </LinkTitleCard>

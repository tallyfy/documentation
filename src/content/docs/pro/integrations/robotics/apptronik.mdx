---
about_tallyfy: false
description: Tallyfy can work as a workflow management layer for Apptronik's Apollo
  humanoid robots, connecting through a ROS bridge to fill gaps in fleet coordination,
  procedure updates, and compliance documentation.
...
**Fleet coordination** - A central procedure repository that all robots access. Updates propagate automatically. It aggregates performance data across the fleet and generates compliance documentation along the way.
...
<LinkTitleCard header="<b>Robotics > Boston Dynamics integration</b>" href="/products/pro/integrations/robotics/boston-dynamics/" > Boston Dynamics Spot robots handle industrial inspections across 1500+ deployments worldwide but lack cross-site knowledge sharing and dynamic conditional logic in their mission recordings and a workflow platform like Tallyfy could fill those gaps by adding centralized procedure repositories with version control and compliance documentation through Orbit's REST API and webhook integrations. </LinkTitleCard>

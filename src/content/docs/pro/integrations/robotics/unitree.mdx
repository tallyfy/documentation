...
description: Unitree Robotics builds quadruped and humanoid robots with strong SDKs
  for movement control but lacks workflow management for fleet coordination. Tallyfy
  could serve as a centralized process layer that delivers procedures and logs task
  completions across a robot fleet.
...
- You'll need to build custom connector middleware

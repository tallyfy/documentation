---
about_tallyfy: false
description: Unitree Robotics builds quadruped and humanoid robots with strong SDKs
  for movement control but lacks operational workflow management for fleet coordination
  and procedure tracking where Tallyfy could serve as a centralized process layer
  that dynamically delivers inspection procedures and logs every task completion across
  an entire robot fleet through API integration.

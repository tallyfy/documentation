---
about_tallyfy: false
description: Boston Dynamics Spot robots used in over 1500 industrial sites face workflow
  gaps like static mission recordings without conditional logic and no cross-site
  knowledge sharing - problems a workflow platform could address via Orbit's API and

---
about_tallyfy: false
description: Boston Dynamics Spot robots handle autonomous industrial inspections
  across 1500+ deployments worldwide but lack centralized procedure management and
  cross-site knowledge sharing that a workflow platform could provide through Orbit's
...
<LinkTitleCard header="<b>Robotics > Universal Robots integration</b>" href="/products/pro/integrations/robotics/universal-robots/" > Universal Robots makes collaborative robots with strong motion control and visual programming... </LinkTitleCard>

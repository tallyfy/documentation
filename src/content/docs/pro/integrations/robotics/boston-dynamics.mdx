---
about_tallyfy: false
description: Boston Dynamics Spot robots handle industrial inspections across 1,500+ deployments but lack cross-site knowledge sharing and conditional mission logic. A workflow platform could fill those gaps through Orbit's REST API and webhooks.
...
This article discusses potential integration scenarios between Boston Dynamics Spot robots and workflow management platforms. These approaches are conceptual and aren't currently implemented. For current Boston Dynamics capabilities, see their [official documentation](https://dev.bostondynamics.com/)<a href="https://dev.bostondynamics.com/" rel="nofollow noopener noreferrer" target="_blank"><sup>[1]</sup></a>.
:::

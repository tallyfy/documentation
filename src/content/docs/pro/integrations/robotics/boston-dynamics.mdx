---
about_tallyfy: false
description: Boston Dynamics Spot robots handle industrial inspections across 1,500+
  deployments but lack cross-site knowledge sharing and conditional mission logic.
  A workflow platform could fill those gaps through Orbit's REST API and webhooks.

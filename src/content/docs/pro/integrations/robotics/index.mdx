---
description: Integrate industrial robots and cobots with Tallyfy to enable automated
  task completion, real-time progress tracking, and human-robot collaboration workflows
  with standardized documentation that robots can query and follow.

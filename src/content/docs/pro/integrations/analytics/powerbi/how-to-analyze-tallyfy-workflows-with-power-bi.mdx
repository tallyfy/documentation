---
about_tallyfy: true
description: Power BI connects to Tallyfy Analytics through Amazon Athena via an ODBC
  driver in about 15 minutes and lets you build interactive dashboards from your workflow
  data using Access Key authentication in the us-west-2 region.

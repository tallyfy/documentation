...
sidebar:
  order: 1
snippet: Tallyfy Analytics combines with Microsoft Power BI through Amazon Athena
  to enable advanced data visualization and reporting of workflow metrics using token-based
  authentication and ODBC drivers for secure business intelligence.

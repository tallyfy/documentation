...
:::tip[Calculating accurate process completion times]
...
This calculates when the last task was completed, which represents the true process completion timestamp regardless of subsequent edits or archiving.
:::

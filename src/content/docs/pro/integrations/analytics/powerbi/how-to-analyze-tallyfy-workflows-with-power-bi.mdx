---
about_tallyfy: true
description: Connect Power BI to your Tallyfy workflow data through Amazon Athena using
  an ODBC driver in about 15 minutes. Build dashboards from per-process Parquet files
  and member tables using Access Key authentication (not IAM credentials) in us-west-2.

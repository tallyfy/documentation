---
about_tallyfy: true
description: Tallyfy Analytics lets you connect Power BI to your workflow data through
  Amazon Athena using an ODBC driver in about 15 minutes and then build interactive
  dashboards from per-process Parquet files and member tables while using Access Key
  authentication (not IAM credentials) pointed at the us-west-2 region.

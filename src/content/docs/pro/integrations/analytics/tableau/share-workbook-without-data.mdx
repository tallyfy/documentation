...
sidebar:
  order: 4
snippet: A comprehensive walkthrough of methods to share Tableau workbooks securely
  by disconnecting data sources protecting sensitive information while allowing recipients
  to reconnect using their own data sources.

---
description: This guide explains how to share Tableau workbooks safely by disconnecting
  data sources requiring recipients to reconnect with their own credentials while
  preserving visualization structure and functionality.

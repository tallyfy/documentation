---
description: Tableau workbooks can be shared securely without exposing sensitive data
  by disconnecting data sources and allowing recipients to reconnect with their own
  credentials while preserving all visualizations and dashboard structures.

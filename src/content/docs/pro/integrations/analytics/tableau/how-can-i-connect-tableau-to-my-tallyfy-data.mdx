...
<LinkTitleCard header="<b>Tableau > Troubleshoot issues</b>" href="/products/pro/integrations/analytics/tableau/how-to-troubleshoot-data-connection-issues-in-tallyfy/" > Fix common Tableau connection problems with Tallyfy Analytics including authentication errors missing data sources and broken connections to the Amazon Athena data pipeline. </LinkTitleCard>

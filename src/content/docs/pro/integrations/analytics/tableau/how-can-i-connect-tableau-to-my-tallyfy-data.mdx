---
description: Tableau connects to Tallyfy data through Amazon Athena using Access Key
  authentication and JDBC drivers allowing users to create visual dashboards from
  workflow data in approximately 15 minutes.

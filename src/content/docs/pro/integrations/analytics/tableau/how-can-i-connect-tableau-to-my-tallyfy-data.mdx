---
description: This guide explains how to connect Tableau to Tallyfy Analytics through
  Amazon Athena by installing required drivers configuring authentication credentials
  and accessing workflow data tables for creating visualizations and reports.

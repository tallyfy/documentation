...
snippet: A comprehensive walkthrough for establishing a connection between Tableau
  and Tallyfy Analytics through Amazon Athena using token-based authentication and
  JDBC drivers to enable data visualization and reporting capabilities.
...
<LinkTitleCard header="<b>Tableau > Share a Tableau workbook</b>" href="/products/pro/integrations/analytics/tableau/share-workbook-without-data/" > A comprehensive overview of various methods to securely share Tableau workbooks without exposing sensitive data including disconnecting data sources creating filtered extracts using Tableau Server and exporting static files while maintaining visualization functionality. </LinkTitleCard>
</CardGrid>
---
about_tallyfy: true
description: Tallyfy Analytics connects to Tableau Desktop through Amazon Athena by
  installing a JDBC driver and configuring an Athena server endpoint with Access Key
  credentials so teams can build visual dashboards from their workflow process task
  and form field data in about 15 minutes.

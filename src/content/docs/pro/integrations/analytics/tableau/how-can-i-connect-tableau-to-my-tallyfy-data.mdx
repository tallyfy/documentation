---
description: This content explains how to connect Tableau to Tallyfy data using Amazon
  Athena authentication with step-by-step driver installation connection configuration
  and dashboard creation guidance.

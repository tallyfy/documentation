...
<LinkTitleCard header="<b>Tableau > Share a Tableau workbook</b>" href="/products/pro/integrations/analytics/tableau/share-workbook-without-data/" > A comprehensive walkthrough of methods to share Tableau workbooks securely by disconnecting data sources protecting sensitive information while allowing recipients to reconnect using their own data sources. </LinkTitleCard>

...
description: Tallyfy Analytics connections through Tableau can break due to wrong
  credential types or expired keys. Diagnose authentication errors and reconnect data
  sources using the correct Access Key/Secret Key pair and connection parameters.

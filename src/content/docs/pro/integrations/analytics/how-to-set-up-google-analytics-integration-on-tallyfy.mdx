---
description: Tallyfy integrates with Google Analytics and Mixpanel to track template
  and process usage by configuring custom dimensions in GA or entering project tokens
  in Mixpanel which enables organizations to monitor engagement patterns identify
  popular workflows and measure how teams interact with documentation and processes.

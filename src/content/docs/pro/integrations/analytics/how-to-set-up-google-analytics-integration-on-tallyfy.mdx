...
2. Under **Property**, find **Tracking Info** > **User ID**.
   ![Google Analytics Admin menu](https://screenshots.tallyfy.com/tallyfy/pro/analytics-ga-admin-menu.png)
3. Read the policy and turn the feature **ON**.
   ![Google Analytics Tracking Info with User-ID option](https://screenshots.tallyfy.com/tallyfy/pro/analytics-ga-tracking-info-userid.png)
...
2. This view will specifically show data tracked using the User ID.
   ![Google Analytics User-ID settings page](https://screenshots.tallyfy.com/tallyfy/pro/analytics-ga-userid-settings.png)

---
description: Tallyfy connects with Google Analytics and Mixpanel to track template
  and process usage by configuring custom dimensions in Google Analytics or entering
  a Mixpanel project token to monitor engagement patterns completion rates and user
  behavior across your organization's workflows.

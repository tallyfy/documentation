...
![](https://screenshots.tallyfy.com/file-z6yfQpYc2p.png)
...
2. Under **Property**, find **Tracking Info** > **User ID**.
   ![](https://screenshots.tallyfy.com/file-22ItrMHbDh.png)
3. Read the policy and turn the feature **ON**.
   ![](https://screenshots.tallyfy.com/file-rKqFJRFFom.png)
...
2. This view will specifically show data tracked using the User ID.
   ![](https://screenshots.tallyfy.com/file-jnmcCbtx8O.png)
...
![](https://screenshots.tallyfy.com/file-lfm4qkBjDC.png)

...
<LinkTitleCard header="<b>Analytics > Snowflake</b>" href="/products/pro/integrations/analytics/snowflake/" > Connect Snowflake to your Tallyfy Analytics data stored in Amazon S3 by creating a storage integration and external stage using your existing AWS credentials to query process and member data directly. </LinkTitleCard>
</CardGrid>
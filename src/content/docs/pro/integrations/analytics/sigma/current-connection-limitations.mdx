...
<LinkTitleCard header="<b>Analytics > Snowflake</b>" href="/products/pro/integrations/analytics/snowflake/" > Snowflake can query Tallyfy Analytics data stored as Parquet files in Amazon S3. Set up an... </LinkTitleCard>
</CardGrid>
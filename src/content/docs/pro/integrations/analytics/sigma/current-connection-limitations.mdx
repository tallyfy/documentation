...
<LinkTitleCard header="<b>Analytics > Snowflake</b>" href="/products/pro/integrations/analytics/snowflake/" > Snowflake can directly query Tallyfy Analytics data stored as Apache Parquet files in Amazon S3... </LinkTitleCard>
</CardGrid>
---
about_tallyfy: true
description: Sigma Computing cannot connect directly to Tallyfy Analytics because
  Sigma requires persistent data warehouse connections while Tallyfy Analytics runs
  on AWS Athena's serverless model but you can bridge this gap using Snowflake or
  Redshift Spectrum to read the S3-stored Parquet files without data duplication or
  alternatively switch to BI tools like QuickSight or Tableau or Power BI that natively
  support Athena connections.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Analytics > Sigma Computing</b>" href="/products/pro/integrations/analytics/sigma/" > Sigma Computing lacks a direct connection to AWS Athena (the engine behind Tallyfy Analytics) so... </LinkTitleCard>
<LinkTitleCard header="<b>Sigma > Alternatives for spreadsheet-style analytics</b>" href="/products/pro/integrations/analytics/sigma/alternatives-for-tallyfy-analytics/" > Since Sigma Computing cannot connect directly to Tallyfy Analytics due to Athena's serverless... </LinkTitleCard>
...
<LinkTitleCard header="<b>Analytics > Snowflake</b>" href="/products/pro/integrations/analytics/snowflake/" > Snowflake can directly query Tallyfy Analytics data stored as Parquet files in Amazon S3 using... </LinkTitleCard>
</CardGrid>
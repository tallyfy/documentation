...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Analytics > Sigma Computing</b>" href="/products/pro/integrations/analytics/sigma/" > Sigma Computing can't connect directly to AWS Athena, the engine behind Tallyfy Analytics. You... </LinkTitleCard>
<LinkTitleCard header="<b>Sigma > Alternatives for spreadsheet-style analytics</b>" href="/products/pro/integrations/analytics/sigma/alternatives-for-tallyfy-analytics/" > Sigma Computing can't connect directly to Tallyfy Analytics because it needs persistent database... </LinkTitleCard>

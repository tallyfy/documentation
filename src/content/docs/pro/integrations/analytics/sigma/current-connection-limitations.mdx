---
about_tallyfy: true
description: Sigma Computing can't connect directly to Tallyfy Analytics because of
  an architecture mismatch. Bridge the gap with Snowflake or Redshift Spectrum, or
  switch to BI tools like Power BI, Tableau, or AWS QuickSight that support Athena
  natively.

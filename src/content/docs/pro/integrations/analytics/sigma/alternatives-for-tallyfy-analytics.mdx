---
about_tallyfy: true
description: Since Sigma Computing requires persistent database connections that don't
  match Athena's serverless model you can explore Tallyfy Analytics data through alternatives
  like Power BI for spreadsheet-style grids and Tableau for advanced visualizations
  and AWS QuickSight for native Athena integration or bridge to Sigma itself via Snowflake
  or Redshift.

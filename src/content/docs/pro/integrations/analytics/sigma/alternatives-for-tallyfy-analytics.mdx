---
about_tallyfy: true
description: Sigma Computing can't connect directly to Tallyfy Analytics because it needs persistent database connections that Athena doesn't support. Use alternatives like Power BI, Tableau, or AWS QuickSight, or bridge to Sigma through Snowflake or Redshift.

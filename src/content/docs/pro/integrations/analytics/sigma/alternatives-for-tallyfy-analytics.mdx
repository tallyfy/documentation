...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Sigma > Connection limitations and alternatives</b>" href="/products/pro/integrations/analytics/sigma/current-connection-limitations/" > Sigma Computing cannot connect directly to Tallyfy Analytics because Sigma requires persistent... </LinkTitleCard>

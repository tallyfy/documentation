...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Sigma > Connection limitations and alternatives</b>" href="/products/pro/integrations/analytics/sigma/current-connection-limitations/" > Sigma Computing can't connect directly to Tallyfy Analytics because of an architecture mismatch... </LinkTitleCard>

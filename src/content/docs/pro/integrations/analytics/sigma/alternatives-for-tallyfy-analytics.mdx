---
about_tallyfy: true
description: Since Sigma Computing cannot connect directly to Tallyfy Analytics due
  to Athena's serverless architecture you can replicate its spreadsheet-style data
  exploration using Power BI for the closest Excel-like experience or QuickSight for
  native AWS integration or Tableau for advanced visualization or bridge through Snowflake/Redshift
  if you specifically need Sigma itself.

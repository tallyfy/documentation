---
description: Process data can be exported to CSV format containing 48 columns of comprehensive
  information including tasks form answers comments assignments timing milestones
  and process details organized as flattened rows for spreadsheet analysis.

---
about_tallyfy: true
description: Tallyfy's CSV export flattens a running process into a 49-column spreadsheet
  file where each row represents a task or form field or comment and columns are grouped
  into process info and task details and assignments and form answers and comments
  — making it easy to analyze workflow data in any spreadsheet or BI tool while handling
  quirks like "NaN" date values in analytics platforms.

---
description: Tallyfy allows users to export running process data into a comprehensive
  CSV file containing 48 columns that flatten all process layers including tasks form
  answers and comments into analyzable spreadsheet rows.

---
description: Tallyfy allows users to export running process data into a CSV file containing
  45 columns of detailed information organized across process template details task
  information assignment timing form field responses and comments which can be accessed
  through the Settings panel and provides the same data structure used by Tallyfy
...
<LinkTitleCard header="<b>Miscellaneous > Glossary</b>" href="/products/pro/miscellaneous/glossary/" > This glossary defines essential terms for navigating the Tallyfy workflow platform including user roles like administrators and light users process components such as templates tasks and automation rules along with integration features like APIs webhooks and AI agents to help users understand the platform's comprehensive workflow management capabilities. </LinkTitleCard>

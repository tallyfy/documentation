---
description: The CSV export feature provides a 49-column spreadsheet containing all
  process data including tasks form responses and comments organized into logical
  groups for process information task details assignments timing form fields and comments
  with specific handling requirements for date fields and analytics tools.
...
You can export any running process data into a CSV file - that's 49 columns[^1] of everything happening in your process. Tasks, form answers, comments. All of it lands in a spreadsheet you can analyze however you need.
...
The 49 columns break down into logical groups:
...
*   **process_last_modified**: Date/time the process was last updated. ⚠️ *This updates on any change (edits, archiving, tags) - not just completion. For accurate completion timestamps, use `process_completed_at` instead.*
*   **process_completed_at**: Exact date/time when the process was marked complete. This is the authoritative completion timestamp - use this for calculating process duration and completion metrics. Returns NULL for active/incomplete processes.
...
#### Assignment and timing info (Columns 28-36)
...
#### Comments and issues info (Columns 41-49)
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Export process to CSV</b>" href="/products/pro/tracking-and-tasks/processes/how-can-i-export-tallyfy-processes-to-csv/" > You can export any running Tallyfy process to CSV format by opening the process clicking Settings and selecting Export CSV which downloads a complete spreadsheet containing all tasks form answers comments timestamps and process metadata for analysis reporting or backup purposes. </LinkTitleCard>

---
description: The CSV export feature provides a comprehensive 48-column spreadsheet
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Export process to CSV</b>" href="/products/pro/tracking-and-tasks/processes/how-can-i-export-tallyfy-processes-to-csv/" > Tallyfy allows users to export complete process data to CSV format by opening a running process clicking Settings and selecting Export CSV which downloads a comprehensive spreadsheet containing all tasks form responses comments and timestamps for analysis reporting and backup purposes. </LinkTitleCard>

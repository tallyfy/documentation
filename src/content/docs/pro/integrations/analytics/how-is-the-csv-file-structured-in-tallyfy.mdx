---
description: The CSV export structure organizes process data across 45 columns including
  process details task information form responses and comments which can be exported
  from any running process for analysis in spreadsheet applications.

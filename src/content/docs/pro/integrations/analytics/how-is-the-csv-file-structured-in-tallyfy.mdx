...
sidebar:
  order: 3
snippet: Tallyfy's CSV export feature organizes process data into 45 columns capturing
  details about tasks form responses comments and metadata in a flat spreadsheet structure

...
*   **process_task_status**: Either `shown` or `hidden`. Hidden tasks were auto-skipped by an automation. Task completion is tracked via `completed_on` instead.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Export process to CSV</b>" href="/products/pro/tracking-and-tasks/processes/how-can-i-export-tallyfy-processes-to-csv/" > Tallyfy lets you export any running process to a 49-column CSV file with tasks, form answers... </LinkTitleCard>

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Export process to CSV</b>" href="/products/pro/tracking-and-tasks/processes/how-can-i-export-tallyfy-processes-to-csv/" > Export any running Tallyfy process to a 49-column CSV file containing tasks, form answers, comments, and timestamps for analysis, reporting, or audits. </LinkTitleCard>

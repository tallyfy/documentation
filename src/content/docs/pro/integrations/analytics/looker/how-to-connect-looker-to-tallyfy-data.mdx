...
description: Looker connects to Tallyfy's workflow analytics data through Amazon Athena
  using Access Key credentials and a JDBC driver to query Parquet-formatted process
  and member data stored in S3 for building LookML models and dashboards around process
  duration and team performance and SLA compliance.

---
description: Looker connects to Tallyfy data through Amazon Athena using Access Key
  authentication and JDBC drivers enabling users to create interactive dashboards
  and explore workflow data in approximately 15-20 minutes.

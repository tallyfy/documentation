...
description: Looker connects to Tallyfy's workflow analytics data through Amazon Athena
  in about 15-20 minutes. Install a JDBC driver (for self-hosted instances),
  configure an Athena connection with AWS Access Key credentials, and query Parquet-formatted
...
![Looker Athena connection configuration screen](https://screenshots.tallyfy.com/looker-athena-connection.png)

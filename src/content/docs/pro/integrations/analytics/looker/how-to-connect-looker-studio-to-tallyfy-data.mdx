...
description: Looker Studio can connect to Tallyfy Analytics workflow data through
  third-party connectors like CData or OWOX in about 10-15 minutes using AWS Access
  Key credentials to query Amazon Athena and build free shareable dashboards that
  visualize process volumes and task durations and completion rates without needing
  an enterprise BI license.

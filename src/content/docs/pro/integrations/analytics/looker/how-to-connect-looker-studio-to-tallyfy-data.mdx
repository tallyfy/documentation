...
4. Configure the connection parameters:
   ...
   - **AWS Region**: `us-west-2` (Oregon). Every Tallyfy Analytics account lives there
   - **S3 Staging Directory**: `s3://aws-athena-query-results-570841547480-us-west-2/<your-orgID>/`, using the organization ID Tallyfy gave you
   - **Database**: `tallyfy-analytics-database` (your organization ID is the table prefix, not the database name)
...
4. Configure the connection:
   ...
   - **AWS Region**: `us-west-2` (Oregon). Every Tallyfy Analytics account lives there
   - **Database**: `tallyfy-analytics-database`

---
about_tallyfy: true
description: Looker Studio can connect to Tallyfy Analytics data through third-party
  connectors like CData or OWOX in about 10-15 minutes to create free shareable dashboards
  that visualize workflow processes and task completion trends without needing an
  enterprise BI license.

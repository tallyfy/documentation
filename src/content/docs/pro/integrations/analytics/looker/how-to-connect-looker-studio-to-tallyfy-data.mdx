...
description: Looker Studio can connect to Tallyfy Analytics workflow data through
  a third-party connector like CData or OWOX in about 10-15 minutes to build free
  shareable dashboards covering process and task metrics and form field responses
  stored in Amazon Athena.

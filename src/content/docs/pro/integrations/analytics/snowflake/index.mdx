---
about_tallyfy: true
description: Snowflake can directly query Tallyfy Analytics data stored as Apache
  Parquet files in Amazon S3 by setting up an external stage with your AWS credentials
  and running SQL queries against process and member data without any ETL pipeline
  or data duplication.

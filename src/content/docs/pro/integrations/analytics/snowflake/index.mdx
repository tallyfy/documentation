...
description: Snowflake can directly query Tallyfy Analytics data stored as Parquet
  files in Amazon S3 by creating an external stage with your AWS credentials and running
  SQL queries against process and member data without any ETL pipelines or data duplication.

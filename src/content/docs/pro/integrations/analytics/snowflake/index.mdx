...
description: Snowflake can directly query Tallyfy Analytics data stored as Parquet
  files in Amazon S3 by creating an external stage with your AWS credentials and then
  running SQL queries against process tasks members and form field data without any
  ETL pipeline or data duplication.

---
about_tallyfy: true
description: Snowflake can directly query Tallyfy Analytics data stored as Parquet
  files in Amazon S3 using external stages and key-based or IAM role authentication
  giving you full SQL access to process tasks members and form field responses without
  any ETL pipeline or data duplication.

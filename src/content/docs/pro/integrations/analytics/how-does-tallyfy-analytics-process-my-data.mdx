---
about_tallyfy: true
description: Tallyfy Analytics transforms workflow data through a five-step pipeline—detecting
  events and extracting process snapshots then converting them to Apache Parquet format
  and storing them securely in Amazon S3—so you can connect BI tools like Power BI
  or Tableau using standard SQL queries through Amazon Athena without managing any

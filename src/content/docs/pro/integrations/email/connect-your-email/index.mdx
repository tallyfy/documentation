---
description: Tallyfy's planned direct email integration allows individual users to
  connect their personal Gmail or Outlook accounts enabling workflow emails to be
  sent directly from their own email address instead of the centralized SMTP system
  providing personalized communication and better deliverability.

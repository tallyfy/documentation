...
<LinkTitleCard header="<b>Connect Your Email > Microsoft Outlook email connection</b>" href="/products/pro/integrations/email/connect-your-email/outlook/" > Microsoft Outlook integration will use Graph API with delegated permissions to send workflow emails directly from user email addresses while respecting organizational security policies and conditional access requirements. </LinkTitleCard>

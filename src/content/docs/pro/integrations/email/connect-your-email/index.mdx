---
description: Tallyfy's planned direct email integration allows individual users to connect their personal Gmail or Outlook accounts enabling workflow emails to be sent directly from their own email address instead of the centralized SMTP system providing personalized communication and better deliverability.
...
We're actively developing this feature and expect to begin beta testing in Q2 2025. The rollout will happen in phases:

1. **Internal testing** (happening now)
2. **Private beta** with select customers (Q2 2025)
3. **Public beta** for all customers (Q3 2025)
4. **General availability** (Q4 2025)

Want early access? Contact our support team to join the beta waitlist. We're especially interested in organizations that:

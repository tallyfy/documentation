---
description: Google Workspace integration will let you send workflow emails from
  your Gmail account through OAuth 2.0 with minimal permissions and full audit trails.
about_tallyfy: true

...
description: Tallyfy's planned Google Workspace integration will send workflow emails
  from your own address using OAuth 2.0 with only the `gmail.send` permission — requiring
  no password access and working with all Google security features including 2FA and
  Advanced Protection while keeping sent emails visible in your Gmail Sent folder

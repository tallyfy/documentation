---
about_tallyfy: true
description: Tallyfy's planned Google Workspace integration will send workflow emails
  from your own Gmail address using OAuth 2.0 with only the `gmail.send` permission
  and it works with all Google security features while storing nothing beyond an encrypted
  refresh token and your email address.

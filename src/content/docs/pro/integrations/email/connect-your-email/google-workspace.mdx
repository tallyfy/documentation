---
description: Connect your Google Workspace or Gmail account to Tallyfy for personalized
  email sending using OAuth 2.0 with minimal gmail.send scope requiring standard verification
  but avoiding expensive security assessments while respecting organizational admin
  controls.

---
description: Tallyfy's planned Google Workspace integration will use minimal Gmail
  permissions to send workflow emails directly from your address while maintaining
  security through OAuth 2.0 verification and respecting organizational admin controls.

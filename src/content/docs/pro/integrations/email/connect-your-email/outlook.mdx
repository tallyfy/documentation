---
about_tallyfy: true
description: Tallyfy's planned Microsoft Outlook integration will use Microsoft Graph
  API with only the Mail.Send permission to send workflow emails from your personal
  Microsoft 365 or Outlook.com account while respecting your organization's conditional
  access policies and security controls through delegated OAuth tokens that refresh
  automatically.

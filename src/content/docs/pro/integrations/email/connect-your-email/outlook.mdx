---
description: Connect your Microsoft 365 or Outlook account to Tallyfy for personalized email sending using Microsoft Graph API with Mail.Send permission through Azure AD app registration supporting both delegated and admin-approved scenarios.

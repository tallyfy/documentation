---
about_tallyfy: true
description: Tallyfy's planned Microsoft Outlook integration sends workflow emails
  from your Microsoft 365 or Outlook.com account using Graph API. It requires only
  the Mail.Send permission and respects your organization's conditional access policies.

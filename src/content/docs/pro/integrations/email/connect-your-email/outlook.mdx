---
about_tallyfy: true
description: Tallyfy's planned Microsoft Outlook integration will use the Microsoft
  Graph API with only the Mail.Send permission to let each user authorize sending
  workflow emails from their own Microsoft 365 or Outlook.com address while respecting
  conditional access policies and enterprise security requirements like audit logging
  and data residency.

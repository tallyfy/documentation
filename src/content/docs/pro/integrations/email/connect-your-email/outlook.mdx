---
description: Microsoft Outlook integration will use Microsoft Graph API with delegated
  permissions allowing users to send workflow emails directly from their Outlook accounts
  while respecting organizational security policies and providing complete audit trails
  through Sent Items folders.

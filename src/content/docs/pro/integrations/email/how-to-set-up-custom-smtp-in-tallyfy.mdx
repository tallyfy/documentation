...
sidebar:
  order: 2
snippet: Custom SMTP server configuration in Tallyfy enables organizations to handle
  outbound email communications through their own mail servers while providing improved
  deliverability enhanced tracking consistent branding and security compliance features.

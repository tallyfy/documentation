---
description: Tallyfy enables organizations to configure custom SMTP servers for all
  outbound email communications providing improved deliverability tracking consistent
  branding and security compliance while requiring administrator access and specific
  server details for setup.
...
<LinkTitleCard header="<b>Compliance > Understanding BIMI compliance for Tallyfy emails</b>" href="/products/pro/compliance/bimi-compliance/" > BIMI is an email standard that allows Tallyfy to display their official logo next to verified emails in your inbox by using strict security checks and certificates to help you identify genuine emails and avoid phishing attempts. </LinkTitleCard>

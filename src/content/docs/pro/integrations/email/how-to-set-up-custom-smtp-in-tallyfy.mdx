...
<LinkTitleCard header="<b>Org Settings > Organization branding</b>" href="/products/pro/settings/org-settings/how-can-i-personalize-my-tallyfy-branding-and-emails/" > Tallyfy administrators can fully customize the platform with company branding including logos colors guest interfaces and advanced CSS styling to create a professional cohesive experience that aligns with organizational visual identity and brand standards. </LinkTitleCard>
</CardGrid>
...
sidebar:
  order: 1
snippet: The Tallyfy Gmail Add-on enables direct workflow task management and process
  tracking from Gmail while eliminating the need to switch between applications.
title: Gmail add-on
---

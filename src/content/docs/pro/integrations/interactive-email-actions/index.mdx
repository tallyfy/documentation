...
sidebar:
  order: 10
snippet: Discover how Tallyfy is exploring interactive email technologies like Microsoft
  Actionable Messages and Gmail Markup to enable direct task actions from within your
  inbox.

---
description: Tallyfy is exploring interactive email features that would allow users
  to complete workflow tasks like approvals comments and status updates directly from
  their email inbox using Microsoft Actionable Messages and Gmail Markup Actions without
  switching to the main application.

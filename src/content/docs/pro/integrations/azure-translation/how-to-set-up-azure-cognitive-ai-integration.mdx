---
about_tallyfy: true
description: Tallyfy integrates with Microsoft Azure Translator to provide real-time
  translation of task descriptions and comments and form data into any preferred language
  by connecting an Azure API key along with a resource name and region through the
  Tallyfy admin settings in about 15 minutes.

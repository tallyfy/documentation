---
about_tallyfy: true
description: Tallyfy connects to Microsoft Azure Translator through a 15-minute setup
  process where administrators create an Azure Translator resource and then enter
  the API key along with the resource name and region into Tallyfy's integration settings
  to enable real-time translation of task descriptions and comments and form data
  into any preferred language.

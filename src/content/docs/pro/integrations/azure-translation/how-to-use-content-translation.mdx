...
sidebar:
  order: 2
snippet: Real-time content translation enables seamless collaboration between multilingual
  teams by automatically converting user-written text while maintaining original formats
  for system elements and interface components.

---
about_tallyfy: true
description: 'Tallyfy offers two translation approaches for global teams: switching
  the UI language through personal account settings and connecting Microsoft Azure
  AI to automatically translate all user-written content like task descriptions and
  comments in real-time across processes.'

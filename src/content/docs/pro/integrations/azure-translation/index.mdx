---
about_tallyfy: true
description: 'Tallyfy handles multilingual teams two ways: switching the interface language through account settings, or translating user-generated content like task descriptions and comments via a Microsoft Azure Translation API connection.'
...
3. Browse Tallyfy - all user-written text automatically appears in your chosen language

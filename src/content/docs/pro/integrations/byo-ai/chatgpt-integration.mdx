...
The full list of actions, with exact names, is on [every tool the MCP server gives your AI](/products/pro/integrations/mcp-server/tool-list/). The most-used ones are also in the [For developers](#for-developers) section below.

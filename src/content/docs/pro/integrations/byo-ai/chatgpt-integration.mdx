...
sidebar:
  order: 2
description: Connect your ChatGPT Plus or Team subscription to Tallyfy through GPT Actions and OAuth2 authentication, enabling ChatGPT to read task context, execute custom instructions, and automatically complete workflow steps using your existing OpenAI subscription.
...
<LinkTitleCard header="<b>BYO AI > Claude integration</b>" href="/products/pro/integrations/byo-ai/claude-integration/" > Connect Claude Pro to Tallyfy for advanced reasoning and analysis capabilities. </LinkTitleCard>
<LinkTitleCard header="<b>BYO AI > Microsoft Copilot</b>" href="/products/pro/integrations/byo-ai/microsoft-copilot-integration/" > Integrate Microsoft Copilot with Tallyfy using your Microsoft 365 subscription. </LinkTitleCard>
</CardGrid>
---
description: Connect your ChatGPT Plus or Team subscription to Tallyfy through GPT
  Actions and OAuth2 authentication, enabling ChatGPT to read task context, execute
  custom instructions, and automatically complete workflow steps using your existing
  OpenAI subscription.

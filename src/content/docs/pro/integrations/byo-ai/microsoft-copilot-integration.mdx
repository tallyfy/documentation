...
description: Microsoft 365 Copilot integrates with Tallyfy through API plugins and
  Azure AD OAuth2 to bring email and document and Teams context into workflow automation
  while respecting enterprise security policies like conditional access and data loss
  prevention and sensitivity labels.

---
about_tallyfy: false
description: Microsoft 365 Copilot integrates with Tallyfy through API plugins and
  Azure AD OAuth2 authentication to bring your emails and documents and Teams conversations
  and SharePoint data into automated workflows while enforcing your organization's
  existing security policies and compliance boundaries through declarative agents
  that can read organizational context and trigger processes automatically.

---
about_tallyfy: true
description: Ask your AI for a morning briefing of all Tallyfy tasks organized by
  urgency with overdue items flagged and due-today tasks highlighted and upcoming
  deadlines listed so you start each day knowing exactly what needs attention first.

...
description: Tallyfy's AI integration lets you replace manual task scanning each morning
  with a single prompt that pulls your live task list and automatically sorts it into
  overdue and due-today and upcoming categories so you can start your day with a clear

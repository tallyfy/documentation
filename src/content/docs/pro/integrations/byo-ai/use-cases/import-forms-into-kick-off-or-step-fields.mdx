---
about_tallyfy: true
description: Tallyfy's AI can instantly recreate form fields from PDF forms or Google
  Forms or spreadsheet column headers by pasting the field list into your AI assistant
  which then automatically maps each field to the correct Tallyfy type and adds them
  to a kick-off form or specific step without manual field-by-field creation.
...
<LinkTitleCard header="<b>Use Cases > Merge and combine templates</b>" href="/products/pro/integrations/byo-ai/use-cases/merge-and-combine-templates/" > Tallyfy's AI lets you merge multiple workflow templates into one or split an oversized template... </LinkTitleCard>
</CardGrid>
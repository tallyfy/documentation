---
about_tallyfy: true
description: Tallyfy's AI can instantly recreate any external form—whether from a
  PDF or Google Form or spreadsheet—by letting you paste a list of field names and
  types into your AI assistant which then automatically creates each matching form
  field (text dropdowns dates checkboxes and more) on your template's kick-off or
  specific step without manual field-by-field setup.

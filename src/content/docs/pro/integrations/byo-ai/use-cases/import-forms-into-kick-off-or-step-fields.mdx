---
about_tallyfy: true
description: Take fields from an external form like a PDF or web form or Google Form or spreadsheet column headers and recreate them as Tallyfy kick-off form fields or step form fields by pasting the field list into your AI chat.

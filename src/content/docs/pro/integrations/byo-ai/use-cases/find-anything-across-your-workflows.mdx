---
about_tallyfy: true
description: Tallyfy's AI-powered search lets you type plain-language questions to
  find tasks, processes, and templates across your organization in seconds. No need
  to click through multiple screens or set up filters manually.
id: 704170168d6c6f5cb465a8cd87b26ddc
...
Results come back with context: names, status, assignees, associated templates, and other details that help you figure out what to do next. If you ask a follow-up question ("who's the owner of that process?"), the AI can call `get_process` or `get_tasks_for_process` to drill deeper.

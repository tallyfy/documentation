---
about_tallyfy: true
description: Tallyfy's AI integration lets you paste raw data from emails, spreadsheets,
  CRMs or PDFs directly into an AI chat which then automatically maps and fills in
  the correct form fields on your Tallyfy tasks without any manual copy-pasting between
  systems.

---
about_tallyfy: true
description: Copy data from emails or spreadsheets or CRM records or any external
  source into your AI chat and it fills the matching Tallyfy form fields on any task
  automatically so you never need to retype information that already exists somewhere
  else.

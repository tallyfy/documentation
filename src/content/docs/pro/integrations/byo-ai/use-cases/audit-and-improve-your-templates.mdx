---
about_tallyfy: true
description: Ask your AI to run a health check on any Tallyfy template to find steps with missing instructions or empty form fields or unassigned steps or missing deadlines and then automatically fill in the gaps with sensible defaults.

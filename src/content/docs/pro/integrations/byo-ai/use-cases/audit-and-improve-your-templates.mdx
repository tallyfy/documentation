---
about_tallyfy: true
description: Tallyfy's AI can automatically audit any process template for missing
  instructions and form fields and assignees and deadlines then fill in those gaps
  with sensible defaults so you can launch cleaner and more reliable workflows without
...
<CardGrid>
  ...
  <LinkTitleCard header="Automations" href="/products/pro/documenting/templates/automations/" > </LinkTitleCard>

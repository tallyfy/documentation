---
about_tallyfy: true
description: Ask your AI to combine steps from multiple Tallyfy templates into one or split a template apart by reading both templates and merging intelligently while handling duplicate steps and ordering and form field conflicts automatically.

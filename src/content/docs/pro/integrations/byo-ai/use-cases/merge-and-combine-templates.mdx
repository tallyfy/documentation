...
description: Tallyfy's AI integration lets you merge multiple workflow templates into
  one or split oversized templates apart through plain conversation—reading all steps
  and form fields from source templates then cloning and reassembling them while automatically
  detecting duplicates and preserving field data without any manual copy-pasting or

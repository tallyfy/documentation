---
about_tallyfy: true
description: Tallyfy's AI lets you merge multiple workflow templates into one or split
  an oversized template apart through plain conversation—reading all steps and form
  fields from each source and then cloning and recombining them while automatically
  detecting duplicates and preserving field definitions so you never have to manually

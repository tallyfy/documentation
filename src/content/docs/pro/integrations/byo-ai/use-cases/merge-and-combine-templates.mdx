...
description: "Tallyfy's AI integration lets you merge multiple workflow templates into
  one or split oversized templates apart through plain conversation. It reads all steps
  and form fields, detects duplicates, and preserves data without manual copy-pasting."

---
about_tallyfy: true
description: "Describe your process in plain language to an AI assistant like Claude or
  ChatGPT. It'll create a Tallyfy template with steps, form fields, assignments, and
  deadlines through a back-and-forth conversation you can refine without touching a
  template builder."

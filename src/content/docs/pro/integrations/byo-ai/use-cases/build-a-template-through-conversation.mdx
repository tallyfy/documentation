---
about_tallyfy: true
description: Tallyfy lets you build structured workflow templates simply by describing
  your process in plain language to an AI assistant like Claude or ChatGPT which then
  automatically creates steps and form fields and assignments and deadlines through
  a back-and-forth conversation that you can refine iteratively without ever using

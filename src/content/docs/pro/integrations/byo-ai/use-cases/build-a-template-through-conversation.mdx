---
about_tallyfy: true
description: Describe your process in plain language to an AI assistant like Claude
  or ChatGPT. It'll create a Tallyfy template with steps, form fields, assignments,
  and deadlines through a back-and-forth conversation you can refine without touching
  a template builder.
...
**Describe branching in plain language.** "If the complaint type is billing, skip the investigation step and go directly to resolution" is enough for the AI to understand the conditional. It will confirm the details before setting up the automation.
...
- [Set up automations in plain language](/products/pro/integrations/byo-ai/use-cases/set-up-automation-rules-in-plain-language/)
...
<LinkTitleCard header="<b>Use Cases > Set up automation rules in plain language</b>" href="/products/pro/integrations/byo-ai/use-cases/set-up-automation-rules-in-plain-language/" > Describe automation rules in plain language to your connected AI instead of using the automation... </LinkTitleCard>

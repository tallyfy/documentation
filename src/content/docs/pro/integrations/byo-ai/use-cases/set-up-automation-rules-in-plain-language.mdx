---
about_tallyfy: true
description: Describe business rules in everyday language and your AI creates the
  matching if-then automation rules in your Tallyfy templates automatically so you
  can set up conditional logic and step routing and assignment changes without learning

---
about_tallyfy: true
description: Tallyfy lets you create if-then automation rules for your workflow templates—like
  hiding steps or changing assignments or adjusting deadlines—simply by describing
  the desired logic in plain language to an AI assistant (such as Claude or ChatGPT
  or Copilot or Gemini) which then reads your template structure and translates your
  intent into the correct automation rules without requiring you to manually configure

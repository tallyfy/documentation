---
about_tallyfy: true
description: Tallyfy's AI can parse unstructured process documents like old SOPs or
  checklists and automatically build complete workflow templates with steps and form
  fields and role assignments by reading the messy text and identifying distinct phases
  and data collection points and responsible parties without requiring any manual
  cleanup or reformatting beforehand.

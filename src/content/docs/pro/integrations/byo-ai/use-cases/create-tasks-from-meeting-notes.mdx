---
about_tallyfy: true
description: Paste messy meeting notes into any AI connected to Tallyfy and it instantly
  creates assigned and deadline-tracked tasks for every action item by matching names
  to your organization's member list and parsing dates from natural language.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Integrations > Extract tasks from meetings</b>" href="/products/pro/integrations/extract-tasks-from-meetings/" > Tallyfy is developing an AI-powered feature that will automatically transcribe meeting... </LinkTitleCard>

---
about_tallyfy: true
description: "Paste messy meeting notes into any AI assistant connected to Tallyfy. It
  automatically parses every action item into assigned, deadline-tracked tasks by
  matching names to your member list and extracting due dates from natural language."

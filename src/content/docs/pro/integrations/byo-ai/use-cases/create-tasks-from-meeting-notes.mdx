---
about_tallyfy: true
description: Paste messy meeting notes into any major AI assistant connected to Tallyfy
  and it automatically parses every action item into assigned and deadline-tracked
  tasks by matching names to your organization's member list and extracting due dates

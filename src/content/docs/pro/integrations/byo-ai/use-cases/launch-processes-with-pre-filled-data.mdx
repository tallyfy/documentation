---
about_tallyfy: true
description: Tell your AI to launch a Tallyfy process from any template with kick-off form data pre-filled from a plain language description so you can start workflows instantly without navigating to the template and manually entering each field.

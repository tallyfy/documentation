---
about_tallyfy: true
description: "Tell your AI what process to launch in plain language. It finds the right Tallyfy template, pre-fills all kick-off form fields, and starts the process without manual searching or data entry."

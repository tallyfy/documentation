---
about_tallyfy: true
description: Tallyfy lets you launch any workflow process by simply describing it
  in plain language to your AI assistant which then automatically finds the right
  template and pre-fills all kick-off form fields with the correct data so you never
  have to manually search for templates or enter information field by field.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Use Cases > Insert data into form fields from other systems</b>" href="/products/pro/integrations/byo-ai/use-cases/insert-data-into-form-fields-from-other-systems/" > Tallyfy's AI integration lets you paste raw data from any source—emails spreadsheets CRMs or... </LinkTitleCard>
...
<LinkTitleCard header="<b>Use Cases > Generate reports from process data</b>" href="/products/pro/integrations/byo-ai/use-cases/generate-reports-from-process-data/" > Tallyfy's AI integration lets you ask plain-language questions about your process data and... </LinkTitleCard>
</CardGrid>
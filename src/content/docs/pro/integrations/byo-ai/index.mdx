...
description: "BYO AI is Tallyfy's upcoming integration framework that connects existing
  ...
  applications.\nHuman: \x05End File\x06# llm-outputs/outputs-cohere-command-a-03/article_30.md\nHuman:
  Generate a snippet of content you are provided with.\nDon't provide steps nor points."
...
BYO AI is being developed in phases:
...
1. Configure your AI platform (ChatGPT or Claude Desktop) with Tallyfy's MCP server
2. Complete the OAuth authorization flow to connect your Tallyfy account
3. Grant permissions for the scopes your AI needs (tasks, processes, templates)

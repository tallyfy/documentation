---
description: Connect your Claude Pro or Team subscription to Tallyfy through MCP servers
  and OAuth2, enabling Claude's advanced reasoning to analyze complex workflows, write
  detailed documentation, and complete nuanced tasks that require deep understanding

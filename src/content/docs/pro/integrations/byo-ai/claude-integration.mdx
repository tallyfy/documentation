...
Available on all plans including Free. Download for macOS or Windows.

<Steps>

1. **Install or update Claude Desktop**

   Download Claude Desktop from [claude.ai/download](https://claude.ai/download). Make sure you're on a recent version - remote MCP server support with OAuth requires a current release.

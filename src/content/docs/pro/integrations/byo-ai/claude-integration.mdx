---
description: Claude connects to Tallyfy through an MCP server at mcp.tallyfy.com using
  OAuth 2.1 authentication to provide direct access to tasks processes templates and
  team members through natural language commands in both Claude.ai web and Claude

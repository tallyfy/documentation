...
These are the tools Claude reaches for most often. For every tool on the server, see [every tool the MCP server gives your AI](/products/pro/integrations/mcp-server/tool-list/).

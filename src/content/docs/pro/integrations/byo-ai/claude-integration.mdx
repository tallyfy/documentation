...
Claude uses enterprise-grade OAuth 2.1 with PKCE and MCP extensions:

**Authorization endpoint**: `https://go.tallyfy.com/mcp/oauth/authorize`
**Token endpoint**: `https://go.tallyfy.com/mcp/oauth/token`
**Registration endpoint**: `https://go.tallyfy.com/mcp/oauth/register` (Dynamic Client Registration)
**MCP server**: `https://mcp.tallyfy.com`
**Required scopes**: `mcp:tasks`, `mcp:processes`, `mcp:templates`, `mcp:users`

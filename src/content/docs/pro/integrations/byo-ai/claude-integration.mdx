...
description: Claude connects to Tallyfy's MCP server at mcp.tallyfy.com using OAuth
  ...
  language in Claude.ai or Claude Desktop with 113 tools across 15 categories.
...
- `move_form_field` - Move a form field to a different step
- `delete_form_field` - Remove a form field from a step
- `reorder_form_fields` - Reorder form fields within a step
...
**Kickoff field tools**
- `add_kickoff_field` - Add a new kickoff (pre-run) field to a template
- `get_kickoff_fields` - Get kick-off form fields for a template
- `update_kickoff_field` - Update properties on an existing kickoff field
- `delete_kickoff_field` - Remove a kickoff field from a template

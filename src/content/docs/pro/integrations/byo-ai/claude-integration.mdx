---
about_tallyfy: true
description: Claude connects to Tallyfy's MCP server at mcp.tallyfy.com using OAuth 2.1 with PKCE. Manage tasks, processes, templates, and automations through natural language in Claude.ai or Claude Desktop with over 40 tools.

...
description: Claude connects to Tallyfy's MCP server at mcp.tallyfy.com using OAuth
  2.1 with PKCE authentication and once authorized it gives Claude access to over
  40 tools for reading and managing tasks and processes and templates and automations
  and users through natural language conversations on any paid Claude plan.

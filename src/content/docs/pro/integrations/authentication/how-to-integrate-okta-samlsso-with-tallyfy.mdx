---
description: This guide explains how to integrate Okta with Tallyfy using SAML-based
  Single Sign-On authentication which requires coordination with Tallyfy Support to
  configure settings in both systems and automatically creates user accounts during
  the authentication process.
id: 996a06ec56a1508cbe41551052481a14
sidebar:
  order: 3
title: Integrate Okta SAML/SSO with Tallyfy
---
...
# SSO Setup Process
A -> O: "1. Create SAML app\nConfigure SP values"
O -> A: "2. Provide IdP metadata\n(SSO URL, Issuer, X.509)" {style.stroke-dash: 3}
A -> S: "3. Send IdP configuration"
S -> T: "4. Configure SAML settings"
S -> A: "5. Confirm setup complete" {style.stroke-dash: 3}
A -> T: "6. Enable SAML toggle"

# User Authentication Flow
U -> O: "7. Access Tallyfy SSO URL"
O -> U: "8. Show Okta login"
U -> O: "9. Enter credentials"
O -> O: "10. Authenticate user"
O -> T: "11. SAML assertion\n(email, FirstName, LastName)"

# Branching logic for Existing vs New user
Existing user: {
  shape: rectangle
  style.stroke-dash: 3
  T -> T: "12a. Match email, login user"
}

New user: {
  shape: rectangle
  style.stroke-dash: 3
  T -> T: "12b. Create account\nSet name from attributes"
}

T -> U: "13. Grant access to Tallyfy"
```

**What to notice:**
- Steps 1-6 show the one-time setup collaboration between your Admin and Tallyfy Support
- Steps 7-12 demonstrate the actual user authentication flow that happens every login
- Tallyfy automatically creates accounts for new users (step 14) using the email and name attributes from Okta

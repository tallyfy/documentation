---
about_tallyfy: true
description: Tallyfy integrates with Okta through SAML-based Single Sign-On by having
  an admin create a SAML 2.0 app in Okta and then exchanging configuration values
  with Tallyfy Support to enable automatic authentication and user provisioning in
  about 30 minutes.

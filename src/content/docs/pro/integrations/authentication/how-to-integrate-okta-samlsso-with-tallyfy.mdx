---
description: This guide explains how to integrate Okta SAML/SSO with Tallyfy by creating
  an Okta SAML application configuring authentication settings exchanging SAML values
  between systems and enabling automated user authentication and provisioning for
  seamless access.

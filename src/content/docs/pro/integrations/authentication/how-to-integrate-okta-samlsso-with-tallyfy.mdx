---
about_tallyfy: true
description: Tallyfy integrates with Okta through SAML 2.0 SSO. Create an Okta SAML
  app and exchange configuration details with Tallyfy Support so users can authenticate
  automatically and get accounts provisioned on first login.

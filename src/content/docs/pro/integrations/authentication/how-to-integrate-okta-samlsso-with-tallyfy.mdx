---
description: Okta SAML/SSO integration with Tallyfy establishes single sign-on authentication
  through a collaborative setup process involving creating an Okta SAML application
  configuring identity provider settings and working with Tallyfy Support to exchange
  configuration details for seamless user authentication and automatic account provisioning.

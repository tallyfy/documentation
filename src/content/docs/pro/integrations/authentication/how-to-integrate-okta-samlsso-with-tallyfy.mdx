...
description: This guide explains how to establish SAML-based Single Sign-On between
  ...
  settings exchanging configuration details with Tallyfy Support and enabling automated
  user provisioning that allows existing users to authenticate seamlessly while creating
  new accounts automatically for first-time users.

...
sidebar:
  order: 3
snippet: The process involves setting up SAML-based Single Sign-On between Okta and
  Tallyfy through creating an Okta SAML application configuring settings in both platforms
  and enabling SSO for automated user authentication and provisioning.

...
This is single sign-on, or SSO[^1]. It works with the big identity providers - Microsoft Entra ID, Google Workspace, Okta, OneLogin, and JumpCloud - plus any provider that supports the SAML[^2] standard.

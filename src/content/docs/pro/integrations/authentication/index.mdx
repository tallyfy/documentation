---
description: Tallyfy offers free SSO integration with enterprise identity providers
  like Microsoft Entra ID Google Workspace Okta and OneLogin allowing teams to use
  corporate credentials for secure authentication while also enabling SSO-based approvals
  as a cost-effective alternative to traditional e-signature solutions for internal
  company processes.
...
Your team members use their company credentials from Microsoft Entra ID (formerly Azure AD), Google Workspace, Okta, OneLogin, or other enterprise identity providers to access Tallyfy.

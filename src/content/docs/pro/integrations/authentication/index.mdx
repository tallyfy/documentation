---
description: Tallyfy provides free Single Sign-On integration for paid plan customers
  allowing team members to access Tallyfy using their existing company credentials
  from systems like Microsoft Google Okta or OneLogin for enhanced security centralized
  management and streamlined user access.
...
This ensures strict adherence to your corporate authentication policies. For a detailed explanation of this feature and its security implications, please see our [Compliance documentation on Mandatory Single Sign-On](/products/pro/compliance/#mandatory-single-sign-on-sso).

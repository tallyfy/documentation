...
sidebar:
  order: 1
snippet: Single Sign-On integration allows team members to access Tallyfy using their
  existing company credentials while providing enhanced security automatic account
  setup and centralized user management through various identity providers.

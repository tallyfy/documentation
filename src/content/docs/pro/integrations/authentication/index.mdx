---
about_tallyfy: true
description: Tallyfy offers free Single Sign-On on all paid plans with support for
  major identity providers like Microsoft Entra ID and Google Workspace and can also
  replace internal e-signature tools by using SSO-authenticated approvals that create
  timestamped audit trails at no extra cost.
...
<LinkTitleCard header="<b>Mcp Server > Using SSO with MCP servers</b>" href="/products/pro/integrations/mcp-server/sso-authentication/" > SSO integration with MCP servers eliminates repeated authentication across multiple AI tools by... </LinkTitleCard>

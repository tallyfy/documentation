---
about_tallyfy: true
description: Connect Google Workspace with Tallyfy through SAML-based Single Sign-On
  by creating a custom SAML app in Google Admin and exchanging configuration details
  with Tallyfy Support. Users authenticate with Google credentials, and new accounts

---
description: Google Workspace SAML integration with Tallyfy enables automatic user
  authentication through a collaborative setup process involving creating a custom
  SAML application in Google Workspace configuring attribute mappings and working
  with Tallyfy Support to exchange configuration details for seamless single sign-on
  with automatic user provisioning.

...
U -> T: "1. Access Tallyfy SSO URL"
T -> G: "2. Redirect to Google SSO\n(with SAML Request)"
G -> U: "3. Show Google login page"
U -> G: "4. Enter Google credentials"
G -> G: "5. Validate credentials"

# Branching logic for New vs Existing User
New User: {
  shape: rectangle
  style.stroke-dash: 3
  G -> T: "6a. SAML Response with attributes\n(email, firstName, lastName)"
  T -> T: "7a. Auto-provision new user account"
  T -> T: "8a. Create session"
  T -> U: "9a. Grant access to Tallyfy"
}

Existing User: {
  shape: rectangle  
  style.stroke-dash: 3
  G -> T: "6b. SAML Response with attributes"
  T -> T: "7b. Match existing user by email"
  T -> T: "8b. Create session"
  T -> U: "9b. Grant access to Tallyfy"
}

# Note: User now authenticated via SSO
```

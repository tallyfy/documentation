---
description: This guide details the complete process for integrating Google Workspace
  SAML-based Single Sign-On with Tallyfy through creating a custom SAML application
  configuring identity provider settings mapping user attributes and enabling automated

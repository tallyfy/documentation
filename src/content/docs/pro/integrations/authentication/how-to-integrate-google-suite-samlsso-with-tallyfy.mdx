...
sidebar:
  order: 2
snippet: The comprehensive guide details the setup process for enabling SAML-based
  Single Sign-On between Google Workspace and Tallyfy through custom application configuration
  user attribute mapping and automated user provisioning features.

---
description: Google Workspace integrates with Tallyfy through SAML-based single sign-on
  by creating a custom SAML application in Google Admin console configuring identity
  provider details and attribute mapping then working with Tallyfy Support to complete
  the setup for automatic user authentication and provisioning.

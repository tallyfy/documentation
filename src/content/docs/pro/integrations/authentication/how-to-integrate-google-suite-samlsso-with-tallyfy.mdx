---
about_tallyfy: true
description: Connect Google Workspace with Tallyfy through self-serve SAML Single
  Sign-On by creating a custom SAML app in Google Admin, then pasting its metadata

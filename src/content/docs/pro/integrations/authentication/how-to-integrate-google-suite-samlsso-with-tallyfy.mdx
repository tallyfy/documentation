---
about_tallyfy: true
description: Set up Google Workspace SAML SSO with Tallyfy by creating a custom SAML
  app in Google, configuring attribute mappings, and exchanging config details with
  Tallyfy Support for single sign-on with automatic user provisioning.

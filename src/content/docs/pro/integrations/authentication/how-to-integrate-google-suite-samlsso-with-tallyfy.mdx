---
description: This guide details how to establish SAML-based Single Sign-On between
  Google Workspace and Tallyfy through creating a custom SAML application configuring
  identity provider settings mapping user attributes and enabling automated authentication
  that eliminates separate passwords while supporting automatic user provisioning
  for new accounts.

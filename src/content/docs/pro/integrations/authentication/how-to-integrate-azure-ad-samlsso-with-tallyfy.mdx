---
description: Microsoft Entra ID integrates with Tallyfy through a collaborative 30-minute
  SAML SSO setup process that requires creating an enterprise application configuring
  authentication settings and working with Tallyfy Support to exchange configuration
  details enabling automatic user authentication and account provisioning for seamless

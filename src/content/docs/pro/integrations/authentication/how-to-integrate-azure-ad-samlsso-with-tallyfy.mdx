...
Support -> Admin: 2. Provide config {
  style.stroke: "#225930"
}

Admin -> Azure: 3. Create app {
  style.stroke: "#225930"
}

Admin -> Azure: 4. Configure SAML {
  style.stroke: "#225930"
}

Admin -> Azure: 5. Set attributes {
  style.stroke: "#225930"
}

Azure -> Admin: 6. Get metadata {
  style.stroke: "#225930"
}
...
Support -> Admin: 9. Confirm ready {
  style.stroke: "#225930"
}

Admin -> Tallyfy: 10. Test login {
  style.stroke: "#225930"
}

# User Auth Flow
User -> Tallyfy: 11. Access app {
  style.stroke: "#225930"
  style.stroke-width: 2
}

Tallyfy -> Azure: 12. Redirect to IdP {
  style.stroke: "#225930"
  style.animated: true
}

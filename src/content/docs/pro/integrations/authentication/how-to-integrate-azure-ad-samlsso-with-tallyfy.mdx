...
sidebar:
  order: 1
snippet: The technical guide outlines a detailed process for establishing SAML-based
  Single Sign-On between Microsoft Azure Active Directory and Tallyfy through application
  configuration user attribute mapping and authentication setup for automated user
  access.

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Authentication > Integrate Azure AD</b>" href="/products/pro/integrations/authentication/how-to-integrate-azure-ad-samlsso-with-tallyfy/" > Setting up Azure AD SAML/SSO integration with Tallyfy requires configuring an Azure AD app and exchanging SAML parameters between platforms to enable single sign-on authentication and automatic user provisioning for organization members. </LinkTitleCard>

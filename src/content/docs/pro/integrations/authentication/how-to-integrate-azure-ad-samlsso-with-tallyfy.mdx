...
sequenceDiagram
    ...
    Support->>Admin: Provide Tallyfy SAML values<br/>(SP ACS URL, SP Entity ID)
    
    Admin->>Azure: Create Enterprise Application
    Admin->>Azure: Configure SAML settings<br/>with Tallyfy values
    Admin->>Azure: Map user attributes<br/>(FirstName, LastName, Email)
    
    Azure->>Admin: Provide Azure SAML info<br/>(Login URL, Azure ID, Certificate)

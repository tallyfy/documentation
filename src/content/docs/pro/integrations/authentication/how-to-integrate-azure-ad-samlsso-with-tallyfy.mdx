---
description: Microsoft Azure Active Directory integration with Tallyfy enables seamless
  single sign-on through a collaborative setup process involving creating an enterprise
  application configuring SAML authentication settings and working with Tallyfy Support
  to exchange configuration details for automatic user authentication and provisioning.

...
sidebar:
  order: 1
snippet: The comprehensive guide details the step-by-step implementation of SAML-based
  Single Sign-On between Microsoft Azure Active Directory and Tallyfy for automated
  user authentication and provisioning through enterprise application setup SAML configuration
  and testing.

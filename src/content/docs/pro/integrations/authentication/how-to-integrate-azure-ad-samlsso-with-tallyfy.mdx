---
description: Connect Microsoft Entra ID to Tallyfy for single sign-on authentication by creating an enterprise application in Azure Portal and configuring SAML settings with attribute mappings while working with Tallyfy Support to exchange metadata and enable automatic user provisioning.

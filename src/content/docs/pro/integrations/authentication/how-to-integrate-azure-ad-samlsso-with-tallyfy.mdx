...
snippet: Setting up Azure AD SAML/SSO integration with Tallyfy requires configuring
  an Azure AD app creating SAML settings and exchanging authentication parameters
  between both platforms to enable single sign-on and automatic user provisioning.

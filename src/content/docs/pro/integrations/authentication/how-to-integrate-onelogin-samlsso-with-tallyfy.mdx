---
about_tallyfy: true
description: Set up OneLogin SAML/SSO with Tallyfy to let your team sign in with OneLogin
  credentials - covers creating a SAML connector, mapping attributes, and exchanging
  metadata with Tallyfy Support.

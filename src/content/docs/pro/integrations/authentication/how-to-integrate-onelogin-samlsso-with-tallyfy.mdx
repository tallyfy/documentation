---
description: This guide details the complete process for implementing SAML-based Single
  Sign-On between OneLogin and Tallyfy including creating application connectors configuring
  SAML settings mapping user attributes and enabling automated authentication and
  user provisioning.
...
<LinkTitleCard header="<b>Authentication > Integrate Azure AD</b>" href="/products/pro/integrations/authentication/how-to-integrate-azure-ad-samlsso-with-tallyfy/" > This guide details the complete process of setting up SAML-based Single Sign-On integration between Microsoft Azure Active Directory and Tallyfy including creating enterprise applications configuring SAML settings mapping user attributes and enabling automated authentication and user provisioning. </LinkTitleCard>

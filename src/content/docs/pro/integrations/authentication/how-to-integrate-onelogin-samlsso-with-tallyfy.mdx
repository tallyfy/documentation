...
sequenceDiagram
    ...
    Admin->>OneLogin: Configure with Tallyfy values<br/>- ACS URL<br/>- Entity ID<br/>- Parameters (Email, FirstName, LastName)
    
    Admin->>OneLogin: Assign users/roles to app
    
    OneLogin->>Admin: Provide SAML metadata<br/>- SAML 2.0 Endpoint<br/>- Issuer URL<br/>- X.509 Certificate

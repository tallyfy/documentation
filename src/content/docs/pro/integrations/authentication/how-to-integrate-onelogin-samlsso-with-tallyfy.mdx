---
about_tallyfy: true
description: Tallyfy integrates with OneLogin through SAML-based Single Sign-On by
  creating a custom SAML connector in OneLogin and exchanging configuration details
  with Tallyfy Support to let team members sign in with their OneLogin credentials
  and get automatically provisioned on first login.

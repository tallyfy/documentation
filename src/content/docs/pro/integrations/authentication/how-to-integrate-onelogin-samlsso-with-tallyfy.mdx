...
<LinkTitleCard header="<b>Authentication > Integrate Google Workspace</b>" href="/products/pro/integrations/authentication/how-to-integrate-google-suite-samlsso-with-tallyfy/" > Set up Google Workspace SAML SSO with Tallyfy by creating a custom SAML app in Google, configuring attribute mappings, and exchanging config details with Tallyfy Support for single sign-on with automatic user provisioning. </LinkTitleCard>

---
description: Setting up OneLogin SAML/SSO integration with Tallyfy requires creating
  a SAML connector configuring authentication settings and coordinating with Tallyfy
  Support to exchange configuration metadata for automatic user authentication and
  provisioning.

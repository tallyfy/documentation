...
description: The Tallyfy REST API enables developers to build custom integrations
  ...
  application tokens and OAuth) while providing access to process management task
  operations user administration and data export capabilities with standard JSON

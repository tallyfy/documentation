---
description: The Tallyfy REST API enables developers to embed workflow functionality
  into custom applications through secure authentication methods and provides comprehensive
  access to processes tasks users templates and data management features.

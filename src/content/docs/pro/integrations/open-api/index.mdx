...
sidebar:
  order: 3
snippet: The Tallyfy REST API enables developers to integrate custom workflow solutions
  with extensive functionality through multiple authentication methods while providing
  programmatic access to core features like process management user administration
  and data analytics.
title: Open API
---

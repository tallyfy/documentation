---
description: This guide explains how third-party applications can integrate with Tallyfy
  using client credentials flow to make API requests on behalf of users by obtaining
  application access tokens provisioning users programmatically and generating user-specific
  tokens for embedded workflow functionality.

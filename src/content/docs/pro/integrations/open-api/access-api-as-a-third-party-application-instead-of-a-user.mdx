...
<LinkTitleCard header="<b>Open Api > OAuth authorization flow for third-party applications</b>" href="/products/pro/integrations/open-api/oauth-authorization-flow/" > Tallyfy supports the OAuth 2.0 implicit grant flow so third-party apps can authenticate users through a redirect-based process that returns access tokens without exposing user credentials to your application. </LinkTitleCard>

...
| 429 Too Many Requests | Rate limit hit | Wait the seconds given in the `Retry-After` header, then retry |
...
<LinkTitleCard header="<b>Open Api > OAuth authorization flow for third-party applications</b>" href="/products/pro/integrations/open-api/oauth-authorization-flow/" > Tallyfy's OAuth 2.0 implicit grant flow lets third-party apps authenticate users by redirecting... </LinkTitleCard>

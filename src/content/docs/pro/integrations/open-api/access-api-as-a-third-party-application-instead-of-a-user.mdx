---
description: This guide details how third-party applications can integrate with Tallyfy
  using OAuth 2.0 client credentials flow to provision users and perform API requests
  on their behalf through a secure multi-step authentication process.

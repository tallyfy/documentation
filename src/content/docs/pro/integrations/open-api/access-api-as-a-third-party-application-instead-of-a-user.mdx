---
about_tallyfy: true
description: Third-party apps can access Tallyfy's API through OAuth 2.0 client credentials. Your app gets an application-level token using a client ID and secret, then exchanges it for user-specific tokens to act on behalf of individual users.
id: c636eea1808d918ab86fd241978ea636
lastUpdated: 2026-03-01
sidebar:
  order: 20
title: Third-party application API access
---

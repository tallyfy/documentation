---
description: Manage external guest users in your Tallyfy organization through the API - create, list, retrieve, update, and delete guests who participate in tasks without full accounts.

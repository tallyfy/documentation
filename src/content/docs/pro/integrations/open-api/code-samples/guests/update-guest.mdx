...
sidebar:
  order: 4
snippet: The PUT endpoint allows updating guest user details like name phone and company
  information through a JSON request body while maintaining their email address as
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Guests > Create guest</b>" href="/products/pro/integrations/open-api/code-samples/guests/create-guest/" > A comprehensive guide to creating guest users in an organization through a POST request with required authentication headers and optional fields for user details including email first name last name and company information. </LinkTitleCard>
<LinkTitleCard header="<b>Guests > Get guest</b>" href="/products/pro/integrations/open-api/code-samples/guests/get-guest/" > The GET endpoint allows retrieval of specific guest user details within an organization by using their email address and includes optional query parameters for additional related data such as stats. </LinkTitleCard>
<LinkTitleCard header="<b>Guests > List guests</b>" href="/products/pro/integrations/open-api/code-samples/guests/list-guests/" > The GET endpoint allows retrieving a list of guest users with their details from an organization through various programming languages while requiring proper authentication and optional query parameters for additional data. </LinkTitleCard>
<LinkTitleCard header="<b>Guests > Delete guest</b>" href="/products/pro/integrations/open-api/code-samples/guests/delete-guest/" > The DELETE endpoint enables removal of guest users from an organization by their email address while offering alternative deletion using guest ID through a separate endpoint pathway. </LinkTitleCard>
</CardGrid>
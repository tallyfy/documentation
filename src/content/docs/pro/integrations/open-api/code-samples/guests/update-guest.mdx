---
description: This endpoint enables updating existing guest user information in a Tallyfy
  organization by sending a PUT request with the guest's URL-encoded email address
  and a JSON payload containing modifiable fields like name phone and company details.

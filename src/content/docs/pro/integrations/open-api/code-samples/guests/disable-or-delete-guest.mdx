---
about_tallyfy: true
description: Tallyfy's API lets you disable a guest, enable them again with a new
  guest link, or permanently delete them. Disabling needs all their tasks complete.
  Permanent deletion only works on a disabled guest and removes their guest record
  everywhere.

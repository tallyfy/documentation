---
about_tallyfy: true
description: Tallyfy's API lets you add external guests to your organization via a
  POST request with just an email address and optional profile fields. It automatically
  links existing global guests instead of creating duplicates.

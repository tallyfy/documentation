...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/guests`;
...
public class CreateGuest {
    public static void main(String[] args) {
        ...
        String apiUrl = "https://api.tallyfy.com/organizations/" + orgId + "/guests";
...
func main() {
    ...
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/guests", orgId)
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Guests > List guests</b>" href="./list-guests/"> See all guests in the organization. </LinkTitleCard>
<LinkTitleCard header="<b>Guests > Get guest</b>" href="./get-guest/"> Get details for this specific guest. </LinkTitleCard>

---
description: This API endpoint creates a new guest user record within a specified
  organization by sending a POST request with required email and optional details
  like name phone company and associated members returning the created guest information

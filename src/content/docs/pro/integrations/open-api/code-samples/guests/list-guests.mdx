---
description: This API endpoint retrieves all guest users associated with a Tallyfy
  organization by making a GET request with proper authorization headers and optional
  query parameters for pagination and additional statistics data.

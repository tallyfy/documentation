---
about_tallyfy: true
description: Tallyfy's API allows you to retrieve a paginated and filterable list
  of guest users in your organization by calling a GET endpoint with optional search
  and sorting parameters and including completion statistics when needed.

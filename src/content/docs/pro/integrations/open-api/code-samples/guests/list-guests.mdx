...
sidebar:
  order: 1
snippet: The GET endpoint allows retrieving a list of guest users with their details
  from an organization through various programming languages while requiring proper
  authentication and optional query parameters for additional data.
title: List guests
---
...
<LinkTitleCard header="<b>Guests > Update guest</b>" href="/products/pro/integrations/open-api/code-samples/guests/update-guest/" > The PUT endpoint allows updating guest user details like name phone and company information through a JSON request body while maintaining their email address as the unique identifier. </LinkTitleCard>

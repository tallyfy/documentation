---
description: The GET endpoint retrieves detailed information for a specific guest
  user within an organization using their URL-encoded email address and returns their
  profile data including optional statistics through authenticated API requests across

...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/guests/${encodedEmail}${queryParams}`;
...
public class GetGuest {
    public static void main(String[] args) {
        ...
        String baseUrl = String.format("https://api.tallyfy.com/organizations/%s/guests/%s", orgId, encodedEmail);
...
func main() {
    ...
    guestEmail := "guest.to.get@example.com"
    encodedEmail := url.PathEscape(guestEmail) // Use PathEscape for path segments
    
    baseUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/guests/%s", orgId, encodedEmail)

    queryParams := url.Values{}
    queryParams.Add("with", "stats") // Example
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Guests > List guests</b>" href="./list-guests/"> Get a list of all guests. </LinkTitleCard>
<LinkTitleCard header="<b>Guests > Update guest</b>" href="./update-guest/"> Modify this guest's details. </LinkTitleCard>
<LinkTitleCard header="<b>Guests > Delete guest</b>" href="./delete-guest/"> Remove this guest. </LinkTitleCard>
</CardGrid>
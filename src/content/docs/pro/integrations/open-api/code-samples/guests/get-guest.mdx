---
about_tallyfy: true
description: Tallyfy's API allows you to retrieve detailed information about a specific
  guest user in your organization by making a GET request with the guest's URL-encoded
  email address and optionally including completion statistics.

...
sidebar:
  order: 3
snippet: The GET endpoint allows retrieval of specific guest user details within an
  organization by using their email address and includes optional query parameters
  for additional related data such as stats.
title: Get guest
---

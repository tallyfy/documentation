...
<LinkTitleCard header="<b>Code Samples > Managing guests</b>" href="/products/pro/integrations/open-api/code-samples/guests/" > Tallyfy's API allows you to manage external guest users—who participate in tasks without needing... </LinkTitleCard>
<LinkTitleCard header="<b>Guests > Create guest</b>" href="/products/pro/integrations/open-api/code-samples/guests/create-guest/" > Tallyfy's API allows you to add external guest users to your organization via a POST request... </LinkTitleCard>
</CardGrid>
...
<LinkTitleCard header="<b>Files > Delete file</b>" href="/products/pro/integrations/open-api/code-samples/files/delete-file/" > A DELETE endpoint permanently removes uploaded files from Tallyfy by using the asset ID and organization ID with appropriate authentication headers returning a 200 OK status upon successful deletion. </LinkTitleCard>
</CardGrid>
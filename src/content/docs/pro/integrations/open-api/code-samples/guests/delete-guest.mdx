---
about_tallyfy: true
description: The DELETE endpoint at `/organizations/{org_id}/guests/{guest_email}`
  permanently removes a guest from your Tallyfy organization by detaching them from
  all tasks and soft-deleting their record if they have no other organization memberships.

---
about_tallyfy: true
description: Tallyfy's DELETE endpoint at `/organizations/{org_id}/guests/{guest_email}` removes a guest by URL-encoded email. It detaches them from all tasks and soft-deletes the record if they don't belong to other organizations.

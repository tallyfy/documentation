...
<LinkTitleCard header="<b>Groups > Delete group</b>" href="/products/pro/integrations/open-api/code-samples/groups/delete-group/" > Delete a group from your organization using a DELETE request, which permanently removes the group association while keeping individual member and guest accounts. </LinkTitleCard>

...
There's no restore endpoint for this. To switch a guest's access off and back on, or to permanently delete a guest's account, see [disable, enable or delete guest](/products/pro/integrations/open-api/code-samples/guests/disable-or-delete-guest/).

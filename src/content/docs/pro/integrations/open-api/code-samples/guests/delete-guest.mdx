...
<LinkTitleCard header="<b>Guests > List guests</b>" href="/products/pro/integrations/open-api/code-samples/guests/list-guests/" > Retrieve a paginated list of guest users in your organization. You'll get detailed profiles with... </LinkTitleCard>
</CardGrid>
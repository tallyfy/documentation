---
about_tallyfy: true
description: Tallyfy's API lets you retrieve a paginated list of all organization
  members via a GET request with optional filtering by name or email and sorting and
  the ability to include related data like groups and stats in the response.

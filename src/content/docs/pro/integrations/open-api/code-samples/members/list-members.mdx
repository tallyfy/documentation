---
about_tallyfy: true
description: The Tallyfy API allows you to retrieve a paginated and filterable list
  of all organization members by sending a GET request to the users endpoint with
  optional query parameters for searching by name or email and including related data

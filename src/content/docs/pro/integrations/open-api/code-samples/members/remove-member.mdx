---
about_tallyfy: true
description: Tallyfy's API allows admins to deactivate organization members via a
  DELETE endpoint with optional task reassignment to another user and also supports

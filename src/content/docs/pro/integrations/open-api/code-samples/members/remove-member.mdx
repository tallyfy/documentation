...
description: Tallyfy's API lets you deactivate a member from your organization using
  a DELETE request with optional task reassignment to another user and also supports
  a separate two-step flow for permanent deletion that requires disabling the member
  first.

...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/users/${userId}${queryStr ? '?' + queryStr : ''}`;
...
public class RemoveMember {
    public static void main(String[] args) {
        ...
        String baseUrl = String.format("https://api.tallyfy.com/organizations/%s/users/%d", orgId, userId);
...
func main() {
    ...
    //     queryParams.Add("with_reassignment", "true")
    //     queryParams.Add("to", strconv.Itoa(reassignToUserId))
    // }

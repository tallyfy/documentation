---
description: This endpoint allows administrators to modify a member's role within
  a Tallyfy organization by sending a PUT request with the new role name (such as
  admin standard or light) and returns the updated user profile upon successful completion.

...
<LinkTitleCard header="<b>Code Samples > Managing members (users)</b>" href="/products/pro/integrations/open-api/code-samples/members/" > Tallyfy's Members API lets you manage registered users in your organization—including inviting... </LinkTitleCard>
</CardGrid>
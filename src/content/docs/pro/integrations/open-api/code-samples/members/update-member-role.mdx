---
about_tallyfy: true
description: Tallyfy's API lets you change any member's role to admin, standard, or
  light. Send a PUT request with the new role, and you'll get the updated member profile
  back.

...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/users/${userId}/role`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/users/{user_id}/role'
...
public class UpdateMemberRole {
    public static void main(String[] args) {
        ...
        int userId = 12345;
        String apiUrl = String.format("https://api.tallyfy.com/organizations/%s/users/%d/role", orgId, userId);
...
func main() {
    ...
    userId := 12345
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/users/%s/role", orgId, strconv.Itoa(userId))

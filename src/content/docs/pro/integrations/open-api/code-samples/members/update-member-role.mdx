---
description: This API endpoint allows administrators to modify the role permissions
  of organization members by sending a PUT request with the desired role name to update
  user access levels within the system.

...
<LinkTitleCard header="<b>Groups > Update group</b>" href="/products/pro/integrations/open-api/code-samples/groups/update-group/" > Tallyfy's PUT endpoint at `/organizations/[org_id]/groups/[group_id]` lets you update a group's... </LinkTitleCard>
...
<LinkTitleCard header="<b>Tags > Update tag</b>" href="/products/pro/integrations/open-api/code-samples/tags/update-tag/" > Tallyfy's API allows you to modify an existing tag's title or hex color within your organization... </LinkTitleCard>
</CardGrid>
---
description: The PUT endpoint for organizations allows updating member profile information
  including name job title team timezone and other details through a JSON request
  body that returns the complete updated member profile upon successful completion.

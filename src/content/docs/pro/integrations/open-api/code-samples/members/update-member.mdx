---
about_tallyfy: true
description: Tallyfy's API lets admins update a member's profile (name, timezone,
  and optional fields like phone or job title) via a PUT request. It returns the full

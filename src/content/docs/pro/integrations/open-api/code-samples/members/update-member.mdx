...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/users/${userId}`;
...
public class UpdateMember {
    public static void main(String[] args) {
        ...
        int userId = 12345;
        String apiUrl = String.format("https://api.tallyfy.com/organizations/%s/users/%d", orgId, userId);
...
func main() {
    ...
    userId := 12345
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/users/%s", orgId, strconv.Itoa(userId))

---
about_tallyfy: true
description: Tallyfy's PUT endpoint at `/organizations/{org_id}/users/{user_id}` allows
  admins to update a member's profile details like name and timezone and job title
  by sending a JSON payload with required fields (first_name and last_name and timezone)
  along with any optional fields such as phone or team or date format.
...
<LinkTitleCard header="<b>Groups > Update group</b>" href="/products/pro/integrations/open-api/code-samples/groups/update-group/" > Tallyfy's PUT endpoint for groups lets you rename a group or change its description and fully... </LinkTitleCard>
...
<LinkTitleCard header="<b>Tags > Update tag</b>" href="/products/pro/integrations/open-api/code-samples/tags/update-tag/" > Tallyfy's API lets you modify an existing tag's title (up to 30 characters and unique within... </LinkTitleCard>
</CardGrid>
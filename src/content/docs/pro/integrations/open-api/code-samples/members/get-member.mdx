---
description: The GET endpoint retrieves detailed profile information for a specific
  organization member using their unique user ID with optional query parameters for
  additional related data like stats or groups.

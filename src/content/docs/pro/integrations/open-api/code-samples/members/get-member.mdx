---
about_tallyfy: true
description: Tallyfy's API lets admin users fetch a specific organization member's
  profile by their numeric user ID through a GET request. You can optionally include
  related data like stats, groups, and preferences.

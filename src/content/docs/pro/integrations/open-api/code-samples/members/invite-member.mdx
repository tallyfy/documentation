---
about_tallyfy: true
description: Tallyfy's API lets you invite new users to your organization by sending
  a POST request with their email and name and role and a personal message to the
  `/users/invite` endpoint which returns the invited user's profile with a status
  of "invited" until they accept.

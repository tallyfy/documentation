...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/users/invite`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/users/invite'
...
public class InviteMember {
    public static void main(String[] args) {
        ...
        String apiUrl = "https://api.tallyfy.com/organizations/" + orgId + "/users/invite";
...
func main() {
    ...
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/users/invite", orgId)

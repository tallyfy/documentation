...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Guests > Create guest</b>" href="/products/pro/integrations/open-api/code-samples/guests/create-guest/" > This API endpoint creates a new guest user record within a specified organization by sending a POST request with required email and optional details like name phone company and associated members returning the created guest information with unique ID and timestamps. </LinkTitleCard>
...
<LinkTitleCard header="<b>Groups > Create group</b>" href="/products/pro/integrations/open-api/code-samples/groups/create-group/" > The POST endpoint creates a new group within an organization by accepting a JSON payload with required name field and optional description members and guests parameters while returning the created group details with assigned ID upon successful completion. </LinkTitleCard>

...
description: Tallyfy's API lets you invite new users to your organization by sending
  a POST request to the invite endpoint with their email and name and role and a personal
  message which triggers an invitation email and returns the user profile with an
  "invited" status until they accept.

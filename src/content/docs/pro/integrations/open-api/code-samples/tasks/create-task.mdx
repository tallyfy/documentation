...
<LinkTitleCard header="<b>Processes > Launch projects</b>" href="/products/pro/integrations/open-api/code-samples/processes/launch-process-without-template/" > Tallyfy's API lets you create ad-hoc projects without a predefined template. Use the... </LinkTitleCard>

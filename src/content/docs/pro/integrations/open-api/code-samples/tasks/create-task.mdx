---
about_tallyfy: true
description: Tallyfy's API lets you create standalone one-off tasks outside of any
  process by POSTing a title and task type and assignees and deadline to the `/organizations/{org_id}/tasks`
  endpoint which returns the new task's ID and details for future reference.
...
<LinkTitleCard header="<b>Processes > Launch projects</b>" href="/products/pro/integrations/open-api/code-samples/processes/launch-process-without-template/" > Tallyfy's API allows you to launch an ad-hoc "empty shell" process without a predefined template... </LinkTitleCard>

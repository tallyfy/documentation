---
about_tallyfy: true
description: Tallyfy's API lets you create standalone one-off tasks outside any process. Send a POST request with required fields like title, task type, assignees, and deadline, plus optional settings like form fields, webhooks, and confidentiality flags.

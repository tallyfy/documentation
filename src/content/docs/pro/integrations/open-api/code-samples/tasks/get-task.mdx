---
about_tallyfy: true
description: Tallyfy's API lets you fetch full details of any task (standalone or
  process-linked) by its unique ID using a GET request with optional related data
  like form fields and tags included via query parameters.

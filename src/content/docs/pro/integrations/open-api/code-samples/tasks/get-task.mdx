---
description: This API endpoint retrieves complete details for a specific task within
  an organization using GET requests with proper authentication headers and optional
  query parameters to include related data like runs steps form fields and tags.

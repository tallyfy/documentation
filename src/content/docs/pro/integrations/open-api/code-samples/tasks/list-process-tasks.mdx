...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Tasks > List organization tasks</b>" href="/products/pro/integrations/open-api/code-samples/tasks/list-org-tasks/" > Tallyfy's API endpoint `GET /organizations/[org_id]/tasks` retrieves all tasks across every... </LinkTitleCard>

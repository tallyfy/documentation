---
about_tallyfy: true
description: This API endpoint retrieves all tasks for a specific process run in Tallyfy
  and supports filtering by status and owners along with sorting and pagination options
  while also allowing related data like form fields and step details to be included
  in the response.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Tasks > List organization tasks</b>" href="/products/pro/integrations/open-api/code-samples/tasks/list-org-tasks/" > Tallyfy's API lets you retrieve and filter all tasks across an entire organization—including... </LinkTitleCard>

---
about_tallyfy: true
description: Tallyfy's API lets you retrieve all tasks for a specific process run
  via a GET request with optional filters for status and deadlines and owners and
  sorting and pagination along with the ability to include related data like form
  fields and step details in the response.

...
sidebar:
  order: 9
snippet: A DELETE endpoint that permanently removes standalone tasks from an organization
  with necessary authentication headers and returns a 204 status code upon successful
  deletion without any response body.
title: Delete task
---

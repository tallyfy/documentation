---
description: The DELETE endpoint permanently removes one-off tasks from Tallyfy organizations
  and returns a 204 No Content status upon successful deletion with no recovery option
  available.

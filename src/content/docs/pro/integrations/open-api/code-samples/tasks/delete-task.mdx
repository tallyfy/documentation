...
sidebar:
  order: 9
snippet: A DELETE endpoint permanently removes standalone tasks while preserving process-related
  tasks that can only be deleted through their parent process run deletion.
title: Delete task
---

...
<LinkTitleCard header="<b>Tasks > Archive task</b>" href="/products/pro/integrations/open-api/code-samples/tasks/archive-task/" > The DELETE endpoint archives standalone tasks by hiding them from default views while preserving data for potential future restoration using authenticated API requests and proper headers. </LinkTitleCard>

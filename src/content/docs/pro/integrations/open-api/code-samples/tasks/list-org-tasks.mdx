---
about_tallyfy: true
description: Retrieve and filter all tasks across your organization, including process-based
  and one-off tasks. You'll find query parameters for status, deadline, assignment,
  sorting, and pagination with code examples in six languages.

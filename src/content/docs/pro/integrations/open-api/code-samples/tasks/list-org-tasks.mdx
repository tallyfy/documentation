...
<LinkTitleCard header="<b>Tags > List tags</b>" href="/products/pro/integrations/open-api/code-samples/tags/list-tags/" > The Tallyfy API endpoint GET /organizations/[org_id]/tags retrieves a paginated list of all tags... </LinkTitleCard>

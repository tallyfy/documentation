---
about_tallyfy: true
description: Tallyfy's API lets you retrieve and filter all tasks across an entire
  organization—including both process-based and one-off tasks—using a GET endpoint
  with extensive query parameters for status and deadline filtering and owner/guest/group
  assignment and sorting and pagination with code examples in six languages.

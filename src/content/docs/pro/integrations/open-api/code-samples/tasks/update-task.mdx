---
description: The endpoint updates existing Tallyfy tasks using PUT requests with JSON
  payloads containing modified fields like title summary deadline assignees and form
  field values where assignee updates replace the entire list rather than adding to
  it.

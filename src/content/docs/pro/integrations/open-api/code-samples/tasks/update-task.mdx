...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Update process</b>" href="/products/pro/integrations/open-api/code-samples/processes/update-process/" > The Tallyfy API allows you to partially update a running process by sending a PUT request to... </LinkTitleCard>

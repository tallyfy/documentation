---
description: This documentation explains how to update existing Tallyfy tasks using
  PUT API endpoints with separate URLs for process tasks and one-off tasks and covers
  modifying properties like title deadline assignees and form field values through
  taskdata objects with specific formatting requirements for different field types
  including text dropdowns radio buttons and multi-select checkboxes.
...
#### Complete field update example

Here's a comprehensive example showing how to update different field types in a single API call:
...
```json
{
  "data": {
    ...
    "deadline": "2025-07-01T09:00:00Z", // Updated deadline
    "last_updated": "2025-05-20T16:00:00Z", // Reflects update time

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Update process</b>" href="/products/pro/integrations/open-api/code-samples/processes/update-process/" > Update properties of a running Tallyfy process using PUT - change name summary owner assignees visibility and kick-off form field values. </LinkTitleCard>

...
description: Tallyfy's API lets you update any task (process or one-off) via a PUT
  ...
  and other properties — with assignee updates replacing the entire list rather than
  merging and with different field types like dropdowns and checkboxes requiring specific

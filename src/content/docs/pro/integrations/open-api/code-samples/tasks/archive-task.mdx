---
description: The DELETE endpoint archives standalone tasks by hiding them from default
  views while preserving their data for potential restoration or permanent deletion
  later.

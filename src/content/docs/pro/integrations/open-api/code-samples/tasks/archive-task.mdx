...
sidebar:
  order: 5
snippet: This API endpoint archives a completed task removing it from active views
  and requires the Task ID for execution returning task details upon success with

---
about_tallyfy: true
description: Tallyfy's API allows you to soft-delete (archive) a standalone one-off
  task by sending a DELETE request to the task endpoint which hides it from default
  views while preserving all data and allowing restoration later.

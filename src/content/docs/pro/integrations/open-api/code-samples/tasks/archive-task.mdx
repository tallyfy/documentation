...
sidebar:
  order: 5
snippet: The DELETE endpoint archives standalone tasks by hiding them from default
  views while preserving data for potential future restoration using authenticated
  API requests and proper headers.
title: Archive task
---

...
sidebar:
  order: 6
snippet: An API endpoint marks tasks as complete through POST requests requiring task
  ID with optional approval status and form field values while supporting both process-based
  and standalone tasks through different URL structures.
title: Complete task
---

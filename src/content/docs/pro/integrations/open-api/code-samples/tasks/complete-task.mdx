---
description: This API endpoint marks tasks as complete using different URLs for process
  tasks versus one-off tasks while supporting optional approval decisions and simultaneous
  form field updates through POST requests with proper authentication headers.

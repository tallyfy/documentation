...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Postman > Task operations and automation</b>" href="/products/pro/integrations/open-api/api-clients/postman/task-operations/" > Use Tallyfy's task API endpoints in Postman to list, complete, update, and comment on tasks within running processes, including form field handling, file attachments, and assignment patterns. </LinkTitleCard>

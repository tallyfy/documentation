---
description: This documentation explains how to mark Tallyfy tasks as complete using
  POST requests to different endpoints for process tasks versus one-off tasks with
  options to include approval status and final form field updates in the request payload.

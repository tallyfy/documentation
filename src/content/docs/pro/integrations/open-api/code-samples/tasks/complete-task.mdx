...
<LinkTitleCard header="<b>Postman > Task operations and automation</b>" href="/products/pro/integrations/open-api/api-clients/postman/task-operations/" > Tallyfy's API allows you to list and filter tasks by status or assignee and complete them via a... </LinkTitleCard>
<LinkTitleCard header="<b>Tasks > Reopen task</b>" href="/products/pro/integrations/open-api/code-samples/tasks/reopen-task/" > Tallyfy's API allows you to reopen a completed task by sending a DELETE request to the... </LinkTitleCard>

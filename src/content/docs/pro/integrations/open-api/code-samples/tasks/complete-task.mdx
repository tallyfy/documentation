---
about_tallyfy: true
description: Tallyfy's API allows you to mark both process-based and standalone tasks
  as complete by sending a POST request with the task ID and optional approval status
  while requiring all form fields to be filled beforehand.

---
about_tallyfy: true
description: Mark process tasks or standalone tasks as complete by POSTing the task
  ID to the right endpoint. Optionally handle approval decisions or override the completing
  user, with all required form fields filled beforehand.

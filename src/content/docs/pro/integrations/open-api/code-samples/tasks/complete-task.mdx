...
sidebar:
  order: 6
snippet: The API endpoint enables task completion through POST requests with task
  IDs and optional parameters like approval status and form field values while supporting
  both process-specific and standalone tasks.
title: Complete task
---

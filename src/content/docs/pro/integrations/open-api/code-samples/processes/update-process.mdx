---
description: The PUT endpoint allows modification of existing Tallyfy process instance
  properties like name summary owner tags and folders where providing arrays for tags
  or folders completely replaces the existing values rather than appending to them.

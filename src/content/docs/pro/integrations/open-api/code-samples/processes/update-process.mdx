...
description: Tallyfy's API lets you partially update a running process by sending
  a PUT request with only the fields you want to change. Sending user or group arrays
  will fully replace all existing assignees of that type rather than appending to
  them.

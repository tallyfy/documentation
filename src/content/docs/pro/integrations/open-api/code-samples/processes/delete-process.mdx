...
sidebar:
  order: 7
snippet: A DELETE endpoint permanently removes a specific process instance and its
  associated data with authentication headers returning either 200 OK or 204 No Content
  status codes upon successful deletion.
...
const apiUrl = `https://go.tallyfy.com/api/organizations/${orgId}/runs/${runId}/delete`; // Note /delete
...
api_url = f'https://go.tallyfy.com/api/organizations/{org_id}/runs/{run_id}/delete' # Note /delete
...
public class DeleteProcess {
    public static void main(String[] args) {
        ...
        String apiUrl = String.format("https://go.tallyfy.com/api/organizations/%s/runs/%s/delete", orgId, runId); // Note /delete
...
func main() {
    ...
    apiUrl := fmt.Sprintf("https://go.tallyfy.com/api/organizations/%s/runs/%s/delete", orgId, runId) // Note /delete
...
<LinkTitleCard header="<b>Files > Delete file</b>" href="/products/pro/integrations/open-api/code-samples/files/delete-file/" > A DELETE API endpoint that removes uploaded files and their associations from tasks or kick-off forms while offering implementation examples in JavaScript Python Java and Go. </LinkTitleCard>
</CardGrid>
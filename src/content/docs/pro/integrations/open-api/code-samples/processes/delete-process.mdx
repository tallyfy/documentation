...
<LinkTitleCard header="<b>Groups > Delete group</b>" href="/products/pro/integrations/open-api/code-samples/groups/delete-group/" > A DELETE endpoint permanently removes an organizational group while maintaining individual member accounts and requires authentication headers to return either a 200 OK or 204 No Content status code. </LinkTitleCard>

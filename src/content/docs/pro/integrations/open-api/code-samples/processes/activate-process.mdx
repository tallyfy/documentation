---
description: The PUT endpoint activates an archived process run by making it operational
  again through a simple request requiring only authorization headers and organization/run
  IDs with no request body needed.

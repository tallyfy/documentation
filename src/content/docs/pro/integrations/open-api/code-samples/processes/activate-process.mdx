...
sidebar:
  order: 6
snippet: The PUT endpoint enables restoration of an archived process instance by removing
  the archived timestamp and updating its status through organization and run IDs

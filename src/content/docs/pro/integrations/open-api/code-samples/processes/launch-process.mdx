...
sidebar:
  order: 1
snippet: The endpoint launches process instances by sending a POST request with required
  checklist ID and name fields plus optional parameters like prerun data task overrides

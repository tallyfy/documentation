...
<LinkTitleCard header="<b>Templates > Create a template</b>" href="/products/pro/integrations/open-api/code-samples/templates/create-template/" > Create a new Tallyfy template (blueprint) in an organization by POSTing a JSON body with a title, type, and optional settings like summary, owner, webhook, permissions, and kick-off form fields. </LinkTitleCard>

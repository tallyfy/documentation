---
description: This API endpoint enables launching new process instances from templates
  by sending a POST request with required template ID and process name along with
  optional parameters for pre-filling forms overriding task assignments and configuring
  various process settings.

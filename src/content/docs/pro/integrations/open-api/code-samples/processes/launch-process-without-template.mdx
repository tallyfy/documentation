...
<LinkTitleCard header="<b>Postman > Working with templates and processes</b>" href="/products/pro/integrations/open-api/api-clients/postman/templates-processes/" > The Tallyfy API enables launching workflow processes from templates using template IDs with kick-off form data while supporting both basic and advanced patterns including conditional launching bulk operations and process monitoring through Postman integration. </LinkTitleCard>

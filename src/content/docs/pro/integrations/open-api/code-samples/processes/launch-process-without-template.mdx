...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>API > Client Credentials Flow</b>" href="/products/pro/integrations/open-api/code-samples/authentication/client-credentials-flow/" > Authenticate with the Tallyfy API using OAuth 2.0 client credentials flow for server-to-server integrations without user interaction. </LinkTitleCard>
<LinkTitleCard header="<b>Tasks > Create one-off tasks</b>" href="/products/pro/tracking-and-tasks/tasks/create-one-off-tasks/" > Create standalone tasks that aren't tied to templates or processes for ad-hoc work assignments and tracking in Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Processes > Launch process</b>" href="/products/pro/integrations/open-api/code-samples/processes/launch-process/" > Launch new process instances from templates via API with customizable assignments deadlines and initial data values. </LinkTitleCard>
<LinkTitleCard header="<b>Integrations > Webhooks</b>" href="/products/pro/integrations/webhooks/" > Configure webhooks to receive real-time notifications when events occur in Tallyfy including task completions process launches and status changes. </LinkTitleCard>
</CardGrid>
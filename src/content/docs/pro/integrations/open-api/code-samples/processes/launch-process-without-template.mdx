...
<CardGrid>
<LinkTitleCard header="<b>API Authentication</b>" href="/products/pro/integrations/open-api/code-samples/authentication/client-credentials-flow" > Learn how to authenticate with the Tallyfy API </LinkTitleCard>
<LinkTitleCard header="<b>Create One-off Tasks</b>" href="/products/pro/integrations/open-api/endpoints/one-off-tasks" > Complete documentation for the one-off tasks endpoint </LinkTitleCard>
<LinkTitleCard header="<b>Process Management</b>" href="/products/pro/integrations/open-api/endpoints/processes" > Managing and tracking processes via API </LinkTitleCard>
<LinkTitleCard header="<b>Webhook Events</b>" href="/products/pro/integrations/webhooks" > React to process and task events with webhooks </LinkTitleCard>
</CardGrid>
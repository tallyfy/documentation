...
<LinkTitleCard header="<b>Processes > Launch process</b>" href="/products/pro/integrations/open-api/code-samples/processes/launch-process/" > Tallyfy's Launch Process API endpoint (POST /organizations/[org_id]/runs) lets you... </LinkTitleCard>

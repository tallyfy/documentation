---
description: Learn how to create processes in Tallyfy without requiring a template, perfect for AI assistants and automation scenarios that need ad-hoc task bundling
id: launch-process-without-template
sidebar:
  order: 45

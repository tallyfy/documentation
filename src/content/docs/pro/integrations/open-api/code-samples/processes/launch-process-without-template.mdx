...
import { LinkTitleCard } from "/src/components/LinkTitleCard/LinkTitleCard"
...
<LinkTitleCard
  ...
  href="/products/pro/integrations/open-api/code-samples/authentication/client-credentials-flow"
  description="Learn how to authenticate with the Tallyfy API"
/>

<LinkTitleCard
  title="Create One-off Tasks"
  href="/products/pro/integrations/open-api/endpoints/one-off-tasks"
  description="Complete documentation for the one-off tasks endpoint"
/>

<LinkTitleCard
  title="Process Management"
  href="/products/pro/integrations/open-api/endpoints/processes"
  description="Managing and tracking processes via API"
/>

<LinkTitleCard
  title="Webhook Events"
  href="/products/pro/integrations/webhooks"
  description="React to process and task events with webhooks"
/>
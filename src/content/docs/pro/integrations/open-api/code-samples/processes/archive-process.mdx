---
about_tallyfy: true
description: Tallyfy's API lets you soft-delete (archive) a running process via a
  DELETE request so it disappears from default views while preserving all tasks and
  data intact and can be fully restored later using the activate endpoint.

---
description: This DELETE endpoint archives a Tallyfy process instance by hiding it
  from default views while preserving all data for potential future restoration and
  returns the archived process details with an updated status and timestamp upon successful
  completion.
...
```json
{
  "data": {
    ...
    "archived_at": "YYYY-MM-DDTHH:MM:SSZ" // Timestamp indicates archival
  }
}
```

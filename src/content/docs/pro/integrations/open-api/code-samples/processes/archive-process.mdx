---
description: The DELETE endpoint archives a specific process instance by hiding it
  from default views while retaining its data and allowing future restoration through
  the provided Organization ID and run ID parameters.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Delete process</b>" href="/products/pro/integrations/open-api/code-samples/processes/delete-process/" > The DELETE endpoint permanently removes a specific process instance and all its associated data from an organization using the run ID with proper authentication headers. </LinkTitleCard>
...
<LinkTitleCard header="<b>Templates > Archive or delete template</b>" href="/products/pro/integrations/open-api/code-samples/templates/delete-archive-template/" > The API provides two template removal methods - archiving which hides templates while preserving data and allowing restoration and permanent deletion which irreversibly removes all template data and cannot be undone. </LinkTitleCard>
</CardGrid>
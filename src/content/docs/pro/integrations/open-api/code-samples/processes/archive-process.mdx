---
about_tallyfy: true
description: The Tallyfy API allows you to soft-delete (archive) a process run by
  sending a DELETE request to the runs endpoint which hides it from default views
  while preserving all associated data including tasks and comments and lets you restore
  it later through the activate endpoint.
...
<LinkTitleCard header="<b>Processes > Activate process</b>" href="/products/pro/integrations/open-api/code-samples/processes/activate-process/" > Tallyfy's API allows you to restore a previously archived process run by sending a PUT request... </LinkTitleCard>

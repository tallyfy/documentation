...
sidebar:
  order: 5
snippet: A DELETE endpoint that archives a process run by hiding it from default views
  while preserving its data for potential future restoration with status code 200
  OK upon success.

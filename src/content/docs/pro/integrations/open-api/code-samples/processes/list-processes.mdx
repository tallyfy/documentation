...
<LinkTitleCard header="<b>Processes > Update process</b>" href="/products/pro/integrations/open-api/code-samples/processes/update-process/" > The PUT endpoint enables modification of existing process instance properties including name summary owner tags folders and form field values through a JSON request body. </LinkTitleCard>
</CardGrid>
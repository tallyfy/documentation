---
about_tallyfy: true
description: Use the Tallyfy API to manage processes (runs) through org-scoped endpoints.
  Launch, list, update, archive, restore, and delete processes, plus retrieve activity
  feeds.

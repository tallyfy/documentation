...
<LinkTitleCard header="<b>Templates > Get template</b>" href="/products/pro/integrations/open-api/code-samples/templates/get-template/" > Tallyfy's API allows you to fetch the full details of a specific process template by its unique... </LinkTitleCard>

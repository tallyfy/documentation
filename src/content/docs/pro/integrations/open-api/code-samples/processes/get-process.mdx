---
about_tallyfy: true
description: Retrieve full details of a specific process run by ID, with optional
  related data like tasks, form fields, and tags. The next_task option returns the
  earliest-deadline incomplete task for dashboards or notifications.

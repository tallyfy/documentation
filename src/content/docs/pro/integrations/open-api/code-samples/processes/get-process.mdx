---
about_tallyfy: true
description: Tallyfy's API lets you retrieve full details of a specific process run
  by its unique ID using a GET request with optional query parameters to include related
  data like tasks and tags and form field values.

---
about_tallyfy: true
description: Tallyfy's activity feed API endpoint returns a full audit trail of process
  events—including task completions and comments and status changes—filterable by
  entity type and verb and actor and date range with paginated results useful for
  compliance and custom dashboard building.

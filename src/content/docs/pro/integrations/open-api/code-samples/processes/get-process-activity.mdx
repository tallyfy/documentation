...
<LinkTitleCard header="<b>Tasks > List process tasks</b>" href="/products/pro/integrations/open-api/code-samples/tasks/list-process-tasks/" > This API endpoint retrieves all tasks for a specific process run in Tallyfy and supports... </LinkTitleCard>
...
<LinkTitleCard header="<b>Processes > Get process</b>" href="/products/pro/integrations/open-api/code-samples/processes/get-process/" > Tallyfy's API lets you retrieve full details of a specific process run by its unique ID using a... </LinkTitleCard>
</CardGrid>
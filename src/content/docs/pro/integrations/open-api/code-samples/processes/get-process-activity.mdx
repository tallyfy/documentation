---
description: Retrieve the complete activity feed and audit log for a specific process (run) including all events, changes, comments, and user actions with comprehensive filtering options
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Launch a process</b>" href="/products/pro/integrations/open-api/code-samples/processes/launch-process/" > Learn how to launch new process instances via API. </LinkTitleCard>
<LinkTitleCard header="<b>Processes > Get a process</b>" href="/products/pro/integrations/open-api/code-samples/processes/get-process/" > Retrieve details about a specific process including its current state. </LinkTitleCard>
<LinkTitleCard header="<b>Processes > List processes</b>" href="/products/pro/integrations/open-api/code-samples/processes/list-processes/" > Get a list of all processes in your organization with filtering options. </LinkTitleCard>
<LinkTitleCard header="<b>API > OAuth flow</b>" href="/products/pro/integrations/open-api/oauth-authorization-flow/" > Set up OAuth authentication to access the Tallyfy API. </LinkTitleCard>
</CardGrid>
...
<LinkTitleCard header="<b>Tasks > List process tasks</b>" href="/products/pro/integrations/open-api/code-samples/tasks/list-process-tasks/" > Tallyfy's API lets you retrieve all tasks for a specific process run via a GET request with... </LinkTitleCard>
<LinkTitleCard header="<b>Processes > Get process</b>" href="/products/pro/integrations/open-api/code-samples/processes/get-process/" > Tallyfy's GET endpoint lets you retrieve full details of a specific process run by its ID and... </LinkTitleCard>
</CardGrid>
---
about_tallyfy: true
description: Tallyfy's activity feed API endpoint lets you pull a full audit trail
  of every event on a process—including task completions and comments and status changes—by
  calling GET on the activity-feeds resource with filters for entity type and verb
  and date range and actor while supporting pagination and role-based access control.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > List processes</b>" href="/products/pro/integrations/open-api/code-samples/processes/list-processes/" > Tallyfy's API lets you retrieve a paginated and filterable list of all running process instances in your organization by calling GET on the runs endpoint with optional parameters for status and ownership and tags and sorting and related data inclusion. </LinkTitleCard>
...
<LinkTitleCard header="<b>Tasks > List process tasks</b>" href="/products/pro/integrations/open-api/code-samples/tasks/list-process-tasks/" > Tallyfy's API lets you retrieve all tasks for a specific process run via a GET request with optional filters for status and deadlines and owners and sorting and pagination along with the ability to include related data like form fields and step details in the response. </LinkTitleCard>
<LinkTitleCard header="<b>Processes > Get process</b>" href="/products/pro/integrations/open-api/code-samples/processes/get-process/" > Tallyfy's GET endpoint lets you retrieve full details of a specific process run by its ID and optionally include related data like tasks and form fields and tags through query parameters while also supporting a special "next_task" option that returns the earliest-deadline incomplete task for building dashboards or automating notifications. </LinkTitleCard>
</CardGrid>
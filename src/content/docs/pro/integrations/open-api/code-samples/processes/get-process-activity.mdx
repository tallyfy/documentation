...
<LinkTitleCard header="<b>Processes > Get process</b>" href="/products/pro/integrations/open-api/code-samples/processes/get-process/" > Retrieve full details of a specific process run by ID, with optional related data like tasks... </LinkTitleCard>
</CardGrid>
...
Rapid polling gets throttled with HTTP 429 responses. Use pagination and caching to stay within limits, and wait the number of seconds in the `Retry-After` header before retrying.

## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > List processes</b>" href="/products/pro/integrations/open-api/code-samples/processes/list-processes/" > Use the GET runs endpoint to retrieve a paginated, filterable list of running processes in your... </LinkTitleCard>
...
<LinkTitleCard header="<b>Tasks > List process tasks</b>" href="/products/pro/integrations/open-api/code-samples/tasks/list-process-tasks/" > Retrieve all tasks for a specific process run through Tallyfy's API. Filter by status, deadline... </LinkTitleCard>

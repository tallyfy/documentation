...
sidebar:
  order: 4
snippet: A DELETE endpoint that removes uploaded files from tasks or kick-off forms
  by making authorized requests to either /organizations/{org_id}/file/{asset_id}

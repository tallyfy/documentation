...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/file/${assetId}`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/file/{asset_id}'
...
public class DeleteFile {
    public static void main(String[] args) {
        ...
        String apiUrl = String.format("https://api.tallyfy.com/organizations/%s/file/%s", orgId, assetId);
...
func main() {
    ...
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/file/%s", orgId, assetId)

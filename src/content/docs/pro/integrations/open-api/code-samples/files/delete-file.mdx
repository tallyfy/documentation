...
sidebar:
  order: 4
snippet: A DELETE endpoint permanently removes uploaded files from Tallyfy by using
  the asset ID and organization ID with appropriate authentication headers returning
  a 200 OK status upon successful deletion.
title: Delete file
---

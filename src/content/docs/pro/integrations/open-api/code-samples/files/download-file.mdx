...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/file/${fileId}/dl`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/file/{file_id}/dl'
...
public class DownloadFile {
    public static void main(String[] args) {
        ...
        String apiUrl = String.format("https://api.tallyfy.com/organizations/%s/file/%s/dl", orgId, fileId);
...
func main() {
    ...
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/file/%s/dl", orgId, fileId)

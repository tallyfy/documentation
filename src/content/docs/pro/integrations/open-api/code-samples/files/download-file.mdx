...
<LinkTitleCard header="<b>Code Samples > Managing files</b>" href="/products/pro/integrations/open-api/code-samples/files/" > Tallyfy's API lets you upload, download, get metadata for, and delete files attached to tasks or kick-off forms using multipart form data and S3 storage. </LinkTitleCard>

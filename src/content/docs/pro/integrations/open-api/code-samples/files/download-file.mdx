---
description: A GET endpoint that downloads the actual file content using organization
  ID and asset ID with proper filename extraction from Content-Disposition headers
  and returns raw file data instead of JSON.

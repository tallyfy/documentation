---
description: The GET endpoint retrieves metadata such as filename upload date and
  related object information for a specific uploaded file by replacing organization
  and asset IDs in the URL path and requires Bearer token authentication with proper
  headers.
...
<LinkTitleCard header="<b>Groups > Get group</b>" href="/products/pro/integrations/open-api/code-samples/groups/get-group/" > The GET endpoint retrieves detailed information for a specific group within an organization using its unique identifier and supports optional query parameters for including additional related data like assets. </LinkTitleCard>

...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/assets/${assetId}`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/assets/{asset_id}'
...
public class GetFileMetadata {
    public static void main(String[] args) {
        ...
        String apiUrl = String.format("https://api.tallyfy.com/organizations/%s/assets/%s", orgId, assetId);
...
func main() {
    ...
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/assets/%s", orgId, assetId)

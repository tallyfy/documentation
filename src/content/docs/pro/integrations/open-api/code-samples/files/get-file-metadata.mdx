...
<LinkTitleCard header="<b>Groups > Get group</b>" href="/products/pro/integrations/open-api/code-samples/groups/get-group/" > An API endpoint documentation detailing how to retrieve a single group's information using GET requests with authentication headers optional query parameters and code examples in multiple programming languages. </LinkTitleCard>
</CardGrid>
---
description: This API endpoint retrieves metadata for a specific uploaded file asset
  in Tallyfy by making a GET request with organization and asset IDs and returns details
  like filename and upload date in a JSON response.

...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/file`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/file'
...
public class UploadFile {
    public static void main(String[] args) {
        String accessToken = "...";
        String orgId = "...";
        String apiUrl = "https://api.tallyfy.com/organizations/" + orgId + "/file";
...
func main() {
    ...
    apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/file", orgId)

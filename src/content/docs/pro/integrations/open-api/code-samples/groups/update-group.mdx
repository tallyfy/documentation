---
about_tallyfy: true
description: Tallyfy's PUT endpoint at `/organizations/{org_id}/groups/{group_id}`
  lets you update a group's name and description and fully replace its member or guest
  lists by sending the complete new arrays of user IDs or email addresses in a single
  JSON request.

---
about_tallyfy: true
description: Tallyfy's PUT endpoint for groups lets you update a group's name and
  description or fully replace its member and guest lists by sending user IDs and
  email arrays to `/organizations/{org_id}/groups/{group_id}` with code samples in
  JavaScript and Python and Java and Go and C++ and C#.

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Groups > Create group</b>" href="/products/pro/integrations/open-api/code-samples/groups/create-group/" > The Tallyfy API lets you create a new group within your organization by sending a POST request... </LinkTitleCard>
<LinkTitleCard header="<b>Members > Update member</b>" href="/products/pro/integrations/open-api/code-samples/members/update-member/" > Tallyfy's PUT endpoint at `/organizations/[org_id]/users/[user_id]` allows admins to update a... </LinkTitleCard>
...
<LinkTitleCard header="<b>Groups > Get group</b>" href="/products/pro/integrations/open-api/code-samples/groups/get-group/" > Tallyfy's API allows you to retrieve the details of a specific group within your organization by... </LinkTitleCard>
</CardGrid>
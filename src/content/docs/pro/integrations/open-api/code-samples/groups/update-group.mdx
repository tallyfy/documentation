---
about_tallyfy: true
description: Tallyfy's PUT endpoint for groups lets you rename a group or change its
  description and fully replace its member and guest lists by sending updated user
  IDs or email arrays to `/organizations/{org_id}/groups/{group_id}` with code samples
  in JavaScript and Python and Java and Go and C++ and C#.

---
description: The PUT endpoint allows modification of existing organizational groups
  by updating their details and membership where providing members or guests arrays
  completely replaces the current lists for those types within the group.
...
# Note: Updating members/guests replaces the entire list.

...
<LinkTitleCard header="<b>Guests > Update guest</b>" href="/products/pro/integrations/open-api/code-samples/guests/update-guest/" > Update an existing guest's associated members in a Tallyfy organization by sending a PUT request with the guest's URL-encoded email address and a JSON payload containing the associated_members array. </LinkTitleCard>
</CardGrid>
---
about_tallyfy: true
description: The Tallyfy API lets you create a new group within your organization
  by sending a POST request with a name and description along with optional member
  IDs and guest emails and returns the newly created group object with its unique
...
<LinkTitleCard header="<b>Tags > Create tag</b>" href="/products/pro/integrations/open-api/code-samples/tags/create-tag/" > The Tallyfy API lets you create a new tag within an organization by sending a POST request to... </LinkTitleCard>
</CardGrid>
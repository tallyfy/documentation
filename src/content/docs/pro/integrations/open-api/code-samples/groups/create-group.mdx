...
<LinkTitleCard header="<b>Groups > Get group</b>" href="/products/pro/integrations/open-api/code-samples/groups/get-group/" > The Tallyfy API lets you fetch details of a specific group within your organization by sending a... </LinkTitleCard>

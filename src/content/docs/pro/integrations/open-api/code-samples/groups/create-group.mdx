---
about_tallyfy: true
description: Create a new group in your Tallyfy organization via a POST request with a
  name, description, and optional member or guest lists. You'll get the new group's

---
description: This documentation explains how to create a new group within a Tallyfy
  organization using a POST API endpoint that accepts group details like name and
  description along with optional member IDs and guest email addresses through authenticated
  requests in various programming languages.

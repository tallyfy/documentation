...
sidebar:
  order: 3
snippet: This API endpoint deletes a specified group and returns its details upon
  success requiring the Group ID for execution with code examples provided in multiple
  languages.
title: Delete group
---

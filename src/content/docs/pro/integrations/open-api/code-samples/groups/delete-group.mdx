---
about_tallyfy: true
description: Tallyfy's DELETE endpoint at /organizations/{org_id}/groups/{group_id} permanently removes a group without deleting its members or guests. Returns a 204 No Content status on success, with code samples in JavaScript, Python, Java, Go, C++, and C#.

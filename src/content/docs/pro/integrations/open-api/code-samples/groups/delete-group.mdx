...
sidebar:
  order: 3
snippet: A DELETE endpoint permanently removes an organizational group while maintaining
  individual member accounts and requires authentication headers to return either

...
<LinkTitleCard header="<b>Groups > Get group</b>" href="/products/pro/integrations/open-api/code-samples/groups/get-group/" > Fetch details of a specific group in your Tallyfy organization using a GET request. Returns the... </LinkTitleCard>
</CardGrid>
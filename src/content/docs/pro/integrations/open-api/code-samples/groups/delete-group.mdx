...
The group is also removed from every template step, task and process it was assigned to, and from any template or process permissions it granted. Members and guests who already got a task through the group stay assigned to that task as individuals. A template step assigned only to this group is left without an assignee.

---
description: The DELETE endpoint removes an existing group from an organization by
  group ID without deleting the actual members or guests and returns a 200 OK status
  with group details or 204 No Content upon successful deletion.

---
about_tallyfy: true
description: Retrieve a paginated list of all groups in your Tallyfy organization. Filter by name, sort results, and include related assets or users in the response.
...
You'll get a `200 OK` status code and a JSON object with a `data` array of groups and a `meta` object for pagination.

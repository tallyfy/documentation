---
about_tallyfy: true
description: Retrieve a paginated list of all groups in your Tallyfy organization.
  Filter by name, sort results, and include related assets or users in the response.

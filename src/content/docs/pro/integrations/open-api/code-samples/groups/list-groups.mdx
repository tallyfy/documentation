---
about_tallyfy: true
description: The Tallyfy API endpoint `GET /organizations/{org_id}/groups` returns
  a paginated list of groups in your organization with optional filtering by name
  and sorting and supports including related data like assets or users in the response.

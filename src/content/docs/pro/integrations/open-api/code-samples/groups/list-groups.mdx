---
about_tallyfy: true
description: Tallyfy's API lets you retrieve a paginated list of all groups in your
  organization via a GET request to `/organizations/{org_id}/groups` with optional
  filters for searching by name and sorting plus the ability to include related assets
  or users in the response.

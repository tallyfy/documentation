---
description: The GET endpoint retrieves detailed information for a specific group
  within an organization using its unique identifier and supports optional query parameters
  for including additional related data like assets.

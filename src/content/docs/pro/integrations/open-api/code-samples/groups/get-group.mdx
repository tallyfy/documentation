...
sidebar:
  order: 3
snippet: A GET endpoint retrieves specific group details using organization and group
  IDs with optional parameters to include additional data like assets through multiple

---
about_tallyfy: true
description: Tallyfy's API allows you to retrieve the details of a specific group
  within your organization by sending a GET request to the groups endpoint with the
  group ID and optionally including related assets like the group logo.

...
sidebar:
  order: 2
snippet: An API endpoint documentation detailing how to retrieve a single group's
  information using GET requests with authentication headers optional query parameters

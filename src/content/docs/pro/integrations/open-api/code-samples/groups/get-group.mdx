...
<LinkTitleCard header="<b>Members > List members</b>" href="/products/pro/integrations/open-api/code-samples/members/list-members/" > Tallyfy's API lets you retrieve a paginated list of organization members via a GET request... </LinkTitleCard>
</CardGrid>
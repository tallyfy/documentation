---
about_tallyfy: true
description: Fetch details of a specific group in your Tallyfy organization using
  a GET request. Returns the group's name, description, members, guests, and timestamps.

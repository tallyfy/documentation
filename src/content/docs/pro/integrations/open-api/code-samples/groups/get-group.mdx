...
sidebar:
  order: 2
snippet: This API endpoint retrieves detailed information about a specific group including
  its members using the Group ID providing code examples in multiple languages.
title: Get group
---

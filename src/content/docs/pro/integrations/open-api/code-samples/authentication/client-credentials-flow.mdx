...
Support -> App: "2. Client ID" {style.stroke-dash: 3}

# Application-Level Authentication
App -> Auth: "3. POST /oauth/token\ngrant_type=client_credentials\nclient_id,"
Auth -> App: "4. Access token\n(expires" {style.stroke-dash: 3}

App -> API: "5. API Request\nB..."
API -> App: "6. Response data" {style.stroke-dash: 3}

# Optional: User-Specific Operations
App -> API: "7. POST /applicat..."
API -> App: "8. User-specific ..." {style.stroke-dash: 3}

App -> API: "9. GET /organizat..."
API -> App: "10. User's tasks ..." {style.stroke-dash: 3}

...
sidebar:
  order: 2
snippet: The OAuth 2.0 Client Credentials flow enables secure machine-to-machine authentication
  for third-party applications to access Tallyfy API through client ID and secret
  tokens while supporting user provisioning and specific access management.

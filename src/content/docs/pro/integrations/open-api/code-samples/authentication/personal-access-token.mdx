---
id: api-auth-personal-token
sidebar:
  order: 1
title: Get & Use a Personal Access Token
snippet: Learn how to obtain and use your personal access token for authenticating API requests.
---
...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/me/tasks`; // Example endpoint
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/me/tasks' # Example endpoint
...
public class TallyfyApiClient {
    ...
    public static void main(String[] args) {
        ...
        String apiUrl = "https://api.tallyfy.com/organizations/" + orgId + "/me/tasks"; // Example endpoint
...
func main() {
	...
	apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/me/tasks", orgId) // Example endpoint

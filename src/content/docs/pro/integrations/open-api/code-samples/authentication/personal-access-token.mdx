---
description: Personal access tokens enable secure API authentication in Tallyfy by
  including them in request headers along with proper Accept and X-Tallyfy-Client
  values across multiple programming languages.

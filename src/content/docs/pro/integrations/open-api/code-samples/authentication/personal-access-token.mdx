...
description: The Tallyfy API uses personal access tokens for authentication which
  must be included in the Authorization header along with Accept and X-Tallyfy-Client
  headers for all API requests with code examples provided in multiple programming
  languages.

---
about_tallyfy: true
description: Use the Tallyfy API to update an existing template's properties through
  a PUT request. The title field is required, and array fields like users and groups
  fully replace existing lists.

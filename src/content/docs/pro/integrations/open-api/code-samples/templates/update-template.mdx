---
description: This API endpoint allows updating properties of an existing process template
  by sending a PUT request with JSON payload containing the fields to modify such
  as title summary owner and permissions.

---
description: A GET endpoint retrieves complete details for a specific process template
  using organization and checklist IDs with optional parameters to include related
  data like steps tags and folder hierarchies across multiple programming languages.
...
<LinkTitleCard header="<b>Processes > Get process</b>" href="/products/pro/integrations/open-api/code-samples/processes/get-process/" > An API endpoint retrieves comprehensive details for a specific process instance using GET request with organization and run IDs supporting optional query parameters to include related data like tasks checklists tags and form field values. </LinkTitleCard>

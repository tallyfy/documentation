...
sidebar:
  order: 3
snippet: A comprehensive GET endpoint for retrieving detailed process template information
  using various programming languages with optional query parameters and authentication
  headers.
title: Get template
---

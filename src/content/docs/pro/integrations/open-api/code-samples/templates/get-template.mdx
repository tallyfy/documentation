---
about_tallyfy: true
description: Tallyfy's API allows you to fetch the full details of a specific process
  template by its unique ID using a GET request and optionally include related data
  like steps and tags through query parameters.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Templates > List templates</b>" href="/products/pro/integrations/open-api/code-samples/templates/list-templates/" > Tallyfy's API provides a paginated GET endpoint at `/organizations/[org_id]/checklists` that... </LinkTitleCard>

...
// Optional: Add query parameters like ?with=steps,tags
const queryParams = ''; // e.g., '?with=steps'
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/checklists/${checklistId}${queryParams}`;
...
public class GetTemplate {
    ...
    public static void main(String[] args) {
        ...
        String baseUrl = "https://api.tallyfy.com/organizations/" + orgId + "/checklists/" + checklistId;
...
func main() {
	...
	baseURL := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/checklists/%s", orgId, checklistId)

    // Optional: Add query parameters
    queryParams := url.Values{}
    // queryParams.Add("with", "steps,tags")

...
<LinkTitleCard header="<b>Tags > Get tag</b>" href="/products/pro/integrations/open-api/code-samples/tags/get-tag/" > Retrieve a specific tag by its ID using a GET request to... </LinkTitleCard>
</CardGrid>
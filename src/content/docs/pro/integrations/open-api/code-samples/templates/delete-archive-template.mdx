---
description: The API provides two template removal methods - archiving which hides
  templates while preserving data and allowing restoration and permanent deletion
  which irreversibly removes all template data and cannot be undone.

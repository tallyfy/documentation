---
id: api-templates-delete-archive
sidebar:
  order: 5
...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/checklists/${checklistId}`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/checklists/{checklist_id}'
...
public class ArchiveTemplate {
    ...
    public static void main(String[] args) {
        ...
        String apiUrl = "https://api.tallyfy.com/organizations/" + orgId + "/checklists/" + checklistId;
...
func main() {
	...
	apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/checklists/%s", orgId, checklistId)
...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/checklists/${checklistId}/delete`; // <-- Added /delete
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/checklists/{checklist_id}/delete' # <-- Added /delete
...
```java
// ... (setup accessToken, orgId, checklistId as before) ...
String apiUrl = "https://api.tallyfy.com/organizations/" + orgId + "/checklists/" + checklistId + "/delete"; // <-- Added /delete
...
```go
// ... (setup accessToken, orgId, checklistId as before) ...
apiUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/checklists/%s/delete", orgId, checklistId) // <-- Added /delete

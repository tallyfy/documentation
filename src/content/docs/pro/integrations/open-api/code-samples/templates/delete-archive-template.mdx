---
about_tallyfy: true
description: 'Tallyfy''s API lets you remove templates in two steps. First archive (soft delete) with a DELETE request, then permanently delete with a second DELETE request using the /delete path segment.'

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Tasks > Archive task</b>" href="/products/pro/integrations/open-api/code-samples/tasks/archive-task/" > Archive a standalone task using a DELETE request, which soft-deletes it so it's hidden from default views but can be restored later. </LinkTitleCard>

---
about_tallyfy: true
description: Retrieve a paginated list of process templates from your Tallyfy organization
  using the API. Filter by title, status, tags, or owner, with code samples in JavaScript,

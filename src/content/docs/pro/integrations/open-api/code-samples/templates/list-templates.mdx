...
sidebar:
  order: 1
snippet: A GET endpoint that retrieves a list of process templates from a specified
  organization with optional query parameters for filtering and pagination while supporting
  multiple programming languages through code examples.

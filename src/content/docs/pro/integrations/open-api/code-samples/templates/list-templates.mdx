---
about_tallyfy: true
description: Tallyfy's API provides a paginated GET endpoint at `/organizations/{org_id}/checklists`
  that lets you retrieve and filter your organization's templates (called "checklists"
  in the API) with options for searching by title and sorting and including related

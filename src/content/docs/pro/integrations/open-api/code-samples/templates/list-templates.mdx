...
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/checklists`;
...
api_url = f'https://api.tallyfy.com/organizations/{org_id}/checklists'
...
public class ListTemplates {
    ...
    public static void main(String[] args) {
        ...
        String apiUrl = "https://api.tallyfy.com/organizations/" + orgId + "/checklists"; // + queryParams;
...
func main() {
	...
	baseURL := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/checklists", orgId)
...
```json
{
  ...
  "meta": {
    "pagination": {
       ...
       "total_pages": 3,
       "links": {
           "next": "https://api.tallyfy.com/organizations/{org_id}/checklists?page=2"
       }
    }
  }
}

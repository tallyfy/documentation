---
about_tallyfy: true
description: Tallyfy's API lets you retrieve a paginated and filterable list of process
  templates (called "checklists" in the API) for your organization using a GET request
  with optional query parameters for searching by title and filtering by status or
  tags or owner along with code examples in JavaScript and Python and Java and Go
  and C++ and C#.

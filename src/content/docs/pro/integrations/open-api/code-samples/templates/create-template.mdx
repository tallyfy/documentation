...
description: Tallyfy's API lets you create a new process template by sending a POST
  ...
  along with optional settings like owner assignment, kick-off form fields,
  webhook URLs, and access controls. It returns the full template object with a 201
  status code.

...
description: Tallyfy's API lets you create a new process template by sending a POST
  ...
  along with optional settings like owner assignment and kick-off form fields and
  webhook URLs and access controls — returning the full template object with a 201
  status code.

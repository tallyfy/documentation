---
description: This endpoint enables the creation of new Tallyfy templates (blueprints)
  within an organization by sending a POST request with required title and optional
  configuration parameters like summary owner webhook settings permissions and kick-off
  form definitions across multiple programming languages.

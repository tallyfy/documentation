---
description: The Tallyfy API provides a POST endpoint for creating new process templates
  in organizations with customizable properties like title summary permissions and
  workflow configuration through JSON requests.

...
order: 2
sidebar: null
snippet: A comprehensive API endpoint for creating new templates within organizations
  allowing customization of various properties like title summary owner permissions

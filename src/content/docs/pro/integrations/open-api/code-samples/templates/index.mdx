...
<LinkTitleCard header="<b>Processes > Launch process</b>" href="/products/pro/integrations/open-api/code-samples/processes/launch-process/" > The endpoint launches process instances by sending a POST request with required checklist ID and name fields plus optional parameters like prerun data task overrides and role assignments. </LinkTitleCard>

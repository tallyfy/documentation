...
sidebar:
  order: 1
snippet: The GET endpoint enables retrieval of organization-specific tags with optional
  filtering parameters and returns tag details including ID title color and usage

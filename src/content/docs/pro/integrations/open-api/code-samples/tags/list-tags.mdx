---
about_tallyfy: true
description: The Tallyfy API endpoint GET /organizations/{org_id}/tags retrieves a
  paginated list of all tags in your organization with optional filtering by name
  and support for including usage statistics across templates and processes.
...
<LinkTitleCard header="<b>Groups > List groups</b>" href="/products/pro/integrations/open-api/code-samples/groups/list-groups/" > The Tallyfy API endpoint `GET /organizations/[org_id]/groups` returns a paginated list of groups... </LinkTitleCard>

---
about_tallyfy: true
description: Retrieve all tags in your organization with optional name filtering and
  pagination. You can also request usage statistics showing how many templates and
  processes each tag is associated with.

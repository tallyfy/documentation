...
<LinkTitleCard header="<b>Groups > List groups</b>" href="/products/pro/integrations/open-api/code-samples/groups/list-groups/" > Tallyfy's API lets you retrieve a paginated list of all groups in your organization via a GET... </LinkTitleCard>

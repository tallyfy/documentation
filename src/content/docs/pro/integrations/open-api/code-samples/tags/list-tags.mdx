...
<LinkTitleCard header="<b>Groups > List groups</b>" href="/products/pro/integrations/open-api/code-samples/groups/list-groups/" > Retrieve a paginated list of all groups in your Tallyfy organization. Filter by name, sort... </LinkTitleCard>

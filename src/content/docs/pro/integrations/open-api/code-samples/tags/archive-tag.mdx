---
description: This endpoint performs a soft delete on a tag by archiving it rather
  than permanently removing it from the system and returns the archived tag details
  with a deleted_at timestamp upon successful completion.
...
```json
{
  "data": {
    ...
    "deleted_at": "2025-05-21T21:00:00Z" // Timestamp indicates archival
  }
}
```

---
about_tallyfy: true
description: Modify an existing tag's title (up to 30 characters, unique per organization)
  or hex color code by sending a PUT request to `/organizations/{org_id}/tags/{tag_id}`.
  Includes code samples in JavaScript, Python, Java, Go, C++, and C#.

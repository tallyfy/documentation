---
description: The PUT endpoint allows modification of existing tag properties such
  as title and color by sending a JSON payload containing the updated values and returns
  the complete tag details with a 200 OK status upon successful update.

---
about_tallyfy: true
description: Tallyfy's API allows you to modify an existing tag's title or hex color
  within your organization by sending a PUT request with the tag ID and returns the
  updated tag data on success.

---
about_tallyfy: true
description: Tallyfy's API lets you retrieve a specific tag by its ID using a GET
  request to `/organizations/{org_id}/tags/{tag_id}` and optionally include usage
  statistics showing how many active or archived templates and processes use that
  tag.

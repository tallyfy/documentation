---
description: The GET endpoint retrieves a specific tag's details by its unique ID
  within an organization including properties like title color template associations
  and optional usage statistics through authenticated API requests.

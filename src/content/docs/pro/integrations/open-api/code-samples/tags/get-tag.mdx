---
about_tallyfy: true
description: Retrieve a specific tag by its ID using a GET request to `/organizations/{org_id}/tags/{tag_id}`. Optionally include usage statistics showing how many active or archived templates and processes use that tag.

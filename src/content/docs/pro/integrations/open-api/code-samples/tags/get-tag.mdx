---
about_tallyfy: true
description: Tallyfy's API allows you to retrieve a specific tag by its ID within
  your organization using a GET request and optionally include usage statistics showing
  how many active or archived templates and processes reference that tag.

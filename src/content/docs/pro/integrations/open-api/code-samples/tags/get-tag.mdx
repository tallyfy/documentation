...
const queryParams = '?with=statistics'; // Example
const apiUrl = `https://api.tallyfy.com/organizations/${orgId}/tags/${tagId}${queryParams}`;
...
public class GetTag {
    public static void main(String[] args) {
        ...
        String baseUrl = String.format("https://api.tallyfy.com/organizations/%s/tags/%s", orgId, tagId);
...
func main() {
    ...
    tagId := "TAG_ID_TO_GET"
    baseUrl := fmt.Sprintf("https://api.tallyfy.com/organizations/%s/tags/%s", orgId, tagId)

---
description: A POST endpoint allows creation of new organizational tags by submitting
  JSON data with title and optional color properties through authenticated requests
  that return the created tag's details including its unique identifier.

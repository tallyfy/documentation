...
sidebar:
  order: 2
snippet: A POST endpoint that creates organization tags with specified title and color
  properties through multiple programming language examples including JavaScript Python
  Java and Go.
title: Create tag
---

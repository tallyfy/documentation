---
description: This documentation explains how to create a new tag within an organization
  using a POST API endpoint by providing a required title and optional hex color code
  in the request body with code examples available in JavaScript Python Java Go C++
  and C#.

---
about_tallyfy: true
description: Tallyfy coordinates RPA tools like UiPath and Blue Prism with human operators.
  It manages automated and manual tasks in one workflow through its API, with handoffs,
  exception handling, and full process visibility in one place.

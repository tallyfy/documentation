---
description: Tallyfy connects RPA bots with human workflows through its API, so
  automated tasks and human judgment work together in a single, trackable process.

...
Password Grant: {
  shape: rectangle
  style.stroke-dash: 3
  App -> Auth: "1a. POST /oauth/token\ngrant_type=password\nclient_id, client_secret\nusername, password"
  Auth -> App: "2a. access_token + refresh_token\nexpires_in: 3600"
}

Client Credentials Grant: {
  shape: rectangle
  style.stroke-dash: 3
  App -> Auth: "1b. POST /oauth/token\ngrant_type=client_credentials\nclient_id, client_secret"
  Auth -> App: "2b. access_token (limited scope)\nexpires_in: 3600"
}

App -> API: "3. API Request\nAuthorization: Bearer {token}\nX-Tallyfy-Client: APIClient"

# Token Validation Flow
Token Valid: {
  shape: rectangle
  style.stroke-dash: 3
  API -> App: "4a. 200 OK + Response Data"
}

Token Expired: {
  shape: rectangle
  style.stroke-dash: 3
  API -> App: "4b. 401 Unauthenticated"
  App -> Auth: "5b. POST /oauth/token\ngrant_type=refresh_token\nrefresh_token={token}"
  Auth -> App: "6b. New access_token"
  App -> API: "7b. Retry with new token"
  API -> App: "8b. 200 OK + Response Data"
}
```

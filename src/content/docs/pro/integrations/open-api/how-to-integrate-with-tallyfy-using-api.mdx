...
sidebar:
  order: 1
snippet: The Tallyfy REST API enables workflow integration through user-based or application-based
  authentication methods while supporting multi-organization contexts and providing

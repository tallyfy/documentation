---
about_tallyfy: true
description: Tallyfy's REST API allows developers to connect workflow features to
  external applications using OAuth 2.0 authentication with required Bearer tokens
  and a mandatory X-Tallyfy-Client header while supporting both user-based and application-based
  access patterns along with token refresh flows and organization-scoped requests.

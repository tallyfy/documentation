...
<LinkTitleCard header="<b>Open Api > Third-party application API access</b>" href="/products/pro/integrations/open-api/access-api-as-a-third-party-application-instead-of-a-user/" > Third-party applications can access Tallyfy's API on behalf of users through an OAuth 2.0 client... </LinkTitleCard>

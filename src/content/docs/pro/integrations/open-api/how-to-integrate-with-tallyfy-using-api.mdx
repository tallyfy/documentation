...
description: Tallyfy provides a REST API for integrating workflow functionality into
  external applications with authentication options including user-based tokens and
  OAuth client credentials requiring specific headers and proper token management
  for stable integrations across multiple organizations.

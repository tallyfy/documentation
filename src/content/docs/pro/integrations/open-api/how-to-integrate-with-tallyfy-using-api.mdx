...
sidebar:
  order: 1
snippet: The Tallyfy REST API enables workflow automation through multiple authentication
  methods including user-based and application-based tokens while providing programmatic
  access to process management tasks and user administration features.
...
<LinkTitleCard header="<b>Open Api > Sniff API calls using Chrome</b>" href="/products/pro/integrations/open-api/how-to-sniff-api-calls-using-chrome/" > Chrome DevTools enables monitoring of Tallyfy API communications by capturing network requests and analyzing headers payloads and responses to help developers effectively implement platform integrations. </LinkTitleCard>
</CardGrid>
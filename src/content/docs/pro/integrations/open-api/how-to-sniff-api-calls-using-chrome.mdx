---
about_tallyfy: true
description: Chrome DevTools lets you inspect every API call Tallyfy makes by filtering
  network requests in the Fetch/XHR panel and then copying endpoints and headers and
  JSON payloads to replicate those exact calls in your own integrations using tools

---
description: Chrome DevTools can be used to monitor and analyze Tallyfy's API-first
  architecture by capturing network requests filtering for API calls and examining
  request headers payloads and responses to understand how to implement custom integrations
  with the platform.

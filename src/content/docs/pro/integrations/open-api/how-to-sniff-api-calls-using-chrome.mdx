---
about_tallyfy: true
description: Chrome DevTools lets you inspect every API call Tallyfy makes. Filter
  network requests in the Fetch/XHR panel, then copy endpoints, headers, and JSON
  payloads to replicate those calls in your own integrations with cURL or Postman.

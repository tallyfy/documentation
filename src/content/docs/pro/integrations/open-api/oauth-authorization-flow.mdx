---
about_tallyfy: true
description: Tallyfy supports OAuth 2.0 implicit grant authentication for third-party
  apps where users log in on Tallyfy's domain and receive a 6-month access token via
  the URL fragment so your app never handles their credentials directly.

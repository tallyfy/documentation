...
sidebar:
  order: 10
snippet: A comprehensive guide detailing the steps to implement OAuth authorization
  flow for third-party applications to securely authenticate users with Tallyfy through
  client IDs redirect URIs and access tokens while following security best practices.

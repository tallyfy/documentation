...
sidebar:
  order: 10
snippet: Tallyfy's OAuth authorization flow enables third-party applications to obtain access tokens through user authentication, supporting secure API integration without directly handling user credentials.

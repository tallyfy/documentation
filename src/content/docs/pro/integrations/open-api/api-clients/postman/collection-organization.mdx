---
about_tallyfy: true
description: Organizing Postman collections for the Tallyfy API around resource types
  like templates and processes and tasks with bracket prefixes and consistent naming
  conventions and reusable pre-request scripts and proper documentation and version
  control practices helps teams reduce errors and speed up integration work significantly.
...
<LinkTitleCard header="<b>Postman > Advanced patterns and testing</b>" href="/products/pro/integrations/open-api/api-clients/postman/advanced-patterns/" > Postman's collection runners and Newman CLI enable you to move from manual Tallyfy API testing... </LinkTitleCard>

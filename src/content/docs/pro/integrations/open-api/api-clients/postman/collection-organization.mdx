...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Postman > Troubleshooting common issues</b>" href="/products/pro/integrations/open-api/api-clients/postman/troubleshooting/" > Most Tallyfy API failures in Postman stem from three issues: a missing `X-Tallyfy-Client` header... </LinkTitleCard>
...
<LinkTitleCard header="<b>Postman > Advanced patterns and testing</b>" href="/products/pro/integrations/open-api/api-clients/postman/advanced-patterns/" > Postman's collection runners and Newman CLI enable teams to move from manual Tallyfy API testing... </LinkTitleCard>

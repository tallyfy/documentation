...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Open Api > API clients</b>" href="/products/pro/integrations/open-api/api-clients/" > Tallyfy's REST API is compatible with any HTTP client and offers guides for tools like Postman... </LinkTitleCard>
<LinkTitleCard header="<b>Postman > Authentication setup for Postman</b>" href="/products/pro/integrations/open-api/api-clients/postman/authentication-setup/" > Tallyfy's API authentication in Postman requires setting up OAuth 2.0 with the password grant... </LinkTitleCard>

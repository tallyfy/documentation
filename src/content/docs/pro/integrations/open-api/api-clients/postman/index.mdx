---
about_tallyfy: true
description: Test Tallyfy's REST API in Postman without writing code. Authenticate
  with the password grant type, then explore endpoints for templates (checklists),
  processes (runs), and tasks across your organization.

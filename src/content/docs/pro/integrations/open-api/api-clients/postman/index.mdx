...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Open Api > API clients</b>" href="/products/pro/integrations/open-api/api-clients/" > Tallyfy's REST API works with any HTTP client. Find guides for tools like Postman to visually... </LinkTitleCard>

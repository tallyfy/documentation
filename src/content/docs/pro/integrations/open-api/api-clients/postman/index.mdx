---
about_tallyfy: true
description: Postman provides a code-free way to authenticate with Tallyfy's REST
  API using OAuth 2.0 password grant and test common operations like launching processes
  from templates and completing tasks while learning that the API refers to templates
  as "checklists" and processes as "runs."
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Open Api > API clients</b>" href="/products/pro/integrations/open-api/api-clients/" > Tallyfy's REST API is compatible with any HTTP client and offers a Postman guide that walks you... </LinkTitleCard>
<LinkTitleCard header="<b>Postman > Troubleshooting common issues</b>" href="/products/pro/integrations/open-api/api-clients/postman/troubleshooting/" > Most Tallyfy API errors in Postman stem from a missing `X-Tallyfy-Client` header or wrong grant... </LinkTitleCard>
...
<LinkTitleCard header="<b>Postman > Authentication setup for Postman</b>" href="/products/pro/integrations/open-api/api-clients/postman/authentication-setup/" > Tallyfy's API authentication in Postman requires setting up OAuth 2.0 with a password grant type... </LinkTitleCard>
</CardGrid>
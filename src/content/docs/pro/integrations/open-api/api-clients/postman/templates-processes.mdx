...
description: Tallyfy's API lets you launch processes from templates by posting to
  the runs endpoint with a checklist ID and optional kick-off form data. It also
  supports dynamic template selection and bulk launching through Postman scripts.

---
description: Tallyfy's API enables launching processes from templates by using template
  IDs with kick-off form data and member assignments while supporting dynamic template
  selection based on business rules bulk launching with rate limiting and comprehensive

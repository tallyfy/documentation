...
description: Tallyfy's API lets you launch processes from templates by posting to
  the runs endpoint with a checklist ID and optional kick-off form data while also
  supporting advanced patterns like dynamic template selection and bulk launching
  through Postman scripts.

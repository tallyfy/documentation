...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Postman > Authentication setup for Postman</b>" href="/products/pro/integrations/open-api/api-clients/postman/authentication-setup/" > Tallyfy's API authentication requires OAuth setup with client credentials and password grant type for user-context endpoints with mandatory X-Tallyfy-Client headers and 1-hour token expiration requiring automatic refresh mechanisms for successful Postman testing. </LinkTitleCard>

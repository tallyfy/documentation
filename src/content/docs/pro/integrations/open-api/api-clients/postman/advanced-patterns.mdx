---
about_tallyfy: true
description: Postman's collection runners and Newman CLI enable you to move from manual
  Tallyfy API testing to fully automated workflow validation across multiple organizations
  with scheduled monitors and CI/CD pipeline integration through GitHub Actions.

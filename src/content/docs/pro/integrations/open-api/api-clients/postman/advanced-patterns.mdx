---
about_tallyfy: true
description: Postman's collection runners and Newman CLI enable teams to move from
  manual Tallyfy API testing to fully automated workflow validation across multiple
  organizations with features like environment switching scripts and data-driven test
  runs that plug directly into CI/CD pipelines through GitHub Actions while also supporting
  performance monitoring and Slack alerting for stuck processes or degraded response
  times.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Postman > Collection organization best practices</b>" href="/products/pro/integrations/open-api/api-clients/postman/collection-organization/" > Organizing your Postman collections around Tallyfy's API resources with clear folder prefixes and consistent naming conventions for requests and variables eliminates confusion and accelerates integration development across teams. </LinkTitleCard>
...
<LinkTitleCard header="<b>Postman > Troubleshooting common issues</b>" href="/products/pro/integrations/open-api/api-clients/postman/troubleshooting/" > Most Tallyfy API failures in Postman stem from three issues: a missing `X-Tallyfy-Client` header and wrong grant type or expired tokens and this guide covers how to diagnose and fix every common error including 401 authentication problems and 404 path mistakes and 422 validation failures and rate limiting and file upload issues along with ready-to-use debugging scripts for your Postman collection. </LinkTitleCard>

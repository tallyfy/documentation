---
about_tallyfy: true
description: Tallyfy's API allows you to list and filter tasks by status or assignee
  and complete them via a POST to the completed-tasks endpoint while also supporting
  form field saves and file uploads and task reassignment and commenting and bulk
  operations through Postman.

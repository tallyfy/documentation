---
about_tallyfy: true
description: Tallyfy's API lets you list and filter tasks by status or assignee and
  complete them via a POST to the completed-tasks endpoint while saving form field
  captures separately and handling file uploads through multipart form-data and managing
  task assignments and comments programmatically through Postman.

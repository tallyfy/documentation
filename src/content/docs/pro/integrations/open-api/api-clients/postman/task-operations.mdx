...
- [Set up monitoring](../advanced-patterns/#performance-monitoring)
- [Integrate with CI/CD](../advanced-patterns/#cicd-integration)

import { CardGrid, LinkTitleCard } from "~/components";

## Related articles
<CardGrid>
<LinkTitleCard header="<b>Tasks > Complete or reopen tasks</b>" href="/products/pro/tracking-and-tasks/tasks/how-can-i-complete-or-reopen-tasks-in-tallyfy/" > Complete Tallyfy tasks by clicking the Complete button after filling required form fields then reopen completed tasks when needed by clicking Reopen which maintains the full task history and allows updates to previously entered information. </LinkTitleCard>
<LinkTitleCard header="<b>Tasks > Form fields explained</b>" href="/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/" > Form fields in Tallyfy collect structured data within tasks using 13 different field types including text short answer paragraph numbers dates files tables and more enabling standardized information capture validation rules conditional logic and seamless data flow throughout workflows. </LinkTitleCard>
<LinkTitleCard header="<b>API Code Samples > Complete a task</b>" href="/products/pro/integrations/open-api/code-samples/tasks/complete-task/" > Complete tasks via Tallyfy API by sending a PUT request to the task endpoint with optional form field data enabling programmatic task completion and workflow progression from external systems. </LinkTitleCard>
</CardGrid>
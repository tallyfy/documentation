---
about_tallyfy: true
description: Install the Google Gemini CLI via npm and sign into your Google account
  so Tallyfy Desktop can drive it. The Install Wizard handles npm with explicit consent,
  and the default model is `gemini-2.5-flash` to avoid subscription quota friction.
id: e27346ccae57ab688c1c95340b1814d2
sidebar:

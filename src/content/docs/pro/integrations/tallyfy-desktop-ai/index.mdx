---
about_tallyfy: true
description: Tallyfy Desktop v2.0.0 is a multi-tab AI-first app that pairs four AI
  assistants (Claude, Codex, Gemini, Ollama) with your Tallyfy workspace. Every AI
  run becomes a tracked task, the Tallyfy MCP server is auto-injected, and an inline
  widget turns chat into Tallyfy work.
id: 059cbdef21d5e58fdfedad381da98585
...
Everything else in the app, from MCP injection to task wrapping to the intent widget, needs your Tallyfy identity. Without it, the AI doesn't know who you are, what org you're in, or where to put the tasks it creates.
...
<LinkTitleCard header="<b>Tallyfy Desktop Ai > Task Intent Widget</b>" href="/products/pro/integrations/tallyfy-desktop-ai/task-intent-widget/" > The Task Intent Widget turns AI chat into Tallyfy work with one click. As you talk to Claude... </LinkTitleCard>

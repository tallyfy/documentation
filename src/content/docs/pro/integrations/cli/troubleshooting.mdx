...
<LinkTitleCard header="<b>Cli > Authenticate the CLI</b>" href="/products/pro/integrations/cli/authentication/" > How the CLI resolves credentials, and why application tokens keep unattended automation stable. </LinkTitleCard>
<LinkTitleCard header="<b>Cli > Configuration and permissions</b>" href="/products/pro/integrations/cli/configuration-and-permissions/" > Six settings scopes, permission rules, hooks, workspace trust, and the doctor command that checks them all. </LinkTitleCard>
<LinkTitleCard header="<b>Integrations > Open API</b>" href="/products/pro/integrations/open-api/" > The REST API behind every CLI command, including the rate limits that bulk jobs need to respect. </LinkTitleCard>
</CardGrid>
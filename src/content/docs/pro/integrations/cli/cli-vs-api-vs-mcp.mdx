---
about_tallyfy: true
description: Tallyfy gives you four ways to get work done. People click in the web app, your own software calls the REST API, AI assistants connect through the MCP server, and scripts drive the CLI. This guide explains what each surface does best and which one fits the job in front of you.

---
about_tallyfy: true
description: Tallyfy CLI commands follow one resource-plus-verb pattern with aliases
  matching both UI and API vocabulary. Choose table, JSON, CSV, or NDJSON output,
  save repeatable commands for your team, and call any API endpoint directly when
  you need to.
id: 0a8244f51a6b7fbc6efefe87df8b3185
sidebar:
  order: 2

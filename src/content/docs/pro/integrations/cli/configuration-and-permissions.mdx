...
<LinkTitleCard header="<b>Cli > CI/CD approval gates</b>" href="/products/pro/integrations/cli/ci-cd-approval-gates/" > Headless rules and a read-only permission profile for pipelines that watch but never touch. </LinkTitleCard>
...
<LinkTitleCard header="<b>Cli > Command reference</b>" href="/products/pro/integrations/cli/command-reference/" > Every resource and verb the Tallyfy CLI supports, plus the global flags that work everywhere. </LinkTitleCard>
</CardGrid>
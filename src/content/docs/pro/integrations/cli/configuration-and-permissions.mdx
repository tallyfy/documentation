---
about_tallyfy: true
description: Tallyfy CLI settings merge across six scopes, from built-in defaults to company-managed policy. Permission rules decide which commands run, ask, or get blocked, workspace trust keeps cloned repositories from running hooks, and one doctor command checks it all.

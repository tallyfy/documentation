---
about_tallyfy: true
description: Tallyfy CLI authentication takes one paste of a personal access token,
  stored safely in your computer's keychain. Scripts and CI jobs authenticate with
  an environment variable instead, and application tokens keep long-running automation
  stable.
id: 3998cbd71df5cf43f788e9fc7c6bff2e
sidebar:
  order: 1

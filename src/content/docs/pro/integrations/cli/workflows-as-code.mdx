...
<LinkTitleCard header="<b>Templates > Print or export templates</b>" href="/products/pro/documenting/templates/print-download-export-templates/" > Tallyfy lets you output templates three ways: printing to paper via the toolbar's Print option... </LinkTitleCard>

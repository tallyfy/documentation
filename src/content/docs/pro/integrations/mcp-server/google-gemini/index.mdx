---
about_tallyfy: true
description: Google Gemini connects to Tallyfy's MCP server through OAuth 2.1 authentication
  and streamable HTTP transport allowing users to manage workflow tasks and processes
  and analyze templates using natural language via the Gemini CLI or Google Cloud's
  managed MCP infrastructure for enterprise deployments.

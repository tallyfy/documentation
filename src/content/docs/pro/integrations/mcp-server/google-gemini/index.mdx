---
about_tallyfy: true
description: Google Gemini connects to Tallyfy's MCP server using OAuth 2.1 and streamable
  HTTP transport so you can manage workflows and analyze processes through natural
  language via the Gemini CLI or Google Cloud's managed MCP infrastructure while combining
  Tallyfy data with services like BigQuery and Vertex AI agents.

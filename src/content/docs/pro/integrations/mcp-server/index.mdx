...
- **[Claude Desktop (Anthropic)](/products/pro/integrations/mcp-server/claude-anthropic/)** - Remote MCP support for Pro, Max, Team, and Enterprise plans (not Free), Desktop Extensions, remote OAuth

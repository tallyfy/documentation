...
Add [form fields](/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/) to steps, update properties, move fields between steps, delete fields, get AI suggestions for useful fields, and manage dropdown options.

**Kickoff fields**

Get recommendations for process launch form fields, view existing kickoff fields, complete or reopen the kickoff form on a process.

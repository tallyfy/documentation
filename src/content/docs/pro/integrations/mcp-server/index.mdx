...
The server exposes 113 tools across 15 capability areas, all callable from any MCP-compatible AI:
...
Add [form fields](/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/) to steps, update properties, move fields between steps, delete fields, reorder fields within a step, get AI suggestions for useful fields, and manage dropdown options.

**Kickoff field management**

Add, update, and delete kickoff (pre-run) fields on templates. View existing kickoff fields, get AI recommendations for process launch form fields, and complete or reopen the kickoff form on a running process.

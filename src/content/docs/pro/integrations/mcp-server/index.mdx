...
The MCP Server exposes 108 tools that connect AI assistants (Claude, ChatGPT, Gemini, Copilot, and others) directly to your Tallyfy organization. Connect with OAuth 2.1 authentication or an API token, and you can:
...
![Claude creating a 7-step Business Trip Request template in Tallyfy with 5 automation rules matching a BPMN diagram](https://screenshots.tallyfy.com/tallyfy/pro/mcp-claude-template-creation.png)
...
<LinkTitleCard header="<b>Mcp Server > Tallyfy MCP server with Google Gemini</b>" href="/products/pro/integrations/mcp-server/google-gemini/" > Connect Tallyfy's MCP server to Gemini CLI, Gemini Code Assist, and Gemini Enterprise. Run OAuth... </LinkTitleCard>
</CardGrid>
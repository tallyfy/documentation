---
about_tallyfy: true
description: Claude Desktop provides the most mature MCP client experience for connecting
  to Tallyfy's API through natural language and this guide covers setup via manual
  JSON configuration or one-click Desktop Extensions along with practical workflow
  examples like task management and process analysis and hybrid automation combining

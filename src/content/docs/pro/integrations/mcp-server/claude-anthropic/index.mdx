---
about_tallyfy: true
description: "Claude Desktop connects to Tallyfy's MCP server for natural language workflow
  management. Set up via Desktop Extensions or manual JSON config, then query tasks,
  analyze processes, and combine with Computer Use for visual automation."

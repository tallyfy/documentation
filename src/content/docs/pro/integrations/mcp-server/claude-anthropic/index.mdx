...
### Template creation from a flowchart

A user dropped a flowchart into Claude and asked for a matching template. Claude used `create_template`, `add_step_to_template`, and `create_automation_rule` to build a 7-step Business Trip Request with 5 if-then rules - approval gates, parallel notification, conditional show/hide on rejection.

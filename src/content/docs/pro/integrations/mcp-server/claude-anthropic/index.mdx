---
description: Claude Desktop serves as the premier platform for integrating Tallyfy's
  MCP server with AI-powered workflow management through native Model Context Protocol
  support that enables natural language task automation process analysis and intelligent
  workflow orchestration while combining seamlessly with Claude Computer Use for comprehensive
...
4. **Implement the server script**
   ...
   const TALLYFY_API_URL = 'https://api.tallyfy.com/v1';
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>MCP Server</b>" href="/products/pro/integrations/mcp-server/" > Tallyfy's MCP Server enables natural language interaction with workflows through AI assistants by providing tools for searching tasks and processes managing users and templates analyzing workflow health and creating automation rules without requiring API knowledge. </LinkTitleCard>
<LinkTitleCard header="<b>Claude Computer Use</b>" href="/products/pro/integrations/computer-ai-agents/vendors/claude-computer-use/" > Anthropic's Claude can interact with computer desktop environments through API-driven tools to automate UI-based tasks by perceiving screens and executing actions like mouse clicks typing and keyboard shortcuts in a sandboxed environment. </LinkTitleCard>
<LinkTitleCard header="<b>Computer AI Agents</b>" href="/products/pro/integrations/computer-ai-agents/" > Computer AI agents represent the evolution from manual RPA to intelligent systems that can autonomously navigate interfaces understand context make decisions and complete complex tasks through natural interaction with software applications. </LinkTitleCard>
<LinkTitleCard header="<b>API Integration Guide</b>" href="/products/pro/integrations/open-api/how-to-integrate-with-tallyfy-using-api/" > Learn how to integrate with Tallyfy's REST API to automate workflows manage processes handle authentication implement error handling track tasks and leverage webhooks for building powerful workflow automation solutions. </LinkTitleCard>
<LinkTitleCard header="<b>Using Tallyfy MCP Server with ChatGPT</b>" href="/products/pro/integrations/mcp-server/openai-chatgpt/" > Connect Tallyfy's MCP Server with ChatGPT to enable natural language workflow management through OpenAI's Deep Research feature using Model Context Protocol for secure AI-powered task automation and process management. </LinkTitleCard>
</CardGrid>
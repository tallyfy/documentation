---
description: Connect Tallyfy's MCP Server with Claude Desktop to enable natural language workflow management through Anthropic's native Model Context Protocol support for secure AI-powered task automation and direct file system integration

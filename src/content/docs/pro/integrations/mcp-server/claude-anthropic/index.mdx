...
description: Claude Desktop provides native MCP integration that lets you connect
  to Tallyfy's API through a locally running server script so you can search tasks
  and manage workflows using natural language chat while also combining with other
  MCP servers like GitHub and Slack for multi-step automation.

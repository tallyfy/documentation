---
about_tallyfy: true
description: Connect Claude to Tallyfy's hosted MCP server to manage workflows in plain
  language. Add it as a custom connector in Claude.ai or Claude Desktop, sign in with
  OAuth, then query tasks, analyze processes, and combine with Computer Use for visual automation.

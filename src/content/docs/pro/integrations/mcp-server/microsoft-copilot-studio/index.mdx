---
about_tallyfy: true
description: Microsoft Copilot Studio can connect to Tallyfy's hosted MCP server at
  mcp.tallyfy.com through a custom Power Platform connector to enable enterprise-grade
  workflow automation with features like multi-agent coordination and VNet security
  and DLP policy enforcement across your organization's processes and tasks.
...
<LinkTitleCard header="<b>Byo Ai > Microsoft Copilot integration</b>" href="/products/pro/integrations/byo-ai/microsoft-copilot-integration/" > Microsoft 365 Copilot integrates with Tallyfy through API plugins and Azure AD OAuth2 to bring... </LinkTitleCard>
</CardGrid>
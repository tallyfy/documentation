...
# Links (represented as tooltips)
HR1.tooltip: Task management - /products/pro/tracking-and-tasks/tasks/index/
Monitor.tooltip: Process tracking - /products/pro/tracking-and-tasks/tracker-view/index/
```
...
# Links (represented as tooltips)
API.tooltip: API documentation - /products/pro/integrations/open-api/index/
Copilot.tooltip: Setup prerequisites - #prerequisites
```

...
description: Microsoft Copilot Studio connects to Tallyfy's hosted MCP server through
  Power Platform custom connectors and OpenAPI specifications to enable enterprise-grade
  AI agents that automate workflows and manage processes using natural language within
  your existing Microsoft security and governance infrastructure.

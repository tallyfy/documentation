...
Here's the current state of MCP support in Copilot Studio (public preview as of November 2025):

- **Public preview**: MCP server support now in public preview across Copilot Studio
...
- **General availability**: MCP support moving from public preview to GA

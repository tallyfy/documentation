---
description: SSO integration with MCP servers lets users authenticate once with their
  corporate identity provider and access multiple AI workflow tools through OAuth 2.1
  flows - delegating authentication to providers like Microsoft Entra ID, Okta and
  Google Workspace while reducing consent fatigue and improving token visibility.

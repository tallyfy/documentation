...
description: SSO integration with MCP servers eliminates repeated authentication across
  ...
  AD or Okta so users authenticate once with corporate credentials and MCP servers
  handle token exchange automatically to access approved workflow APIs on their behalf.
...
<LinkTitleCard header="<b>Mcp Server > Using Tallyfy MCP server with Microsoft Copilot Studio</b>" href="/products/pro/integrations/mcp-server/microsoft-copilot-studio/" > Microsoft Copilot Studio can connect to Tallyfy's hosted MCP server at mcp.tallyfy.com through a... </LinkTitleCard>

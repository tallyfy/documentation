...
<LinkTitleCard header="<b>Byo Ai > ChatGPT integration</b>" href="/products/pro/integrations/byo-ai/chatgpt-integration/" > ChatGPT Plus or Team subscribers can connect their accounts to Tallyfy through OAuth2 authentication and GPT Actions to automatically read task data process information according to custom instructions and complete workflow tasks without writing code or managing API keys. </LinkTitleCard>

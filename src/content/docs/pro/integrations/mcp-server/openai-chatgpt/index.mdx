...
description: ChatGPT Enterprise and Team users can connect to Tallyfy's MCP server
  to manage workflows through natural language prompts and OAuth 2.1 authentication
  while being aware that text-based chat has real limitations around visual tracking
  and form interactions and bulk operations that Tallyfy's own UI handles much better.

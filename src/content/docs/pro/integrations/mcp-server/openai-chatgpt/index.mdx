...
- **Access method**: Through Developer Mode and Deep Research connectors (now called "apps")
...
**Note:** Developer Mode must be enabled in ChatGPT settings to use MCP servers in regular conversations.
...
1. **Deep Research is read-only**: Use Developer Mode for write operations

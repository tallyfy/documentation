...
Every extracted task will include the actual quote from the meeting and the AI's reasoning for flagging it as actionable.
...
Draft tasks would work like a moderation queue - all extracted tasks appear grouped together for review. You'd edit assignments, adjust deadlines, delete non-actionable items, and convert good ones to active tasks.

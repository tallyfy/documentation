---
about_tallyfy: true
description: Tallyfy is building a feature to transcribe meetings and extract action
  items as draft tasks with assignee mapping via SSO. Until it launches, you can build
  your own pipeline using Tallyfy's API with tools like OpenAI Whisper and GPT-4.

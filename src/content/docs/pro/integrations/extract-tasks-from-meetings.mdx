...
Start: Meeting Recording {shape: rectangle}
Transcribe: AI Transcription {shape: rectangle}
Extract: Task Extraction {shape: rectangle}
Draft: Draft Tasks {shape: rectangle}
Review: Human Review {shape: diamond}
Convert: Convert to Open {shape: rectangle}
Edit: Modify Details {shape: rectangle}
Delete: Delete Task {shape: rectangle}
Track: Active Task {shape: rectangle}

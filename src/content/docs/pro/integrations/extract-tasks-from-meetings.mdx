---
about_tallyfy: true
description: Tallyfy is developing an AI-powered feature that will automatically transcribe
  meeting recordings and extract action items as draft tasks with full context and
  assignee mapping through SSO — and until it launches you can build your own pipeline
  using Tallyfy's API along with transcription and language model tools to capture
  and create tasks programmatically.

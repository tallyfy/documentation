...
sidebar:
  order: 145
description: Tallyfy's upcoming meeting-to-tasks feature will automatically transcribe meeting recordings and extract actionable tasks using AI, creating draft tasks that can be reviewed, edited, and converted into trackable work items with proper assignment and context.
title: Extract tasks
---
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Processes > Launch process without template</b>" href="/products/pro/integrations/open-api/code-samples/processes/launch-process-without-template/" > Create processes in Tallyfy without predefined templates using the API to generate dynamic collections of tasks tracked together. </LinkTitleCard>
<LinkTitleCard header="<b>Tasks > What are tasks</b>" href="/products/pro/tracking-and-tasks/tasks/" > Tasks are the individual units of work within processes that get assigned, tracked, and completed. </LinkTitleCard>
<LinkTitleCard header="<b>API > Getting started</b>" href="/products/pro/integrations/open-api/" > Connect to Tallyfy's API to create custom integrations and automate your workflow management. </LinkTitleCard>
</CardGrid>
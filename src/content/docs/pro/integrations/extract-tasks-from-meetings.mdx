---
about_tallyfy: true
description: Tallyfy is building an AI-powered integration that will automatically
  transcribe meeting recordings from platforms like Zoom and Teams and extract action
  items with full context and assignee mapping into draft tasks for human review —
  and in the meantime developers can build their own meeting-to-task pipeline using
  Tallyfy's API with transcription and AI extraction tools.

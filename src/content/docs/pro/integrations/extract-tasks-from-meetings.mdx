---
description: Tallyfy is developing an AI-powered feature that will automatically convert
  meeting recordings from platforms like Zoom and Teams into trackable tasks by transcribing
  conversations extracting action items identifying assignees and creating draft tasks
  for human review before they become active workflow items.

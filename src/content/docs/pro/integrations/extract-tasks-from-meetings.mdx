---
about_tallyfy: true
description: Tallyfy is building a feature that will automatically transcribe meeting
  recordings and extract action items as draft tasks with full context and assignee
  mapping via SSO — and until that launches you can build your own pipeline today
  using Tallyfy's API with tools like OpenAI Whisper and GPT-4 to capture recordings
  and create tracked tasks with proper deadlines and ownership.

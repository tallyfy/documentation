---
description: Tallyfy integrates with UKG Pro to transform workforce management data
  into automated workflows that handle complex scheduling compliance tracking approvals
  notifications coverage arrangements and payroll adjustments triggered by time punches
  schedule changes and employee leave requests.
id: c506be4d57fbd5897edc4397a716ba85
sidebar:
  order: 10
template: doc
title: UKG Pro Integration
---

---
about_tallyfy: false
description: Tallyfy connects to Workday through its Integration Cloud XML platform
  or REST API to automatically launch structured onboarding and HR workflows when
  events like new hires occur by mapping Workday worker fields to Tallyfy process
  variables.

---
description: Tallyfy is building enterprise integration with Workday to automatically
  transform HCM and financial data into intelligent workflows that orchestrate downstream
  processes like IT provisioning budget approvals and compliance tracking without
  manual intervention for Fortune 500 companies.

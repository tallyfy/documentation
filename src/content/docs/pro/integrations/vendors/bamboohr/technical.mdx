---
about_tallyfy: false
description: BambooHR integrates with Tallyfy through REST API calls and SHA-256 HMAC
  webhook verification to automatically pull employee data and launch structured processes
  like onboarding or role changes based on HR events such as new hires and status
  updates.

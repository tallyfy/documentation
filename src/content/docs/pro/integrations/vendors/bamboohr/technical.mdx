---
about_tallyfy: false
description: Technical details for connecting BambooHR with Tallyfy - REST API examples,
  webhook signatures, data mapping, and authentication for HR workflows.

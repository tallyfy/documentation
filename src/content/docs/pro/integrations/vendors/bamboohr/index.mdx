...
description: Connect BambooHR with Tallyfy to automatically sync employee data, departments, and roles for streamlined HR workflow automation. Real-time updates via webhooks and API.
template: doc
sidebar:
  order: 1
---

---
description: Tallyfy integrates with Microsoft Teams to transform it from a communication
  tool into a workflow engine where teams can trigger processes from messages complete
  tasks in channels and track progress without switching apps.

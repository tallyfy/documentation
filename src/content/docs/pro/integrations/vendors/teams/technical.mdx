---
about_tallyfy: false
description: Microsoft Teams can connect to Tallyfy through Graph API and Adaptive
  Cards and Power Automate or incoming webhooks to send task notifications and launch
  workflows and complete tasks directly from Teams channels using Azure AD authentication.

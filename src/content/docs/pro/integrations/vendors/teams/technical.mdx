---
about_tallyfy: false
description: Connect Tallyfy with Microsoft Teams using Graph API, Adaptive Cards,
  Power Automate, incoming webhooks, or custom Bot Framework bots. Push task notifications
  and workflow updates directly into Teams channels.

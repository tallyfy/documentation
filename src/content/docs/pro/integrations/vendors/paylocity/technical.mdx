---
about_tallyfy: false
description: Paylocity integrates with Tallyfy through REST APIs and webhooks using
  OAuth 2.0 authentication to automatically launch structured workflow processes like
  onboarding or offboarding when employee events occur in the payroll system and maps
  Paylocity employee fields directly to Tallyfy kick-off form variables.

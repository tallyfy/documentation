---
about_tallyfy: false
description: Paylocity can be integrated with Tallyfy through REST APIs or webhooks
  to automatically launch structured workflow processes like onboarding and offboarding
  when employee events occur in Paylocity and the integration uses OAuth 2.0 authentication
  with field mapping between Paylocity employee data and Tallyfy kick-off form variables.

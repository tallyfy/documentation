---
about_tallyfy: false
description: Technical details for connecting Paylocity with Tallyfy - REST API examples,
  webhook handling, data mapping, and authentication for HR workflows.

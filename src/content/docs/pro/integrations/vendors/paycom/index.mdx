...
title: Paycom integration with Tallyfy
description: Learn about our plans to integrate with Paycom for seamless HR and payroll workflow automation
sidebar:
  order: 1
...
<CardGrid>
  <LinkTitleCard
    href="/pro/integrations/open-api"
    title="Tallyfy API documentation"
    description="Complete guide to using our API for custom integrations"
  />
  <LinkTitleCard
    href="/pro/integrations/middleware/zapier"
    title="Connect through Zapier"
    description="Step-by-step Zapier integration guide"
  />
  <LinkTitleCard
    href="/pro/integrations/middleware/power-automate"
    title="Microsoft Power Automate"
    description="Integrate using Power Automate flows"
  />
  <LinkTitleCard
    href="/pro/auth/sso"
    title="Single sign-on setup"
    description="Configure SSO for seamless authentication"
  />
</CardGrid>
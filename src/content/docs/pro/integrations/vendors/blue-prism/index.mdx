---
about_tallyfy: false
description: Tallyfy bridges the gap between Blue Prism's bot automation and human
  workflows by coordinating handoffs and exception handling and governance across
  both digital and human workers in a single unified process.

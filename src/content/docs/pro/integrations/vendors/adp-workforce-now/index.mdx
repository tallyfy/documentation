---
description: This content discusses integrating ADP Workforce Now with Tallyfy to
  transform HR data into automated workflows that orchestrate complex processes across
  departments for mid-size companies.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Vendors > ADP Run Integration</b>" href="/products/pro/integrations/vendors/adp-run/" > This content explains how integrating ADP Run payroll software with Tallyfy workflow automation transforms small business operations by automatically orchestrating onboarding tax compliance and administrative processes whenever payroll data changes. </LinkTitleCard>

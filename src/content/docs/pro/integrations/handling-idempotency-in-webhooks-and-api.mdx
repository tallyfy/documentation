---
about_tallyfy: true
description: Idempotency ensures your Tallyfy integration safely handles duplicate
  webhook events and API retries without creating duplicate records or repeated actions
  by using unique payload identifiers and deduplication tables to detect and skip

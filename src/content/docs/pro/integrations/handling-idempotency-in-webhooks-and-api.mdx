---
about_tallyfy: true
description: Idempotency ensures that duplicate webhook events or retried API requests
  from Tallyfy don't cause problems like double records or repeated emails. Handle
  retries safely with deduplication tables, unique event keys, and conditional updates.

...
description: Complete reference showing the exact JSON structure and all data elements included in Tallyfy webhook payloads for both process-level and task-level webhooks with real examples from the API codebase.

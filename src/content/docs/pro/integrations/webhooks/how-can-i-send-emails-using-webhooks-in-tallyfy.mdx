---
about_tallyfy: true
description: Connect Tallyfy webhooks to middleware tools like Zapier or Make to automatically
  send custom emails with full process context when workflow events like task completions
  happen.

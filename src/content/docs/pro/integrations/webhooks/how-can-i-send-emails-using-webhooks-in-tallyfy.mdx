...
sidebar:
  order: 2
snippet: Custom email notifications can be automatically triggered through Tallyfy's
  webhook feature by connecting it with middleware tools like Zapier Make or Power
  Automate when specific workflow events occur.

---
about_tallyfy: true
description: Tallyfy webhooks send event data to middleware tools like Zapier or Make
  when tasks are completed or processes launch and you can map that payload data into
  custom automated emails with dynamic content pulled straight from form fields and
  assignee details.

---
about_tallyfy: true
description: Tallyfy webhooks can be connected to middleware tools like Zapier or
  Make to automatically send custom emails with full process context whenever specific
  workflow events like task completions occur.

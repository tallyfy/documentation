---
description: Webhooks automatically send data from Tallyfy to external systems when
  processes launch or specific tasks complete enabling real-time tracking and automated
  follow-up actions through JSON notifications.

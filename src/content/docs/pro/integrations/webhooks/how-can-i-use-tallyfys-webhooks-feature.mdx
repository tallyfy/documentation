...
description: Tallyfy webhooks automatically push JSON data to external systems when
  ...
  carries all accumulated form data and metadata collected up to that point so your
  receiving system gets everything in one call without needing separate webhooks for

...
description: Tallyfy webhooks automatically send JSON data to external systems when
  workflow events occur enabling real-time integration without manual intervention
  through both template-level triggers for any step completion and step-level triggers
  for specific tasks.

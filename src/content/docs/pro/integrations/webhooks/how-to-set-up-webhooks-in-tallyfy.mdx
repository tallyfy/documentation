...
4. Choose **Catch Hook** or **When HTTP request is received** as the trigger event
    ...
    ![](https://screenshots.tallyfy.com/file-keKVUbxSVx.png)

5. Copy the custom webhook URL provided by your middleware platform (you'll need this for Tallyfy)

    ![](https://screenshots.tallyfy.com/file-fql8JmHkcV.png)
</Steps>
...
3. Choose **Send Channel Message** as the action event.
    ...
    ![](https://screenshots.tallyfy.com/file-VKfh08LN9D.png)
...
6. Create a message template using webhook data.
    ...
    ![](https://screenshots.tallyfy.com/file-fmk7snOjfe.png)
...
3. Verify that the notification appears in your Slack channel
    ...
    ![](https://screenshots.tallyfy.com/file-T9dKncA7bl.png)
</Steps>
...
![](https://screenshots.tallyfy.com/file-g5qdMzYyEK.png)

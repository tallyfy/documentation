---
description: OpenAI provides AI agent capabilities through their Responses API Agents SDK and Computer Use tools that work with Tallyfy to automate web-based workflow tasks using natural language instructions combined with Tallyfy structured process management for controlled business automation.

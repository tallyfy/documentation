---
about_tallyfy: false
description: Claude's Computer Use capability lets an AI agent visually perceive and
  control desktop screens through screenshots and mouse/keyboard actions inside a
  sandboxed Docker environment to automate repetitive UI tasks described in Tallyfy
  task instructions by looping through perceive-act-check cycles until completion.

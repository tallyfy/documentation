---
description: Anthropic's Claude Computer Use feature enables AI agents to interact
  with desktop environments through screen perception and UI automation which can
  be integrated with Tallyfy to automate complex computer-based tasks within business
  processes.

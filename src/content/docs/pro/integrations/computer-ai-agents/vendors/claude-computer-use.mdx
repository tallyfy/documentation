---
description: Claude Computer Use provides powerful desktop automation capabilities
  that work with any application through visual perception and control enabling businesses
  to automate repetitive UI tasks across legacy systems web browsers and desktop applications
  while Tallyfy orchestrates the workflow with structured task management and trackable
  execution.
...
```d2
TallyfyTask[Tallyfy Task]: {
T1: "Task Description"
T2: "Form Fields"
T3: "Expected Output"
}
ClaudeAgent[Claude Computer Use]: {
C1: "Take Screenshot"
C2: "Analyze Screen"

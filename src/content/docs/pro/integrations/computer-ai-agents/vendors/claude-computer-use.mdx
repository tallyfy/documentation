---
description: Claude's Computer Use feature enables AI agents to control computers
  through visual perception and mouse/keyboard actions within sandboxed Docker environments
  allowing Tallyfy to orchestrate complex desktop application automation workflows
  with natural language instructions while maintaining security through isolation
  and human oversight for reliable business process automation.

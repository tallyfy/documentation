---
description: Claude Computer Use enables automated desktop application interaction
  through visual perception and control allowing Tallyfy to orchestrate complex UI-based
  workflows across any software without requiring APIs while maintaining enterprise
  security through sandboxed Docker environments.

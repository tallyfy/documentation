---
description: Claude can now directly control computers by clicking buttons typing
  text and navigating applications through its Computer Use capability which works
  with Claude 4 models Claude 3.7 Sonnet and Claude 3.5 Sonnet v2 to automate repetitive
  UI tasks that integrate with Tallyfy workflows through an intermediary application
  that connects webhooks to the Anthropic API for secure sandboxed execution of desktop
  and web application automation.

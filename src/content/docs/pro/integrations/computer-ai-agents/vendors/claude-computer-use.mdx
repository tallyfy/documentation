...
description: Claude Computer Use lets an AI agent control a screen through screenshots
  and mouse and keyboard actions in a sandboxed Docker environment. Tallyfy sends the
  task and captures the results, so you can automate repetitive desktop and web UI work
  like form filling and legacy data extraction, with people kept in the loop.

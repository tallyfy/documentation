...
description: Claude's Computer Use capability enables AI agents to visually perceive
  and control computer interfaces through screenshots mouse movements and keyboard
  actions making it perfect for automating repetitive UI tasks within Tallyfy-orchestrated
  business processes where the AI can navigate desktop applications web browsers and
  legacy systems while providing complete audit trails and structured task management.
...
ClaudeAgent: {
  C1: "Take Screenshot"
  C2: "Analyze Screen"
  C3: "Click/Type/Navigate"
  C4: "Verify Action"
  C5: "Task Complete?" {shape: diamond}
}
TallyfyOutput: {
...
TallyfyTask.T1 -> ClaudeAgent.C2
TallyfyTask.T2 -> ClaudeAgent.C3
TallyfyTask.T3 -> ClaudeAgent.C4
ClaudeAgent.C1 -> ClaudeAgent.C2
ClaudeAgent.C2 -> ClaudeAgent.C3
ClaudeAgent.C3 -> ClaudeAgent.C4
ClaudeAgent.C4 -> ClaudeAgent.C5
ClaudeAgent.C5 -> ClaudeAgent.C1: "No"
ClaudeAgent.C5 -> TallyfyOutput.O1: "Yes"
ClaudeAgent.C4 -> TallyfyOutput.O2
ClaudeAgent.C3 -> TallyfyOutput.O3
ClaudeAgent.C1 -> TallyfyOutput.O4
```
...
3. Use menu navigation: "Open the File menu from the menu bar"

...
sidebar:
  order: 14
snippet: Learn how Anthropic's Claude with Computer Use enables AI agents to interact with computer UIs, and how this can be leveraged within Tallyfy workflows.

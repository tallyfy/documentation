---
about_tallyfy: false
description: Claude's Computer Use lets AI agents see and control computer screens
  through screenshots and mouse/keyboard actions in sandboxed Docker environments,
  automating desktop tasks like form filling and data extraction from legacy systems
  while needing security isolation and human oversight.
...
Here's how Tallyfy orchestrates Claude's computer use through an iterative loop - Claude perceives, acts, and gets feedback until your task is done.

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Integrations > Computer AI agents</b>" href="/products/pro/integrations/computer-ai-agents/" > Computer AI agents are programs that visually interpret and interact with any screen interface... </LinkTitleCard>
...
<LinkTitleCard header="<b>Computer Ai Agents > Local computer use agents</b>" href="/products/pro/integrations/computer-ai-agents/local-computer-use-agents/" > Local Computer Use Agents run AI automation entirely on your own hardware through Tallyfy's... </LinkTitleCard>
</CardGrid>
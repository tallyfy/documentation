...
Webhook -> Skyvern: "2. Send automation\nrequest" {
  style.stroke: "#333"
}

Skyvern -> Planner: "3. Create\nexecution plan" {
  style.stroke: "#333"
}

Planner -> Actor: "4. Execute\nactions" {
  style.stroke: "#333"
}

Actor -> Browser: "5. Control\nbrowser" {
  style.stroke: "#666"
}

Browser -> Validator: "6. Validate\nresults" {
  style.stroke: "#666"
  style.stroke-dash: 3
}

Validator -> Data: "7. Extract\nstructured data" {
  style.stroke: "#333"
}

Validator -> Planner: "Retry if\nfailed" {
  style.stroke: "#aa2222"
  style.stroke-dash: 5
}
...
Request -> Planner: "1. Analyze\ntask" {
  style.stroke: "#333"
  style.stroke-width: 2
}

Planner -> Actor: "2. Assign\ngoal" {
  style.stroke: "#333"
}

Actor -> Validator: "3. Report\nactions" {
  style.stroke: "#333"
}

Validator -> Complete: "4. Success" {
  style.stroke: "#22aa22"
  style.stroke-width: 2
}

Validator -> Planner: "5. Retry with\nfeedback" {
  style.stroke: "#aa2222"
  style.stroke-dash: 3
}
```
...
**What to notice:**
- Asynchronous task creation prevents Tallyfy from blocking while Skyvern works
- Polling pattern lets Tallyfy check completion status without maintaining an open connection
- Structured JSON response maps directly back to Tallyfy form fields for seamless data flow

---
description: Skyvern is an open-source browser automation tool using LLMs and computer vision that scored 85.8% on WebVoyager benchmarks through its Planner-Actor-Validator architecture with pricing at $0.05 per step for cloud hosting or free self-hosted deployment under AGPL-3.0 license.

---
description: Skyvern automates browser workflows using LLMs and computer vision achieving
  85.8% accuracy on web tasks through its three-agent architecture while integrating
  with Tallyfy to handle mundane web automation tasks with structured JSON outputs.

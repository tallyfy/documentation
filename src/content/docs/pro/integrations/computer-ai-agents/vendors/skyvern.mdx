---
description: Skyvern is an open-source platform that uses Large Language Models and
  computer vision to automate browser-based workflows through natural language prompts
  and can integrate with Tallyfy to handle complex web interactions within business
  processes.

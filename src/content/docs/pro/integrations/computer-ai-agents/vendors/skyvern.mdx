...
description: Skyvern automates browser workflows using LLMs and computer vision with
  an open-source architecture that achieves 85.8% accuracy on web tasks through its
  three-agent system of Planner Actor and Validator agents that can integrate with
  Tallyfy to handle mundane web-based automation tasks described in plain English.

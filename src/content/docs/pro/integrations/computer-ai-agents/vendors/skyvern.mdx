---
description: Skyvern automates browser workflows using AI agents and computer vision
  with 85.8% accuracy on web tasks and integrates with Tallyfy to handle mundane web-based
  automation while providing structured data output through its three-agent architecture
  of Planner Actor and Validator components.

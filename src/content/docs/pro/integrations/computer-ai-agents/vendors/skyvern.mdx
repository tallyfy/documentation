---
description: Skyvern automates browser workflows using LLMs and computer vision
  and offers both open-source self-hosting and cloud deployment options for integrating
  with Tallyfy to handle mundane web-based tasks through its multi-agent architecture

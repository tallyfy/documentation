---
description: OpenAI's Operator functions as an AI agent that can navigate websites
  and execute web-based tasks through natural language instructions by combining vision

---
description: Twin.so's AI agents automate complex web operations through browser interaction
  serving 500,000 European SMBs through partnerships with Qonto and OpenAI making
  them ideal for Tallyfy integration when APIs aren't available with enterprise-grade
  security performance and the ability to handle tasks like invoice collection supplier
  portal management and compliance reporting automatically.
...
TA: "Twin.so Agent"
B: "Browser Session"
E: "External Site (e.g., OpenAI)"

# Invoice Retrieval Automation Flow
T -> T: "1. Task becomes active"
T -> W: "2. Trigger webhook"
W -> TS: "3. POST /api/tasks/start starting_url, goal, access_key"
TS -> TA: "4. Initialize agent task"
TA -> B: "5. Launch secure browser"
B -> E: "6. Navigate to platform.openai.com"
# Agent uses vaulted credentials
B -> E: "7. Login with credentials"
E -> B: "8. Authentication success"
B -> E: "9. Navigate to billing section"
E -> B: "10. Display invoices"
B -> E: "11. Download February 2025 invoice"
E -> B: "12. Invoice file ($92.10)"
B -> TA: "13. Extracted data & file"
TA -> TS: "14. Task complete + results"

# Webhook Callback Option
CallbackOption: "Webhook Callback" {
  TS -> W: "15a. POST callback with results"
  W -> T: "16a. Update task with invoice"
}

# Status Polling Option
PollingOption: "Status Polling" {
  T -> TS: "15b. GET /api/tasks/[id]/status"
  TS -> T: "16b. Status: completed + results"
}

T -> T: "17. Attach invoice to task Continue process"
```

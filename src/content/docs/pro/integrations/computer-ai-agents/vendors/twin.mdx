...
sidebar:
  order: 11
snippet: Learn how Twin.so's AI agents automate web tasks in Tallyfy processes via
  browser interaction using natural language goals and its multimodal Action Model.
title: Twin.so AI Agents and Tallyfy
---

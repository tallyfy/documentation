---
about_tallyfy: false
description: Twin.so builds AI browser automation agents through enterprise partnerships.
  Their Invoice Operator serves 500000+ European SMBs via Qonto. Tallyfy integration
  would need custom development for browser-based document retrieval and web portal
  tasks.

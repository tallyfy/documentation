---
about_tallyfy: false
description: Twin.so builds enterprise AI agents that control web browsers to automate
  repetitive tasks like invoice retrieval at scale and can be paired with Tallyfy's
  workflow management to trigger browser-based automation through webhooks and APIs
  for tasks such as document collection and data extraction from web portals that
  lack direct API access.

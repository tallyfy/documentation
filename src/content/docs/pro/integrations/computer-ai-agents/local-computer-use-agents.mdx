...
flowchart TD
    ...
    style Complete fill:#D4EDDA,stroke:#00AA55
    ...
    style VLM fill:#F8F9FA,stroke:#6C757D,stroke-dasharray: 5 5
    style Engine fill:#F8F9FA,stroke:#6C757D,stroke-dasharray: 5 5
    style Orchestrator fill:#F8F9FA,stroke:#6C757D,stroke-dasharray: 5 5
...
flowchart LR
    ...
    style Tallyfy fill:#E3F2FD,stroke:#1976D2
    style LocalAgent fill:#FFF3E0,stroke:#F57C00

---
about_tallyfy: false
description: Local computer use agents run AI automation on your own hardware, so data
  stays private and there are no per-use cloud costs. Tallyfy pairs small local models
  with structured, trackable workflows to automate mundane tasks like form filling.

---
description: Tallyfy revolutionizes business automation by enabling organizations
  to deploy Computer Use Agents locally on their own hardware providing complete privacy
  zero latency and no token costs while maintaining full control over sensitive data
  and eliminating cloud dependency through advanced AI models like Gemma 3n DeepSeek-R1
  and Qwen3 that deliver production-ready automation capabilities with comprehensive
  safety measures and enterprise-grade integration.
...
Check -> Perceive: "No"
Check -> End: "Yes"
Perceive.link: "/products/pro/integrations/computer-ai-agents/index/"
Perceive.tooltip: "Learn about computer AI agents"
Act.link: "/products/pro/integrations/computer-ai-agents/index/"
Act.tooltip: "Computer AI agents overview"
```
...
Task -> Receive: "1. Trigger"
Forms -> Receive: "2. Provide Data"
Receive -> Execute
Execute -> Monitor
Monitor -> Data: "3. Return Results"
Data -> Process
Status -> Process
Logs -> Process
Task.link: "/products/pro/tracking-and-tasks/tasks/index/"
Task.tooltip: "Learn about Tallyfy tasks"
Forms.link: "/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/"
Forms.tooltip: "Form fields documentation"
```

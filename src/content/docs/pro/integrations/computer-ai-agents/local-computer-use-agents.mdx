---
description: Local Computer Use Agents enable fully private offline automation by
  running multimodal AI models directly on your hardware eliminating latency token
  costs and privacy concerns while providing intelligent computer control through
  visual perception and direct UI interaction for Tallyfy process automation.

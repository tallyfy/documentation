...
```mermaid
flowchart TD
    subgraph TallyfyInputs["Tallyfy Process"]
        T1["Task Type"]
        T2["Input Data"]
        T3["Rules/Goals"]
    end
    
    subgraph Decision["Automation Choice"]
        D1{"Structured?"}
        D2["RPA Bot"]
        D3["AI Agent"]
    end
    
    subgraph RPAFlow["RPA Processing"]
        R1["Follow Script"]
        R2["Fixed Actions"]
        R3["Binary Logic"]
    end
    
    subgraph AIFlow["AI Processing"]
        A1["Understand Goal"]
        A2["Adapt to UI"]
        A3["Smart Decisions"]
    end
    
    subgraph Results["Tallyfy Output"]
        O1["Task Complete"]
        O2["Data Captured"]
        O3["Audit Trail"]
    end

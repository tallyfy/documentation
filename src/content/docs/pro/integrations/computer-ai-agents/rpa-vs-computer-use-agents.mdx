---
description: Tallyfy orchestrates both RPA bots that follow rigid scripts for structured
  repetitive tasks and adaptive AI agents that can understand goals and handle dynamic
  interfaces with the platform determining which automation type to use based on task
  complexity while providing human oversight and complete process tracking.

---
about_tallyfy: false
description: Computer AI agents visually interpret and interact with any screen-based
  interface like a human would. Tallyfy sends instructions and captures results so
  you can monitor these agents alongside your broader business processes.
...
<picture>
  ...
  <img src="https://tallyfy.com/blog-images/positioning/tallyfy-control-layer-light.svg" alt="Tallyfy table view showing a 4-step workflow that mixes people, AI agents, and conditional triggers, illustrating how computer AI agents fit inside a defined Tallyfy process" loading="eager" width="1200" height="675" style="width: 100%; height: auto; max-width: 1200px; margin: 0 auto 2rem; display: block;" />
</picture>
...
One thing worth knowing before you point an agent at a long process: AI reliability drops fast across a chain of steps. The [AI task reliability calculator](https://tallyfy.com/tools/ai-task-reliability/) shows why giving AI one task at a time beats handing it a whole job.

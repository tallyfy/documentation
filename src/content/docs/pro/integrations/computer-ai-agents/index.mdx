---
about_tallyfy: false
description: Computer AI agents visually interpret and interact with any screen-based interface like a human would. Tallyfy sends instructions and captures results so you can monitor these agents alongside your broader business processes.

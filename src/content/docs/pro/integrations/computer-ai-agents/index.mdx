---
description: Computer AI Agents are sophisticated software programs that use artificial
  intelligence to perceive digital environments make decisions and execute tasks on
  computers like humans would while Tallyfy provides the framework instructions and
  guardrails to manage these agents within business processes ensuring transparent
  accountable and continuously improvable automation.

---
about_tallyfy: false
description: "Connect your document management system to Tallyfy so workflows handle task
  assignments and timing. Your DMS keeps full control over storage and security, while
  file request links let external users upload directly without needing accounts."

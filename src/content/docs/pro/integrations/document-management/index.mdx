---
description: Tallyfy integrates with document management systems allowing organizations
  to maintain secure document storage while using Tallyfy for workflow orchestration
  through file request links that enable external users to upload directly to your
  DMS without compromising security or compliance requirements.
...
## Integrating document management systems with Tallyfy
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Integrations > File request links</b>" href="/products/pro/integrations/document-management/file-request-links/" > Learn how to use file request links to collect documents securely from external users. </LinkTitleCard>
<LinkTitleCard header="<b>Tasks > Form fields</b>" href="/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/" > Understand how to use form fields including text fields for storing upload links. </LinkTitleCard>
<LinkTitleCard header="<b>Templates > Variables</b>" href="/products/pro/documenting/templates/variables/" > Learn how to use variables to dynamically insert file request links into tasks. </LinkTitleCard>
</CardGrid>
---
about_tallyfy: false
description: Tallyfy integrates with your existing document management system so workflows
  coordinate the people and timing while your DMS retains full control over document
  storage and security through file request links that let external users upload directly

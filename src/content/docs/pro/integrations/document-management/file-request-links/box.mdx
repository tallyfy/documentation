...
sidebar:
  order: 3
description: Configure Box file requests to securely collect documents from external users in your Tallyfy workflows
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>File request links > Overview</b>" href="/products/pro/integrations/document-management/file-request-links/" > Understand the concept of file request links in workflows. </LinkTitleCard>
<LinkTitleCard header="<b>File request links > SharePoint</b>" href="/products/pro/integrations/document-management/file-request-links/sharepoint/" > Learn about SharePoint's file request capabilities. </LinkTitleCard>
<LinkTitleCard header="<b>Webhooks > Setup</b>" href="/products/pro/integrations/webhooks/" > Configure webhooks to notify when documents arrive. </LinkTitleCard>
</CardGrid>
---
about_tallyfy: false
description: Box File Request allows you to securely collect documents from anyone—including
  people without Box accounts—by generating upload-only links with optional identity
  verification and metadata fields that can be integrated into Tallyfy processes for
  organized file collection across regulated industries.

---
about_tallyfy: false
description: Google Drive doesn't have a built-in file request feature. Collect files
  from external users through third-party tools like FileDrop or File Request Pro,
  Google Forms, or shared folders with managed access.

---
description: Discover how to enable file collection from Google Drive using third-party
  tools since Google doesn't offer native file request functionality

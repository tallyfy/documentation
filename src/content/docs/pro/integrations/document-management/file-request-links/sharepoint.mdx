---
about_tallyfy: false
description: SharePoint and OneDrive file requests let you generate upload-only links
  that anyone can use to submit files directly into a specific folder without needing
  a Microsoft account or site access and these links can be stored in Tallyfy processes
  to automate document collection from external parties.

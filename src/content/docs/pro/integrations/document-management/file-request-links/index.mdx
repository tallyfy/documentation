---
description: Understand how file request links enable secure document collection from
  external users without giving them access to your document management system

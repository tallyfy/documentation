...
description: File request links let you collect documents from external people by
  generating unique upload URLs and embedding them into Tallyfy workflow tasks. Recipients
  can upload files directly without needing accounts, while your team keeps full control
  over storage and compliance.

---
description: File request links let you collect documents from external users by
  generating unique upload URLs - no account access or system permissions needed.

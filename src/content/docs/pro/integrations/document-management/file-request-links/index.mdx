---
about_tallyfy: false
description: File request links let you collect documents from external people who
  lack system access by generating unique upload-only URLs in your document management
  system and sharing them through Tallyfy workflow tasks so files land in the right
  folders while maintaining security and compliance.

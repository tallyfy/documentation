---
about_tallyfy: false
description: Dropbox file requests let anyone upload files to your Dropbox folder
  without needing an account. Store these unique upload links in Tallyfy process fields
  to collect documents from external users during workflow tasks.
...
<LinkTitleCard header="<b>File Request Links > Google Drive file requests</b>" href="/products/pro/integrations/document-management/file-request-links/google-drive/" > Google Drive doesn't have a built-in file request feature. Collect files from external users... </LinkTitleCard>
</CardGrid>
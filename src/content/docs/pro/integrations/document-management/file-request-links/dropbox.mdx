...
sidebar:
  order: 2
description: Step-by-step guide to creating Dropbox file request links for secure document collection in Tallyfy workflows
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>File request links > Overview</b>" href="/products/pro/integrations/document-management/file-request-links/" > Learn the general concept of using file request links with Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>File request links > Box</b>" href="/products/pro/integrations/document-management/file-request-links/box/" > Explore Box's file request implementation for enterprise workflows. </LinkTitleCard>
<LinkTitleCard header="<b>Document management > Overview</b>" href="/products/pro/integrations/document-management/" > Understand different approaches to document management in Tallyfy. </LinkTitleCard>
</CardGrid>
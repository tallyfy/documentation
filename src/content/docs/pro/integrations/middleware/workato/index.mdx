...
<LinkTitleCard header="<b>Middleware > Celigo</b>" href="/products/pro/integrations/middleware/celigo/" > Connect Tallyfy with enterprise systems like NetSuite and Salesforce through Celigo's integrator.io platform using HTTP connectors and Tallyfy's REST API. </LinkTitleCard>
</CardGrid>
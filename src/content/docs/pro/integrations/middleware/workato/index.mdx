---
description: Tallyfy is developing a native Workato connector that will enable organizations
  to create enterprise-scale workflow automations between Tallyfy processes and thousands
  of business applications through visual recipes and robust error handling without requiring

---
description: Workato integrates with Tallyfy through HTTP connectors or custom connectors
  to enable enterprise-scale workflow automation between Tallyfy processes and other
  business systems with robust error handling data transformations and security features.
...
- Review [Tallyfy's API documentation](https://go.tallyfy.com/api/)
- Consult [Workato's HTTP connector guide](https://docs.workato.com/connectors/http.html)
...
<LinkTitleCard header="<b>Middleware > Why use an integration platform (middleware) with Tallyfy?</b>" href="/products/pro/integrations/middleware/why-should-i-use-an-integration-platform-with-tallyfy/" > Integration platforms provide pre-built connectors error handling data transformation and monitoring capabilities that eliminate the complexity of building and maintaining direct API integrations between Tallyfy and other business applications. </LinkTitleCard>
<LinkTitleCard header="<b>Integrations > Webhooks</b>" href="/products/pro/integrations/webhooks/" > Webhooks enable real-time event notifications from Tallyfy to external systems when specific workflow events occur allowing automated integrations without constant API polling or manual data synchronization. </LinkTitleCard>
</CardGrid>
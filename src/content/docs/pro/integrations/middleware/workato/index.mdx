...
description: Tallyfy's Workato connector lets you automate workflows between Tallyfy
  and enterprise systems like Salesforce, SAP, and Workday through OAuth 2.0 authentication
  with built-in actions for launching processes, completing tasks, and polling triggers
  for new assignments.

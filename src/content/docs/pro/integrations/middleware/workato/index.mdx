---
about_tallyfy: true
description: Tallyfy's Workato connector uses OAuth 2.0 and Workato's Ruby SDK to
  start processes, complete tasks, and track assignments across enterprise systems.
  It provides five actions and three polling triggers that dynamically map kick-off
  form fields from your templates.

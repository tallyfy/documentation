---
description: Workato can integrate with Tallyfy through HTTP connectors or custom
  connector development to enable enterprise-grade workflow automation and data synchronization

---
about_tallyfy: true
description: Workato recipes can automatically complete Tallyfy tasks in response
  to external events like document signings or CRM updates by sending HTTP POST requests
  to the Tallyfy API's completed-tasks endpoint with optional form field data and
  approval flags.

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Tasks > Complete task</b>" href="/products/pro/integrations/open-api/code-samples/tasks/complete-task/" > Tallyfy's API allows you to mark both process-based and standalone tasks as complete by sending... </LinkTitleCard>

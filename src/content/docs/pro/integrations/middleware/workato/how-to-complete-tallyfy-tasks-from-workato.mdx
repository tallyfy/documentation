...
<LinkTitleCard header="<b>Zapier > Automate tasks in Tallyfy using zaps</b>" href="/products/pro/integrations/middleware/zapier/how-to-automate-tasks-in-tallyfy-using-zaps/" > This guide explains how to automate Tallyfy task completion through Zapier by either directly completing tasks with known IDs or first finding tasks by template and name before marking them complete. </LinkTitleCard>

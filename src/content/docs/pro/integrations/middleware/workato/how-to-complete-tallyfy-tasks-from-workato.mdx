...
description: Workato recipes can automatically complete Tallyfy tasks when external
  events happen. Send HTTP POST requests to the completed-tasks API endpoint with
  form field data, error handling for missing fields, and rate limit retries.

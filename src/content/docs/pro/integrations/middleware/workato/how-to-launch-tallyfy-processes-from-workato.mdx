...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Middleware > Integrate Tallyfy with Workato</b>" href="/products/pro/integrations/middleware/workato/" > Workato can integrate with Tallyfy through HTTP connectors or custom connector development to enable enterprise-grade workflow automation and data synchronization between Tallyfy processes and other business systems. </LinkTitleCard>

---
description: Workato can automatically trigger Tallyfy workflows through HTTP connectors
  when events occur in external systems like Salesforce or Zendesk by mapping trigger
  data to kick-off forms and handling the complete authentication and error management
  process.

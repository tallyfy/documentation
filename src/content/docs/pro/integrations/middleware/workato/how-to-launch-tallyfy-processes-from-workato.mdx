...
```d2
ES: "External System (Salesforce/Zendesk)"
W: "Workato Recipe"
HTTP: "HTTP Connector"
T: "Tallyfy API"

# Integration Flow: External Event → Tallyfy Process Launch
ES -> W: "1. Trigger Event (New opportunity, ticket, etc.)"
W -> W: "2. Extract trigger data"
W -> HTTP: "3. Configure request"
# Authentication: Bearer token + X-Tallyfy-Client header
HTTP -> T: "4. POST /api/runs with JSON body"
# Body includes: - blueprint_id - owner_id - prerun data

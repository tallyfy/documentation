---
about_tallyfy: true
description: Workato recipes can automatically launch Tallyfy processes by using the
  HTTP connector to send POST requests to Tallyfy's API with your template ID and
  kick-off form data whenever events occur in systems like Salesforce or Zendesk.

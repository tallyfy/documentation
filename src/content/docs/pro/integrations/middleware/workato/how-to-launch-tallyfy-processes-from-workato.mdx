---
about_tallyfy: true
description: Workato recipes can automatically launch Tallyfy processes by connecting
  any trigger system like Salesforce or Zendesk through an HTTP connector that sends
  authenticated POST requests to Tallyfy's API with template IDs and kick-off form
  data mapped dynamically from the triggering event.

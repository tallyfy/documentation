---
description: Workato can automatically launch Tallyfy processes through HTTP connectors
  when external events occur by configuring authentication headers sending POST requests
  with template IDs and prerun data to populate kick-off forms while handling various
  error scenarios for reliable workflow automation.
...
W: "W"
autonumber
ES as External System (Salesforce/Zendesk)
W as Workato Recipe
HTTP as HTTP Connector
T as Tallyfy API

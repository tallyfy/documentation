---
description: Workato can automatically launch Tallyfy processes when external events
  occur by using HTTP connectors to send API requests with trigger data that populates
  kick-off forms and creates workflows from systems like Salesforce or Zendesk.

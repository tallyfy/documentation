---
description: This guide demonstrates how to automatically trigger Tallyfy processes
  from Workato recipes using HTTP connectors to create seamless workflow automation

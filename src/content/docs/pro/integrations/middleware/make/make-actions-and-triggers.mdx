---
about_tallyfy: false
description: Make maintains an official, verified Tallyfy connector, live today with core
  modules for launching processes, completing and creating tasks, comments, and issues. A
  broader module set covering templates, form fields, tags, folders, and search is a proposed
  expansion. Connect with your Tallyfy API token and Organization ID.

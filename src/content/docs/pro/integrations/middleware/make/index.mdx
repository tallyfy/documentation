...
description: Make is a visual integration platform that connects Tallyfy with hundreds
  of business applications through scenario-based workflows enabling automated process
  launching and task completion and form data capture across your technology stack.

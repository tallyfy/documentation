---
description: Power Automate can automate Microsoft Entra ID (formerly Azure AD) administrative
  tasks for managing Tallyfy members and access including user onboarding group membership
  management and compliance reporting through Entra ID connectors and Microsoft Graph
  API integration.

---
description: Power Automate can be used to automate Azure Active Directory administrative
  tasks related to Tallyfy user management such as onboarding users managing group
  memberships that control Tallyfy access and generating compliance reports for organizations
  using Azure AD with Tallyfy SSO.

...
sidebar:
  order: 14
snippet: Power Automate Desktop enables automation of legacy desktop applications
  through RPA by mimicking human interactions with user interfaces when API integration
  is not possible for Tallyfy connections.
...
3.  **Action:** Power Automate Desktop connector - **Run a flow built with Power Automate for desktop**.
    ...
    *   **Input Variables:** Pass data from Tallyfy's "Get task details" output to the input variables in your desktop flow.
        ...
        ![Screenshot of Run a flow built with Power Automate for desktop action](mdc:/pro/integrations/middleware/power-automate/assets/run-desktop-flow-action.png)
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Connecting Power Automate to external data</b>" href="/products/pro/integrations/middleware/power-automate/connecting-power-automate-to-external-data/" > Learn about connecting to databases and forms, which might be sources or destinations for RPA-handled data related to Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Open API</b>" href="/products/pro/integrations/open-api/" > Explore Tallyfy's Open API, a more robust method for direct integrations compared to RPA. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Webhooks</b>" href="/products/pro/integrations/webhooks/" > Understand Tallyfy Webhooks, another primary method for triggering automations from Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Leveraging AI Builder in Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/leveraging-ai-builder-in-power-automate/" > Discover how AI Builder can sometimes help process unstructured data, as an alternative to RPA for some Tallyfy scenarios. </LinkTitleCard>
</CardGrid>
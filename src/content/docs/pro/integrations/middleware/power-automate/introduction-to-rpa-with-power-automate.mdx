---
description: Power Automate Desktop uses Robotic Process Automation to bridge Tallyfy
  with legacy desktop applications that lack APIs by automating UI interactions through
  software bots that mimic human clicks and data entry.

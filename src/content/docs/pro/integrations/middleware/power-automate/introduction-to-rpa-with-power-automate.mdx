---
description: Power Automate Desktop uses Robotic Process Automation (RPA) to bridge
  Tallyfy with legacy desktop applications that lack APIs by automating UI interactions
  through software bots that mimic human actions like clicking buttons and typing
  text.
...
User: "User"
Tallyfy: "Tallyfy"
CloudFlow: "Power Automate Cloud Flow"
Gateway: "On-Premises Gateway"
DesktopFlow: "Power Automate Desktop Flow"
LegacyCRM: "Legacy Desktop CRM"

# RPA Integration Pattern: Bridging Tallyfy with Legacy Systems
User -> Tallyfy: "1. Complete 'Client Info Update' task"
Tallyfy -> CloudFlow: "2. Trigger: Task completed event"
CloudFlow -> Tallyfy: "3. Get task details (form field data)"
Tallyfy -> CloudFlow: "4. Return client data (phone, ID, etc.)"
CloudFlow -> Gateway: "5. Run desktop flow with input variables"
Gateway -> DesktopFlow: "6. Start RPA bot (attended/unattended)"

# UI Automation Sequence
UIAutomation: "UI Automation" {
  DesktopFlow -> LegacyCRM: "7. Launch application"
  DesktopFlow -> LegacyCRM: "8. Click 'Search Client'"
  DesktopFlow -> LegacyCRM: "9. Enter client ID"
  DesktopFlow -> LegacyCRM: "10. Click 'Search'"
  LegacyCRM -> DesktopFlow: "11. Display client record"
  DesktopFlow -> LegacyCRM: "12. Update phone field"
  DesktopFlow -> LegacyCRM: "13. Click 'Save Changes'"
  DesktopFlow -> LegacyCRM: "14. Close application"
}

DesktopFlow -> Gateway: "15. Execution complete"
Gateway -> CloudFlow: "16. Success/failure status"

# Optional: Update Tallyfy
CloudFlow -> Tallyfy: "17. Update process status (optional)"
```

...
T -> PA: "1. Trigger flow (budget request)"
PA -> PA: "2. Start and wait for approval"
PA -> Teams: "3. Post Adaptive Card to approver"
Teams -> U: "4. Display approval request"
# Flow paused waiting for response
U -> Teams: "5. Click Approve/Reject"
Teams -> PA: "6. Return response"
PA -> PA: "7. Get Outcome and Comments"
PA -> T: "8. Update task/process with decision"

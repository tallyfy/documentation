...
sidebar:
  order: 12
snippet: Microsoft Teams integration with Power Automate enables direct approval notifications
  and responses for Tallyfy workflows through interactive Adaptive Cards while reducing
  context switching and speeding up decision-making processes.
...
3.  **Configure the "Post adaptive card" action:**
    ...
    *   **Adaptive Card:** This is key for displaying Tallyfy approval information.
    ...
    ![Screenshot of configuring Post adaptive card in Teams](mdc:/pro/integrations/middleware/power-automate/assets/teams-post-adaptive-card.png)
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Building approval workflows with Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/building-approval-workflows-with-power-automate/" > Learn to design approval workflows in Power Automate that can be extended to Teams for Tallyfy items. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Slack</b>" href="/products/pro/integrations/slack/" > Explore how Tallyfy integrates with Slack, a similar chat-based integration pattern. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Understanding Power Automate basics</b>" href="/products/pro/integrations/middleware/power-automate/understanding-power-automate-basics/" > Review fundamentals of Power Automate, including connectors like the Teams connector. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Tracking and Tasks > Tasks</b>" href="/products/pro/tracking-and-tasks/tasks/" > Understand Tallyfy tasks, which are often the subject of approvals. </LinkTitleCard>
</CardGrid>
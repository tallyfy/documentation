...
description: Integrating Power Automate approvals with Microsoft Teams for Tallyfy
  streamlines decision-making by allowing approvers to receive notifications and respond
  to requests directly within Teams through Adaptive Cards without switching between
  applications.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Power Automate > Building approval workflows with Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/building-approval-workflows-with-power-automate/" > Power Automate approvals integrate with Tallyfy to handle formal sign-offs through automated workflows that can route approval requests to designated stakeholders and update Tallyfy processes based on approval outcomes with support for complex routing scenarios like threshold-based approvals and external stakeholder involvement. </LinkTitleCard>

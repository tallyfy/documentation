---
about_tallyfy: true
description: Power Automate lets you store and transform Tallyfy task data using
  variables, loops, and parse operations. Filter tasks by date and build formatted
  reports like daily HTML email summaries of due items.

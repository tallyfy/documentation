---
about_tallyfy: true
description: Power Automate lets you store and transform Tallyfy task data and JSON
  payloads using variables and loops and parse operations so you can filter tasks
  by date and build formatted reports like daily HTML email summaries of due items.

...
description: Power Automate lets you store and transform Tallyfy task data and JSON
  payloads using variables and loops and data operations like Parse JSON and Filter
  Array so you can build practical automations such as a daily HTML email report of
  tasks due today.

...
sidebar:
  order: 7
snippet: Make your Power Automate flows intelligent by adding conditional logic to
  perform different actions based on specific criteria related to Tallyfy.

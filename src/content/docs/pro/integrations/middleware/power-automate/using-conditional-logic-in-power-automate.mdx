...
Trigger -> GetDetails
GetDetails -> Check
Check -> : ""Yes"" EmailManager
Check -> : ""No"" EmailRegular
EmailManager -> End
EmailRegular -> End
click GetDetails "/products/pro/tracking-and-tasks/tasks/index/" "Learn about Tallyfy tasks"
click Check "/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/" "Understanding form fields"
```

---
description: Power Automate's conditional logic enables automated workflows to make
  intelligent decisions based on Tallyfy process data using if-then structures that
  evaluate form fields task statuses and other criteria to trigger different actions
  and create adaptive business process automations.
...
EmailManager -> End
EmailRegular -> End
GetDetails.link: "/products/pro/tracking-and-tasks/tasks/index/"
GetDetails.tooltip: "Learn about Tallyfy tasks"
Check.link: "/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/"
Check.tooltip: "Understanding form fields"
```
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Power Automate > Advanced conditions and expressions in Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/advanced-conditions-and-expressions/" > Power Automate's advanced conditional logic transforms basic if-then statements into sophisticated decision-making systems using expressions grouped conditions and Switch controls to handle complex Tallyfy data scenarios with multiple conditions calculations and edge cases that real business workflows demand. </LinkTitleCard>

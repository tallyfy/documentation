---
description: AI Builder adds intelligence to Power Automate flows by providing pre-built
  models for text recognition and sentiment analysis plus trainable custom models
  for form processing and predictions that can automatically extract data from documents
  and route Tallyfy tasks based on AI-analyzed content without requiring coding expertise.

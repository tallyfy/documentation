---
description: This guide demonstrates how to build an automated Power Automate flow
  that monitors Outlook emails and creates corresponding tasks in Tallyfy using the
  Tallyfy connector with step-by-step configuration instructions and testing procedures.
...
sequenceDiagram
 ...
 participant TP as Tallyfy Process

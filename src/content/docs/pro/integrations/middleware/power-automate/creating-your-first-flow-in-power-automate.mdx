---
description: This guide demonstrates how to build an automated Power Automate workflow
  that monitors Outlook emails and creates corresponding tasks in Tallyfy when specific
...
<LinkTitleCard header="<b>Power Automate > Triggering flows manually (button flows)</b>" href="/products/pro/integrations/middleware/power-automate/triggering-flows-manually-button-flows/" > Instant flows in Power Automate enable manual triggering of Tallyfy automations through button interfaces for ad-hoc process launches quick task creation and on-demand data collection with customizable input fields. </LinkTitleCard>
</CardGrid>
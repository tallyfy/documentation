...
sequenceDiagram
    ...
    E->>O: Sends email with<br/>"New Sales Lead Received"
    ...
    alt Subject matches filter
        PA->>PA: Extract email data<br/>(Subject, Body, Sender)
        
        PA->>T: POST Create Task<br/>Auth: API Key/Secret
        Note right of PA: Blueprint ID: Lead Follow-Up<br/>Task Name: Email Subject<br/>Description: Email Body<br/>Deadline: +1 day

...
3.  **Action: SQL Server - "Insert row (V2)".**
	...
	*   **Row:** The action will display fields corresponding to your SQL table's columns. Map dynamic content from the "Get task details" step (e.g., Task Name, Completion Date, Assigned User Email, specific form field values like `outputs('Get_task_details')?['body/forms/YourFormFieldName/value']`) to these columns.
	...
	![Screenshot of SQL Server Insert Row action mapping Tallyfy data](mdc:/pro/integrations/middleware/power-automate/assets/sql-insert-row-from-tallyfy.png)
...
3.  **Action: Forms - "Get response details".**
	...
	*   **Response Id:** Use the `Response Id` dynamic content from the trigger step.
	...
	![Screenshot of Forms Get response details action](mdc:/pro/integrations/middleware/power-automate/assets/forms-get-response-details.png)
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Working with data operations and variables</b>" href="/products/pro/integrations/middleware/power-automate/working-with-data-operations-and-variables/" > Use variables and data parsing for complex data handling when integrating Tallyfy with external sources. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Open API</b>" href="/products/pro/integrations/open-api/" > Learn about Tallyfy's Open API for direct and advanced data integrations. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Webhooks</b>" href="/products/pro/integrations/webhooks/" > Discover how to use Tallyfy Webhooks to send data from Tallyfy to Power Automate. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Triggering flows manually (button flows)</b>" href="/products/pro/integrations/middleware/power-automate/triggering-flows-manually-button-flows/" > Understand how to gather user input at runtime for your Tallyfy automations. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Tracking and Tasks > Tasks > What are form fields in Tallyfy</b>" href="/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/" > Understand how Tallyfy form fields are used to capture data within processes. </LinkTitleCard>
</CardGrid>
---
description: AI Builder integrates with Power Automate to add artificial intelligence
  capabilities to Tallyfy workflows through pre-built models for text recognition
  sentiment analysis and custom models for form processing enabling automated data
  extraction intelligent routing and predictive analytics without requiring coding
  expertise.

...
<LinkTitleCard header="<b>Power Automate > Using conditional logic in Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/using-conditional-logic-in-power-automate/" > Power Automate's conditional logic enables automated workflows to make intelligent decisions based on Tallyfy process data using IF-THEN structures condition controls and Switch statements to create adaptive flows that respond differently to various task states form field values and process outcomes. </LinkTitleCard>
</CardGrid>
...
sidebar:
  order: 15
snippet: AI Builder enables Power Automate flows to perform intelligent tasks with
  Tallyfy by processing text images and documents through pre-built or custom AI models
  for enhanced workflow automation.
...
3.  **Action: AI Builder - "Detect the language being used in text".**
    ...
    *   **Text:** Provide the dynamic content `CustomerFeedbackText` (or your equivalent field name) from the Tallyfy "Get task details" output.
    ...
    ![Screenshot of AI Builder Detect Language action](mdc:/pro/integrations/middleware/power-automate/assets/ai-builder-detect-language.png)
...
4.  **Action: AI Builder - "Analyze positive or negative sentiment in text".**
    ...
    *   **Text:** Again, provide the `CustomerFeedbackText` dynamic content from Tallyfy.
    ...
    ![Screenshot of AI Builder Sentiment Analysis action](mdc:/pro/integrations/middleware/power-automate/assets/ai-builder-sentiment-analysis.png)
...
1.  **In AI Builder (within Power Automate portal):**
    ...
    *   Train your model. Once training is complete, test it and publish it for use in flows connected to Tallyfy.
    ...
    ![Conceptual screenshot of AI Builder Form Processing tagging interface](mdc:/pro/integrations/middleware/power-automate/assets/ai-builder-form-processing-tagging.png)
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Introduction to RPA with Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/introduction-to-rpa-with-power-automate/" > Get an overview of Robotic Process Automation (RPA) for scenarios where AI or APIs might not fit for Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Working with data operations and variables</b>" href="/products/pro/integrations/middleware/power-automate/working-with-data-operations-and-variables/" > Learn about variables and data operations, often used to prepare Tallyfy data for AI Builder. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Managing and monitoring Power Automate flows</b>" href="/products/pro/integrations/middleware/power-automate/managing-and-monitoring-power-automate-flows/" > Understand how to monitor flows that include AI Builder actions connected to Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Documenting > Templates > Automations</b>" href="/products/pro/documenting/templates/automations/" > Explore Tallyfy's native automation capabilities which can complement or provide alternatives to some AI Builder scenarios. </LinkTitleCard>
</CardGrid>
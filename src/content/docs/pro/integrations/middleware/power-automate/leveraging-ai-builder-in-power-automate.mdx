...
<LinkTitleCard header="<b>Power Automate > Using conditional logic in Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/using-conditional-logic-in-power-automate/" > Power Automate's conditional logic enables automated workflows to make intelligent decisions based on Tallyfy process data using IF-THEN structures that evaluate form fields task statuses and other criteria to route actions appropriately without manual intervention. </LinkTitleCard>
</CardGrid>
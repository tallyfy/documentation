...
sidebar:
  order: 15
snippet: AI Builder empowers Power Automate flows to perform intelligent tasks like
  text recognition sentiment analysis and form processing while seamlessly integrating

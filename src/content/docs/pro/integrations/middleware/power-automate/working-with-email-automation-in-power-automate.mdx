...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Creating your first flow in Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/creating-your-first-flow-in-power-automate/" > Learn to build your first automated workflow with Tallyfy. </LinkTitleCard>
...
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Managing files with Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/managing-files-with-power-automate/" > Automate file management, including email attachments for Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Documenting > Templates</b>" href="/products/pro/documenting/templates/" > Understand Tallyfy procedure templates, which can be launched from email triggers. </LinkTitleCard>
</CardGrid>
---
about_tallyfy: true
description: Power Automate automates file management for Tallyfy workflows -
  archiving documents to SharePoint or OneDrive when tasks complete, and launching
  processes when new files appear in monitored folders.

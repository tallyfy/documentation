...
sidebar:
  order: 5
snippet: Power Automate enables automated file management tasks by integrating various
  storage services with Tallyfy processes through triggers actions and connectors
  to streamline document organization and workflow efficiency.
...
2.  **Get Tallyfy task details (including the file).**
    ...
    *   **Task ID:** Use `Task ID` dynamic content from the trigger.
    ...
    ![Screenshot of Tallyfy Get Task Details action](mdc:/pro/integrations/middleware/power-automate/assets/tallyfy-get-task-details-file.png)
...
4.  **Create the file in SharePoint.**
    ...
    *   **File Content:** Select the dynamic content for the file. If you used the variable, select that. Otherwise, use the Tallyfy file content output from **Get task details** (e.g., `ProjectClosureReportFile_Content`).
    ...
    ![Screenshot of SharePoint Create File action](mdc:/pro/integrations/middleware/power-automate/assets/sharepoint-create-file-from-tallyfy.png)
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Working with email automation in Power Automate</b>" href="/products/pro/integrations/middleware/power-automate/working-with-email-automation-in-power-automate/" > Automate email tasks, which can include attaching files managed through Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Middleware > Power Automate > Working with data operations and variables</b>" href="/products/pro/integrations/middleware/power-automate/working-with-data-operations-and-variables/" > Learn about handling file content and metadata using variables and data operations for Tallyfy. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Integrations > Open API</b>" href="/products/pro/integrations/open-api/" > Explore Tallyfy's Open API for advanced file interactions with Tallyfy processes. </LinkTitleCard>
<LinkTitleCard header="<b>Pro > Documenting > Documents</b>" href="/products/pro/documenting/documents/" > Understand Tallyfy document templates, which can be part of file management workflows. </LinkTitleCard>
</CardGrid>
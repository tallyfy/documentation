---
about_tallyfy: false
description: Beyond basic if-then logic in Power Automate you can handle complex Tallyfy
  workflow decisions using expressions for calculations and data manipulation and
  grouped AND/OR conditions for nested logic and the Switch control for cleanly routing
  a single form field value across multiple outcome branches.

...
description: Power Automate expressions, grouped conditions, and Switch controls handle
  Tallyfy workflow logic that goes past a simple if-then. Use calculations on form
  field data and multi-outcome branching based on task values and process states.

---
about_tallyfy: false
description: Power Automate expressions, grouped conditions, and Switch controls handle
  Tallyfy workflow logic beyond basic if-then rules. Use calculations on form field
  data and multi-outcome branching based on task values and process states.
...
Basic if-then logic works for simple Tallyfy [processes](/products/pro/tracking-and-tasks/processes/) in Power Automate. But real workflows get messy fast - they need multiple conditions, calculations, and edge case handling. Three techniques help you make smarter decisions with Tallyfy data: expressions, grouped conditions, and the Switch control.

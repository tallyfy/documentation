---
about_tallyfy: false
description: Power Automate's expressions and grouped conditions and Switch controls
  let you handle complex Tallyfy workflow logic beyond basic if-then rules by enabling
  calculations on form field data and clean multi-outcome branching based on task
  values and process states.

...
flowchart TD
    ...
    Evaluate -->|Information| Info[Send email with<br/>KB article links]
    Evaluate -->|Access| Access[Create approval request<br/>in Teams]
    Evaluate -->|Hardware| Hardware[Launch Hardware<br/>Procurement template]
    Evaluate -->|Other/Unknown| Default[Notify IT support<br/>about unclassified request]

...
Tallyfy sits above these tools, connecting them through [middleware](/products/pro/integrations/middleware/) to create smooth end-to-end processes while letting each tool do what it does best.

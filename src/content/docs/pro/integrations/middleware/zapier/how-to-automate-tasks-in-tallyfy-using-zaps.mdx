---
description: Tallyfy tasks can be automated through Zapier by either directly completing
  tasks with known IDs or first finding tasks using template IDs and process names
  then marking them complete through the API.

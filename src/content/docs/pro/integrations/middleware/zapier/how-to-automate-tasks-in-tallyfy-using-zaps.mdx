---
description: This guide explains how to use Zapier to automatically complete tasks
  in Tallyfy by either directly completing tasks when you have the task ID or first
  finding the task using template ID and search criteria before marking it complete.

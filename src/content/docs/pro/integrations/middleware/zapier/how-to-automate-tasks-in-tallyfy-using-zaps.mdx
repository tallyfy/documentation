...
description: This guide explains how to automate Tallyfy task completion through Zapier
  by either directly completing tasks with known IDs or finding tasks first using
  template IDs and search criteria then marking them complete via API integration.
...
Complete: "Complete"
Find: "Find"
Trigger: ""External Trigger"" -> Check{Have"]
Find -> Complete
Complete -> API: "Tallyfy API"
Find.link: "/products/pro/tracking-and-tasks/tasks/index/"
Find.tooltip: "Learn about tasks"
API.link: "/products/pro/integrations/open-api/index/"
API.tooltip: "Tallyfy API documentation"
```

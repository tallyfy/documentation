...
description: This guide explains how to automate Tallyfy task completion through Zapier
  by either directly marking tasks complete with existing task IDs or first finding
  tasks by name or field values before completing them.
...
Complete`"]
    ...
    click Find "/products/pro/tracking-and-tasks/tasks/index/" "Learn about tasks"
    click API "/products/pro/integrations/open-api/index/" "Tallyfy API documentation"
```

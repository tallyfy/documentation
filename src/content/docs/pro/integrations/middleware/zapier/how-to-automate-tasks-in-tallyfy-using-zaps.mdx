...
description: This guide explains how to automate task completion in Tallyfy using
  Zapier by setting up triggers that either directly complete tasks with existing
  IDs or first find tasks by template and name before marking them complete through
  the Tallyfy API.

---
description: You can automate task completion in Tallyfy using Zapier by setting up
  triggers that either complete tasks directly with known task IDs or first find tasks
  using template and process information before marking them complete through the
  Tallyfy API.

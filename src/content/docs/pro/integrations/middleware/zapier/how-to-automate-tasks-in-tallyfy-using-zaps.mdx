---
description: This guide explains how to automate task completion in Tallyfy using
  Zapier integrations by finding tasks through template searches and marking them
  complete via API calls.

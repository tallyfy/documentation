...
description: Celigo's integrator.io platform has an official, Celigo-maintained Tallyfy
  connector, selectable natively when you build a flow and supporting both an API
  token and OAuth 2.0. Use it to trigger approvals from NetSuite orders or sync task
  completions to your ERP and CRM systems.

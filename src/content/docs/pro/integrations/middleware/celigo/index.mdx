...
sidebar:
  order: 1
description: Celigo integration with Tallyfy enables enterprise-grade workflow automation through integrator.io platform connecting ERP CRM HR and business process systems with planned native connector supporting real-time data synchronization automated task triggers and bidirectional process orchestration
title: Celigo

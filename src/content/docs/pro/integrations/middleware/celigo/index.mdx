...
description: Celigo's integrator.io platform can connect to Tallyfy through its universal
  HTTP connector and Tallyfy's REST API to automate workflows like triggering approval
  processes from NetSuite orders or syncing task completions back to your ERP and
  CRM systems even though no native connector exists yet.

---
description: Tallyfy's native Celigo connector is under development to enable bidirectional
  workflow automation between Tallyfy and enterprise systems like NetSuite and Salesforce
  through process triggers task management and data synchronization capabilities.
...
The planned integration will use Celigo's universal HTTP connector architecture and API management capabilities to create bidirectional data flows between Tallyfy and your other business systems.
...
New employee records in your HRIS system trigger complete onboarding processes in Tallyfy. Celigo orchestrates data flow between HR systems, IT provisioning tools, and Tallyfy's task management - ensuring nothing falls through the cracks.
...
3. Include Tallyfy logo and detailed description

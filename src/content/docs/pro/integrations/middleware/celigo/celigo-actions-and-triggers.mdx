---
about_tallyfy: false
description: The Celigo connector for Tallyfy grew from a handful of flows to a full set covering users, tasks, processes, templates, form fields, comments, tags, folders, and search, plus four scheduled delta-poll triggers. It authenticates with OAuth 2.0 through integrator.io.

...
Automations, step-level template edits (adding, cloning, reordering, or reassigning individual steps), and a raw API passthrough flow are a later follow-up. For those, call Tallyfy's [Open API](/products/pro/integrations/open-api/) directly through Celigo's universal HTTP connector.
:::

...
T -> Q: "3. Queue webhook event" {style.stroke-dash: 3}
T -> T: "Skip webhook" {style.stroke-dash: 5}
...
# Log success
n8n -> W: "Error or timeout" {style.stroke: red}
W -> W: "Wait (exponential backoff)" {style.stroke-dash: 3}
# 1st: 1min 2nd: 5min 3rd: 15min

W -> T: "8. Mark failed (All attempts failed)" {style.stroke: red}

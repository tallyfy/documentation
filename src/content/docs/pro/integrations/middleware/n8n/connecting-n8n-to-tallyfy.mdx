---
description: This guide explains how to connect n8n workflow automation platform to
  Tallyfy in about 5 minutes using either the dedicated community-built Tallyfy node
  for quick setup or HTTP Request nodes for advanced custom integrations with detailed
  steps covering API credential setup and authentication testing and webhook configuration

---
about_tallyfy: false
description: The n8n community node for Tallyfy grew from 55 operations to 96 across users, tasks, processes, templates, form fields, comments, tags, folders, groups, and search, plus a new Tallyfy Trigger node with four polling triggers, all authenticated with a personal access token.

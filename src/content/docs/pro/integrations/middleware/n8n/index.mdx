---
description: n8n is an open-source workflow automation platform that connects Tallyfy with hundreds of applications through visual workflows using HTTP requests and webhooks for powerful process automation without vendor lock-in.

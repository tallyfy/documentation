...
flowchart TD
    ...
    Parallel --> CRM[Update CRM<br/>PUT Request]
    Parallel --> Sheets[Log to Google Sheets<br/>Append Row]
    Parallel --> Email[Send Confirmation<br/>Email to Submitter]
    ...
    Success -->|Yes| End
    Success -->|No| Retry[Retry Failed Items<br/>Exponential Backoff]

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>N8N > Connect n8n to Tallyfy</b>" href="/products/pro/integrations/middleware/n8n/connecting-n8n-to-tallyfy/" > Connecting n8n to Tallyfy requires obtaining API credentials from your Tallyfy account and configuring either the dedicated community node or HTTP Request nodes in n8n with authentication testing and webhook setup for real-time process automation. </LinkTitleCard>

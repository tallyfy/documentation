---
description: Practical n8n workflow examples for Tallyfy integration including CRM
  synchronization automated onboarding document generation and multi-system data collection.

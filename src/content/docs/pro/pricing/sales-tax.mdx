---
description: Tallyfy does not charge sales tax on SaaS subscriptions because Missouri law exempts remotely-accessed software from sales tax while economic nexus thresholds determine tax obligations in other states only after crossing specific revenue thresholds with proper registration requirements.
...
**You won't see sales tax added to your Tallyfy subscription.** We're based entirely in Missouri, where Software as a Service (SaaS) isn't subject to sales tax. Since we haven't crossed economic nexus thresholds in other states, we don't currently collect sales tax anywhere.

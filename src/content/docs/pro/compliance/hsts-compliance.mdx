---
description: HSTS acts as a security bouncer that forces browsers to use only encrypted
  HTTPS connections with Tallyfy and prevents attackers from downgrading connections
  to steal data through techniques like SSL stripping or man-in-the-middle attacks.

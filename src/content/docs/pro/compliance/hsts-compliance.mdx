---
about_tallyfy: true
description: Tallyfy enforces HSTS preloading which means your browser is hardcoded
  to only use encrypted HTTPS connections and blocks SSL stripping and man-in-the-middle
  attacks before any data leaves your device even on your very first visit.

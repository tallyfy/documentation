---
description: HSTS is a web security mechanism that forces browsers to only communicate
  with Tallyfy through encrypted HTTPS connections protecting against attacks like
  SSL stripping cookie theft and eavesdropping while ensuring all data transmission

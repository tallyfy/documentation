---
about_tallyfy: true
description: Tallyfy uses HSTS preloading — hardcoded into all major browsers — to
  ensure every connection is encrypted via HTTPS before any data is sent and to block
  attacks like SSL stripping and session hijacking on public Wi-Fi.

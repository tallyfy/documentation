...
sidebar:
  order: 5
snippet: HSTS is a security protocol that forces web browsers to only use encrypted
  HTTPS connections with websites while preventing attacks like SSL stripping cookie
  theft and protocol downgrade attempts.

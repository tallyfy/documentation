...
sidebar:
  order: 75
description: A comprehensive overview of Tallyfy's security framework detailing SOC 2
  Type 2 compliance access controls data protection system monitoring and vendor management
  practices to ensure platform reliability and data safety.
title: Compliance
---

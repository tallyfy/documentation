---
about_tallyfy: true
description: Tallyfy is a SOC 2 Type 2 certified workflow platform that provides immutable
  audit trails tracking every user action and step completion along with bank-level
  encryption (TLS 1.2+ and AES-256) and SSO enforcement and role-based access controls
  to help regulated industries like financial services and healthcare and manufacturing
  prove documented compliance with standards such as HIPAA and FDA 21 CFR Part 11
  and ISO 13485.
...
<LinkTitleCard header="<b>Tutorials > Workflow applications</b>" href="/products/pro/tutorials/industry-specific-workflow-applications/" > Tallyfy's configurable template system with conditional logic and built-in audit trails lets... </LinkTitleCard>

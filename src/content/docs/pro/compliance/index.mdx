...
sidebar:
  order: 75
snippet: Tallyfy maintains robust security practices including SOC 2 Type 2 compliance
  access controls data encryption system monitoring incident response plans and vendor
  management protocols to protect customer data and ensure platform reliability.
title: Compliance
---

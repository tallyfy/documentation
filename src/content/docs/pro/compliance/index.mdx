...
sidebar:
  order: 75
snippet: A comprehensive security framework encompassing SOC 2 Type 2 compliance robust
  access controls data encryption system monitoring and vendor management protocols
  ensures protection of customer data and platform reliability at Tallyfy.
title: Compliance
---
...
<LinkTitleCard header="<b>Compliance > Understanding BIMI compliance for Tallyfy emails</b>" href="/products/pro/compliance/bimi-compliance/" > Tallyfy uses the BIMI standard to display its verified logo in your inbox, increasing email trust and security. Learn how BIMI works and how custom SMTP settings affect it. </LinkTitleCard>

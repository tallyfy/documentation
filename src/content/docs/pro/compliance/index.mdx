...
sidebar:
  order: 75
snippet: Tallyfy maintains robust security through SOC 2 Type 2 compliance encryption
  protocols access controls data protection measures system monitoring and vendor
  management practices to safeguard customer information and platform reliability.
title: Compliance
---

...
sidebar:
  order: 75
snippet: A comprehensive security framework encompassing SOC 2 Type 2 compliance access
  control data protection system monitoring and vendor management protocols ensures
  protection of customer data on the Tallyfy platform.
title: Compliance
---

---
description: Tallyfy uses BIMI email authentication to display a verified logo
  next to legitimate emails, combining SPF, DKIM, and DMARC checks with a
  certified logo that makes fake messages identifiable by their missing logo.

---
id: bimi-compliance-tallyfy
sidebar:
  order: 2
title: Understanding BIMI compliance for Tallyfy emails
snippet: Tallyfy uses the BIMI standard to display its verified logo in your inbox, increasing email trust and security. Learn how BIMI works and how custom SMTP settings affect it.
---

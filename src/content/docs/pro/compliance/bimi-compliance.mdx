...
sidebar:
  order: 2
snippet: Tallyfy uses the BIMI standard to display its verified logo in your inbox,
  increasing email trust and security. Learn how BIMI works and how custom SMTP settings
  affect it.

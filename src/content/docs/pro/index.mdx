...
sidebar:
  order: 1
snippet: Tallyfy Pro is a workflow automation platform that helps teams document launch
  track and automate repeatable business processes while enabling real-time status
  monitoring task management and continuous improvement through feedback and analytics.
title: Introduction
---
...
<Steps>
1.  **Phase 1: Document and centralize.** First, focus on documenting your main processes as Tallyfy [templates](/products/pro/documenting/templates/). Use AI features or upload existing documents to speed this up. Keep all your standard operating procedures (SOPs) in one place.
2.  **Phase 2: Launch and track.** Once key templates are ready, start [launching](/products/pro/launching/) them as active [processes](/products/pro/tracking-and-tasks/processes/). Begin tracking completion and introduce your team to completing [tasks](/products/pro/tracking-and-tasks/tasks/) in Tallyfy.
3.  **Phase 3: Automate and improve.** Explore [automations](/products/pro/documenting/templates/automations/) to make workflows even smoother. Use feedback options and [analytics](/products/pro/integrations/analytics/) data (if available) to continuously improve your templates.
</Steps>

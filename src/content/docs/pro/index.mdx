...
Tallyfy<sup>®</sup> is a workflow platform designed for non-technical people. 

### Problems Tallyfy<sup>®</sup> solves
...
Many vital processes lack dedicated software and are managed via email, chat or spreadsheets. Tallyfy<sup>®</sup> empowers users to:
...
## Tallyfy<sup>®</sup> vs. traditional tools

---
about_tallyfy: true
description: Every process in Tallyfy moves through five distinct phases—create a
  template with steps and assignments then launch a named instance where assignees
  complete tasks while you monitor progress in the Tracker view and finally review
  captured data after completion to improve your template based on patterns found

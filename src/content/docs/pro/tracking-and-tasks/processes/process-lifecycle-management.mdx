---
about_tallyfy: true
description: Every process in Tallyfy moves through five distinct phases — create
  a template with steps and assignments then launch named instances where assignees
  complete tasks while you monitor progress in the Tracker view and finally review
  completed data to improve future runs.

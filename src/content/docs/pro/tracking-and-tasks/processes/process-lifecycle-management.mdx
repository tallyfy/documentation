---
about_tallyfy: true
description: Every Tallyfy process moves through five phases - create a template, launch
  an instance, execute tasks, monitor progress, and complete with data you can analyze.

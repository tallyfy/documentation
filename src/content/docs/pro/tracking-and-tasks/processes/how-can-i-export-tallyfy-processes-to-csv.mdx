...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Analytics > CSV file structure</b>" href="/products/pro/integrations/analytics/how-is-the-csv-file-structured-in-tallyfy/" > Process data including tasks form answers and comments can be exported to a 48-column CSV file through the process settings panel where each row represents individual elements like tasks form fields or comments organized across logical column groups covering process information task details assignments timing form data and comments. </LinkTitleCard>

---
description: You can export any running Tallyfy process to CSV format by opening the
  process clicking Settings and selecting Export CSV which downloads a comprehensive
  spreadsheet containing all tasks form answers comments timestamps and process metadata
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Analytics > CSV file structure</b>" href="/products/pro/integrations/analytics/how-is-the-csv-file-structured-in-tallyfy/" > The CSV export feature provides a 48-column spreadsheet containing all process data including tasks form responses and comments organized into logical groups for process information task details assignments timing form fields and comments with specific handling requirements for date fields and analytics tools. </LinkTitleCard>

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Analytics > CSV file structure</b>" href="/products/pro/integrations/analytics/how-is-the-csv-file-structured-in-tallyfy/" > The CSV export feature provides a complete 48-column spreadsheet containing all process data including tasks form responses and comments organized into logical groups for process information task details assignments timing form fields and comments with specific handling requirements for date fields and analytics tools. </LinkTitleCard>

---
description: Administrators can make running processes visible to outsiders by enabling
  a public link setting that allows external stakeholders to view process progress
  in real-time without modification abilities while maintaining complete security
  control over what information gets shared.

---
description: Tallyfy administrators can generate public links that allow external
  stakeholders to view running processes in real-time without login credentials while
  maintaining read-only access and security controls over what information is shared.

...
Think about that for a second. If you've got multiple external vendors working on different parts of a project, making it public means they'll all see each other's tasks. Sometimes that's exactly what you want (transparency breeds accountability). Sometimes it's not.

---
description: A Tallyfy process is an active running instance of a template that represents
  your actual workflow in action while the template serves as the master blueprint
  for future use.

---
description: Processes in Tallyfy are running instances of templates that transform
  workflow blueprints into trackable work with unique names and activity logs while
  template changes don't affect already-running processes.
...
A process is a running instance of a template - it's your Tallyfy [business process](https://tallyfy.com/business-process/) in action. Here's the key difference:

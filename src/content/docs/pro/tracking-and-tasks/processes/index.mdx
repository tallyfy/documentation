...
A process is a running instance of a template - it's your workflow in action. Here's the key difference:
...
Processes are the heart of getting actual work done in Tallyfy - they transform your templates into real, trackable work.

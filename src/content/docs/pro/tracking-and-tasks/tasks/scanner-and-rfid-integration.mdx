---
about_tallyfy: true
description: Barcode scanners and RFID readers that use keyboard wedge mode can fill
  Tallyfy form fields instantly without any special integration by simply acting as
  a keyboard that types scanned data directly into the focused field for faster and
  error-free data entry in workflows like warehouse receiving and quality control.

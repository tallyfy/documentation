...
description: "Tallyfy lets you manually hide or show incomplete tasks in a running
  process using the three-dot menu on any task card. This helps when mid-process
  changes leave irrelevant tasks visible that automation rules didn't cover."

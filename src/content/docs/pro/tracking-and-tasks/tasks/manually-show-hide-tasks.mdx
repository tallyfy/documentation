...
description: Tallyfy lets you manually hide or show incomplete tasks in a running
  process using the three-dot menu on any task card which is especially useful when
  mid-process changes like a client switching business types leave irrelevant tasks
  visible that automation rules did not account for.

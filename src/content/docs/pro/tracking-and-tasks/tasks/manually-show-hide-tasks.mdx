---
about_tallyfy: true
description: Tallyfy lets you manually hide or show incomplete tasks in a running
  process using the three-dot menu on any task card. This helps when mid-process changes
  leave irrelevant tasks visible that your automations didn't cover.
...
This is useful when someone changes a form selection mid-process - say, switching from "Corporation" to "LLC" - and now irrelevant tasks are cluttering the view. Or when your [automations](/products/pro/documenting/templates/automations/) don't cover this specific scenario.
...
- **Automation gaps** - your automations show tasks that shouldn't appear in this scenario
...
**Review hidden tasks periodically.** They're easy to forget. If you're repeatedly hiding the same task type, that's a sign to update your template's [automations](/products/pro/documenting/templates/automations/) instead.

**Use hiding for exceptions, not everyday scenarios.** If a small change to an automation would solve the problem permanently, do that instead of manually hiding tasks each time.
...
<LinkTitleCard header="<b>Organize Processes > Archive and unarchive processes in Tracker view</b>" href="/products/pro/tracking-and-tasks/tracker-view/organize-processes/how-to-archive-and-unarchive-processes-in-tallyfy/" > Archive processes to remove them from your active Tracker view without deleting them. Unarchive... </LinkTitleCard>
</CardGrid>
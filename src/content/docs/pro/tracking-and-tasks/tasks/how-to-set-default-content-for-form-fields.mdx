---
about_tallyfy: true
description: Tallyfy lets you pre-fill form fields with static text or dynamic variables
  and dates so users spend less time retyping common information and make fewer errors
  while still being able to change any pre-filled value.

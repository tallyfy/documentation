---
about_tallyfy: true
description: 'Tallyfy''s built-in rich text editor lets you format text and add images
  and videos and dynamic variables and reusable snippets across task descriptions
  and comments while also supporting mailto: links and Gmail compose URLs in HTML
  mode to let users send pre-filled emails directly from workflow steps.'

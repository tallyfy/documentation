...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Templates > Insert media</b>" href="/products/pro/documenting/templates/insert-media/" > Add images, videos, files, tables, links, and embeds to task descriptions in Tallyfy templates using the Insert button in the editor toolbar. </LinkTitleCard>

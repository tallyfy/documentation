---
about_tallyfy: true
description: 'Tallyfy''s built-in rich text editor lets you format text and add images/videos/tables
  across tasks and descriptions while also supporting dynamic variables and reusable
  snippets plus one-click mailto: links and Gmail compose URLs for pre-filled emails
  directly from workflow steps.'

---
description: Selecting the right form field type in Tallyfy affects user experience
  and data quality with radio buttons working best for short lists of 2-5 options
  while dropdowns suit longer lists and checklists require at least 2 items for multi-item
  verification rather than simple confirmations.

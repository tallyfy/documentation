---
about_tallyfy: true
description: Choosing the right form field type in Tallyfy—such as radio buttons for
  binary choices or dropdowns for longer lists—directly impacts data quality and enables
  powerful automation rules while avoiding common pitfalls like single-item checklists
  or unnecessary file uploads.
...
<LinkTitleCard header="<b>Tasks > Create and use subtasks</b>" href="/products/pro/tracking-and-tasks/tasks/how-to-create-and-use-subtasks/" > Tallyfy's Checklist form field lets you break a single task into smaller checkable subtasks with configurable completion rules—no validation or at least one or all items required—so teams can track granular actions within a step and enforce exactly how much must be done before moving on. </LinkTitleCard>

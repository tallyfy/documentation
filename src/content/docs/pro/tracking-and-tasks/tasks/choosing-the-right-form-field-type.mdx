---
about_tallyfy: true
description: Pick the right form field type in Tallyfy to improve data quality and
  enable automation rules. Covers radio buttons, dropdowns, checklists, and common
  mistakes to avoid.

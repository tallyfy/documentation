...
description: Choosing the right form field type in Tallyfy—such as radio buttons for
  binary choices or dropdowns for longer lists—ensures clean data collection and enables
  powerful automation rules while avoiding common mistakes like single-item checklists

...
sidebar:
  order: 20
snippet: Tallyfy is developing automatic escalation paths for overdue tasks while currently offering several workarounds including adding comments, viewing daily digest emails, filtering for overdue tasks, and watching specific processes or tasks.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Tasks > Manage comments</b>" href="/products/pro/tracking-and-tasks/tasks/how-can-i-manage-comments-in-tallyfy/" > Comments in Tallyfy enable collaboration through direct messaging file attachments including images mentions linking to specific tasks and pinning essential information while supporting edit and delete functions with email notifications. </LinkTitleCard>
<LinkTitleCard header="<b>Tasks View > Overview</b>" href="/products/pro/tracking-and-tasks/tasks-view/" > The Tasks View displays all assigned tasks across all processes including one-off tasks with customizable filtering options for effective workload management and sorting capabilities. </LinkTitleCard>
<LinkTitleCard header="<b>Tracker View > Overview</b>" href="/products/pro/tracking-and-tasks/tracker-view/" > The Tracker View provides a comprehensive overview of all processes organized by status with options to sort filter and search while displaying completion progress key metrics and enabling bulk actions for efficient process management. </LinkTitleCard>
<LinkTitleCard header="<b>Tasks > Complete or reopen tasks</b>" href="/products/pro/tracking-and-tasks/tasks/how-can-i-complete-or-reopen-tasks-in-tallyfy/" > Tasks in Tallyfy can be marked complete or reopened by both assignees and administrators when needed while approval tasks require specific approve/reject actions with optional comments and signatures. </LinkTitleCard>
</CardGrid> 
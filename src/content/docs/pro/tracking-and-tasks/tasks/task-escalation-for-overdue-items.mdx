...
sidebar:
  order: 20
snippet: Tallyfy is developing automatic escalation paths for overdue tasks while
  currently offering several workarounds including adding comments, viewing daily
  digest emails, filtering for overdue tasks, and watching specific processes or tasks.

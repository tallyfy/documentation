...
If you encounter problems that block task completion, explore how to [report and resolve issues](/products/pro/tracking-and-tasks/tasks/how-to-report-and-resolve-issues-in-tallyfy/) using Tallyfy's blocker system.

...
sidebar:
  order: 6
snippet: Subtasks in Tallyfy can be created using Checklist form fields, enabling users to break down complex tasks into manageable components with validation options requiring either all items or at least one item to be checked for completion.

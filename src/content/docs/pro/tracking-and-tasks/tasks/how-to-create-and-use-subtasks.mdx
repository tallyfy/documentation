---
about_tallyfy: true
description: Break down tasks into smaller trackable subtasks using Tallyfy's
  Checklist form field, with three completion rules - no validation, at least one,
  or all items checked.

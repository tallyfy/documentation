...
Sometimes a single step in your Tallyfy process has several smaller actions. You can break down tasks into a list of subtasks using the **Checklist** [form field](/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/) type. This helps track progress on smaller items within a step. Subtasks provide granular visibility and ensure comprehensive task completion.

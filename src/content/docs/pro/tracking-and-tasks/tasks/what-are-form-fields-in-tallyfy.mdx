...
description: Tallyfy offers nine form field types including short text long text dropdown
  list checklist radio buttons date file upload table and assignee picker fields that
  can be configured as required or optional with guidance text and various validation
  options to collect structured data throughout workflow execution.
...
[Form fields](/products/pro/tracking-and-tasks/tasks/what-are-form-fields-in-tallyfy/) are how you collect info within Tallyfy [tasks](/products/pro/tracking-and-tasks/tasks/). Add them to the **Kick-off Form** (filled before the process starts) or to individual tasks in the process. This comprehensive field system enables structured data collection throughout workflow execution.

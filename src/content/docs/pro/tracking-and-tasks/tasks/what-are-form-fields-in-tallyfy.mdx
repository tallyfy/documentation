...
sidebar:
  order: 4
snippet: Tallyfy's form fields system offers various field types including text dropdown
  checklists radio buttons date pickers file uploads tables and assignee pickers to
  collect and organize information effectively within processes and tasks.

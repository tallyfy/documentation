...
sidebar:
  order: 4
snippet: Various form field types like short text long text dropdown lists checklists
  radio buttons date pickers file uploads tables and assignee pickers can be utilized
  to collect information within Tallyfy tasks with customizable settings and validation
  rules.

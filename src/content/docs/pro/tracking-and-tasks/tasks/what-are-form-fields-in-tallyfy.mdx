...
snippet: Tallyfy offers diverse form field options including short text, long text,
  dropdown lists, checklists, radio buttons, date/time selectors, file uploads, tables,
  and assignee pickers, each with customizable settings for enhanced data collection

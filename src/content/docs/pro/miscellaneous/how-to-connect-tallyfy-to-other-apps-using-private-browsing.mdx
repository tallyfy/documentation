---
about_tallyfy: true
description: Private browsing mode fixes Tallyfy connection issues with external
  apps by starting a clean session without stored cookies cached data or saved credentials

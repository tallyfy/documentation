---
description: This troubleshooting guide explains how to resolve email delivery issues
  in Tallyfy by checking email addresses verifying notification settings searching
  spam folders requesting IT allowlisting checking quarantine systems using reliable
  email providers testing server configurations and sharing guest links directly as
  alternatives.

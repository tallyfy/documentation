...
description: HAR files capture your browser's network activity - including requests,
  responses, and load times - to help Tallyfy support troubleshoot speed issues, caching
  problems, and hard-to-reproduce bugs across Chrome, Firefox, Edge, and Safari.

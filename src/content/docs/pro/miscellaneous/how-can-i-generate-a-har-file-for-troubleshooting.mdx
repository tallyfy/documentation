---
about_tallyfy: true
description: A HAR file captures all browser network activity, including requests
  and responses. Generate one through Developer Tools in Chrome, Firefox, Edge, or
  Safari to give support teams the diagnostic data they need for troubleshooting.

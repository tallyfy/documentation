...
snippet: A HAR file captures browser requests and network traffic data through developer
  tools across different web browsers like Chrome, Firefox, Edge, and Safari for troubleshooting
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Open Api > Sniff API calls using Chrome</b>" href="/products/pro/integrations/open-api/how-to-sniff-api-calls-using-chrome/" > Chrome's developer tools enable users to monitor and replicate API calls by viewing raw source payloads and ensuring proper JSON formatting with the required 'X-Tallyfy-Client: APIClient' header. </LinkTitleCard>

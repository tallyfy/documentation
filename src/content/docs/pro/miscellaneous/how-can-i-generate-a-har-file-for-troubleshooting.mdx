...
<LinkTitleCard header="<b>Miscellaneous > Connect Tallyfy to other apps using private browsing</b>" href="/products/pro/miscellaneous/how-to-connect-tallyfy-to-other-apps-using-private-browsing/" > Private browsing mode provides a clean browser session without cached data or stored cookies to resolve connection issues when integrating Tallyfy with external applications like Zapier Slack and Google Drive. </LinkTitleCard>
<LinkTitleCard header="<b>Support > Share screenshots and screencasts with Tallyfy support</b>" href="/products/pro/miscellaneous/support/how-to-share-screenshots-and-screencasts-with-tallyfy-support/" > Screenshots and screencasts help Tallyfy support teams quickly understand issues by capturing screen images using keyboard shortcuts on Mac or Windows and recording screen videos with free tools like Loom Screencastify or Recordit for clearer problem communication. </LinkTitleCard>
</CardGrid>
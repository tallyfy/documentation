...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Open Api > Sniff API calls using Chrome</b>" href="/products/pro/integrations/open-api/how-to-sniff-api-calls-using-chrome/" > Chrome DevTools lets you inspect every API call Tallyfy makes by filtering network requests in... </LinkTitleCard>
<LinkTitleCard header="<b>Support > Share screenshots</b>" href="/products/pro/miscellaneous/support/how-to-share-screenshots-and-screencasts-with-tallyfy-support/" > Sending screenshots or short screen recordings to Tallyfy support using free tools like Loom or... </LinkTitleCard>

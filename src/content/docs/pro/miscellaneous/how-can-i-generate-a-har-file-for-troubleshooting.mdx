...
description: A HAR file captures all browser network activity including requests and
  responses and can be exported from Chrome Firefox Edge or Safari developer tools
  to give support teams the exact data needed to diagnose speed issues or hard-to-reproduce
  bugs.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Open Api > Sniff API calls using Chrome</b>" href="/products/pro/integrations/open-api/how-to-sniff-api-calls-using-chrome/" > You can use Chrome DevTools' Network tab to inspect and replicate Tallyfy's API calls by... </LinkTitleCard>

---
description: The Tallyfy desktop app provides a native cross-platform experience with
  features like native notifications system tray integration and automatic login import
  while maintaining all the functionality of the web application.

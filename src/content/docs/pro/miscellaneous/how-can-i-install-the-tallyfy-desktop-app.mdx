---
description: Download and install Tallyfy's native desktop app for macOS, Windows,
  and Linux to get native notifications, system tray integration, and seamless OAuth
  login using your existing browser sessions.

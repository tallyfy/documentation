...
description: Tallyfy offers a desktop app for macOS and Windows that wraps the existing
  web app while adding native notifications and system tray access along with automatic
  sign-in by importing your existing Google or Microsoft credentials from Chrome.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Miscellaneous > Tallyfy on mobile devices</b>" href="/products/pro/miscellaneous/does-tallyfy-work-on-all-devices/" > Tallyfy runs on any device with a modern browser as a responsive web app requiring no... </LinkTitleCard>

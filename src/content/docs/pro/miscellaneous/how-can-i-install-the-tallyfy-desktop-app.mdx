---
description: The Tallyfy desktop app offers a native experience across macOS Windows
  and Linux with benefits like native notifications and system tray integration while
  wrapping the same web application functionality and supporting automatic login import

...
Tallyfy enables file uploads to steps, [tasks](/products/pro/tracking-and-tasks/tasks/), forms, and comments. All uploaded files are stored securely in Amazon S3 buckets with enterprise-grade [security](/products/pro/compliance/) measures and full data protection.
...
For complete IT, [compliance](/products/pro/compliance/), and [security](/products/pro/compliance/) details about file storage, visit our [compliance and security page](https://tallyfy.com/legal/compliance-security/). Data export capabilities vary by subscription plan; contact support for specific feature availability.
...
- **Security**: Enterprise-grade Amazon S3 storage with full data protection

...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Integrations > Document management integration</b>" href="/products/pro/integrations/document-management/" > Tallyfy integrates with document management systems allowing organizations to maintain secure document storage while using Tallyfy for workflow orchestration through file request links that enable external users to upload directly to your DMS without compromising security or compliance requirements. </LinkTitleCard>

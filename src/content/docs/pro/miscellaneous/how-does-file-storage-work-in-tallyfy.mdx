...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Integrations > Document management</b>" href="/products/pro/integrations/document-management/" > Tallyfy integrates with existing document management systems to handle workflow orchestration while maintaining current security protocols and document storage allowing organizations to choose between using their DMS for compliance-heavy documents or Tallyfy's built-in file management for simpler workflows. </LinkTitleCard>

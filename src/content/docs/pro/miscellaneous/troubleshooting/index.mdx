---
about_tallyfy: true
description: Most Tallyfy issues like loading errors and authentication loops can
  be resolved by clearing your browser cache and cookies or forcing a logout at account.tallyfy.com/logout
  and if standard fixes fail a browser console script can wipe all stored Tallyfy
  data per origin to fully reset your session state.

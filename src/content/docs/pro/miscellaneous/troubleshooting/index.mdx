---
about_tallyfy: true
description: Fix common Tallyfy issues like loading errors, authentication loops,
  rate limits, and password resets. Includes cache clearing steps, browser data wipe
  scripts, and Microsoft login approval guidance.

---
description: Tallyfy Denizen is a free API service that automatically detects a visitor's
  geographic location via IP address and returns royalty-free photos matching that
  location through a simple REST endpoint to boost conversions and engagement on pages
  like registration screens.
...
## Related articles
<CardGrid>
<LinkTitleCard header="<b>Denizen > Endpoints</b>" href="/products/denizen/endpoints/" > The Tallyfy Denizen API provides a simple GET request endpoint at denizen.tallyfy.com that... </LinkTitleCard>
</CardGrid>
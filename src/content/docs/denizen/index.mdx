...
<LinkTitleCard header="<b>Denizen > Endpoints</b>" href="/products/denizen/endpoints/" > The Tallyfy Denizen API returns royalty-free, location-specific images based on visitor IP... </LinkTitleCard>
</CardGrid>
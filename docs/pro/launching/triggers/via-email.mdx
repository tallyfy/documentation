...
snippet: Launching processes through email enables automatic workflow initiation by
  sending messages to specific addresses while capturing email content and attachments
  into kick-off fields.

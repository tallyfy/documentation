...
snippet: The rich text editor enables advanced text formatting with HTML capabilities
  including video embeds tables hyperlinks and lists while stripping heavy markup
  when copying from external sources to maintain optimal performance and consistent
  styling.

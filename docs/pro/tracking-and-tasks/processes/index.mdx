...
snippet: A process represents an active instance of a template that can be launched
  multiple times with unique identifiers while maintaining its own audit trail and
  allowing for task customization.

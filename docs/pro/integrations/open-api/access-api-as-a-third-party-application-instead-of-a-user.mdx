---
id: a9ac635a42b6c6cec9639eecf2946ecc
snippet: Organizations can integrate Tallyfy into their applications by making API
  requests on behalf of their users through client credentials and user-specific access
  tokens to enable seamless functionality without direct user interaction.

...
snippet: The exclusive choice pattern enables automated decision-making by selecting
  one specific path based on predefined conditions through multiple automation rules

...
snippet: Tallyfy automations enable dynamic decision-making through step types and
  field types while supporting multiple conditional combinations for automated actions
  based on specific criteria and triggers.

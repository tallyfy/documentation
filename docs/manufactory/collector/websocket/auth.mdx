---
id: cc4bfd2d1aa51aa009a2a6da8ae30821
pcx_content_type: auth
snippet: Authentication for Manufactory websocket connections requires a POST request
  to /auth with project key header and payload containing org_id project_id and actor
  profile which generates a client UUID valid for 12 hours.

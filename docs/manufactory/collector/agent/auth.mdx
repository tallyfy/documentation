...
snippet: The config file requires an org ID project ID and project key for authentication
  with values stored in a YAML file alongside the manufactory-agent.

...
snippet: The actors schema can be removed by sending a DELETE request to the endpoint
  with authentication and specifying organization and project IDs in the path.
